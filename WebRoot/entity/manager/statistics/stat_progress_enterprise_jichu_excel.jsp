...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_progress_enterprise_jichu.xls"); %>
...
<%
	...
	+sql_bath+"  "+sql_con+"  "+sql_con1+"  "+sql_emp+" and co.flag_course_type='402880f32200c249012200c780c40001'  group by ps.id ";
