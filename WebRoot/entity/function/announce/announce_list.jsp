...
<%@ page
	import="com.whaty.platform.interaction.*,com.whaty.platform.interaction.announce.*"%>
...
<html>
	...
	<%
		...
		String publisher_name = fixnull(request
				.getParameter("publisher_name"));
		try {
			...
			int totalItems;
			totalItems = interactionManage.getAnnouncesNum(teachclass_id,
			...
			String link = "&title=" + title + "&publisher_name="
					+ publisher_name;
			//----------分页结束---------------
			List announceList = interactionManage.getAnnounces(pageover,
					teachclass_id, title, publisher_name);
	%>
                      ...
                      <td height="46">&nbsp;</td>
									...
									<tr>
										<td align="right" valign="top">
											<form method="post" action="announce_list.jsp"
												name="announce_listSearchForm">
														...
														<td>
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	...
																	<td align="center">
																		<input name="publisher_name" type="text" size="10"
																			maxlength="50" value="<%=publisher_name%>" />
																	</td>
																</tr>
															</table>
														</td>
														<td align="center">
															<input type="image" src="../images/search.gif" width="99"
																height="19" />
														</td>
										...
										<td height="26" background="../images/tabletop.gif"
											...
											<table width="100%" border="0" align="center" cellpadding="0"
												...
												<tr>
													...
													<td width="58%" align="center" class="title">
														名&nbsp;&nbsp;&nbsp;&nbsp;称
													</td>
									...
									<tr>
										<td align="center" background="../images/tablebian.gif">
											<table width="99%" border="0" cellspacing="0" cellpadding="0"
												...
												<tr>
													<td bgcolor="<%=trBgcolor%>" width="5%" align="center"
														valign="middle" class="td1">
														<img src="images/xb2.gif" width="8" height="8">
													</td>
													...
													<td bgcolor="<%=trBgcolor%>" width="58%" align="center"
														class="td1">
														<a
															href="announce_detail.jsp?id=<%=announce.getId()%>&pageInt=<%=pageInt%>&title=<%=title%>&publisher_name=<%=publisher_name%>"><%=announce.getTitle()%></a>
													</td>
													<td bgcolor="<%=trBgcolor%>" width="18%" align="center"
														class="td1"><%=announce.getPublisherName()%></td>
													<td bgcolor="<%=trBgcolor%>" align="center" class="td1"><%=announce.getDate()%></td>
													<td bgcolor="<%=trBgcolor%>" width="40" align="center"
														class="td1">
														&nbsp;
													</td>
												</tr>
