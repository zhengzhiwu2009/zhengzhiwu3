...
<script type="text/javascript">  
        Ext.onReady(function() {
			...
			var url = '/entity/statistics/prBzzStatistics_regStatByRegtype.action';
            ...
            var grid = new Ext.whaty.ux.grid.ExQueryPageGrid({
                ...
                cmField: [  
                    ...
                    {header: '注册类别',mcol:1,mtext:'&nbsp;',mwidth:100,width: 100,dataIndex: 'reg_type'},  
