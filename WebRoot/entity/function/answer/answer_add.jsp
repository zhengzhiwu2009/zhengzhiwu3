...
<html>
	<head>
		...
		<%
			...
			//Lee start 2014年3月14日 解决课程答疑中文乱码
			Question question = interactionManage.getQuestion(id);
			String a_title = question.getTitle();
			//Lee end
		%>
	</head>
	...
	<body leftmargin="0" topmargin="0" background="../images/bg2.gif">
		<form
			action="answer_addexe.jsp?id=<%=id%>&pageInt=<%=pageInt%>&title=<%=title%>&name=<%=name%>"
										...
										<tr>
											<td bgcolor="#FFFFFF">
												<table width="100%" border="0" cellspacing="0"
														...
														<td>
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td width="260" align="left"><%=a_title%><!-- <img src="../images/gg2.gif" width="259" height="32"> -->
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
														<td width="90">
															<input type="image" name="Submit" src="../images/fs.gif"
																width="82" height="23">
														</td>
														<td width="90">
