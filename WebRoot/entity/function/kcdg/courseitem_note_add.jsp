...
<%
	...
	String sql = "SELECT content FROM interaction_teachclass_info WHERE teachclass_id = '" + courseId + "' and type = '" + type + "'";
	String content = "";
...
<form action="courseitem_note_addexe.jsp" method="POST" name="frmAnnounce" onsubmit="return chkSubmit()">
...
<input type=hidden name=type value=<%=type %>>
                    ...
                    <tr>
                      <td background="../images/table_02.gif" ><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="bg4">
                          <tr>
							...
							<input type=text name=title value =" " class=input1 size=60 maxlength="60">
							</td>
						  </tr>
                          	<tr>
                          	<td class="neirong" valign=top width=20% class="text1"nowrap="nowrap">
							内容：
							</td>
							<td valign=top>
							<textarea  cols="80" name="body" rows="12"><%=content %></textarea>
		...
		<tr>
			<td align=center><input type=submit value="提交" id=sub>&nbsp;&nbsp;<input type=button value="返回" onclick="window.location='courseitemnote_list.jsp'"></td>
		</tr>
                  </table> </td>
              </tr>
            </table></td>
