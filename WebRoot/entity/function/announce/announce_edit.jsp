...
<html>
	...
	function chkSubmit()
	{
		...
		if(frmAnnounceUpdate.title.value.length <2)
		{
			alert("标题好像忘记写了!");
			return false;
		}
	...
	<body leftmargin="0" topmargin="0" background="../images/bg2.gif">
		<form action="announce_editexe.jsp" method="POST"
			name="frmAnnounceUpdate" onsubmit="return chkSubmit()">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="86" valign="top" background="../images/top_01.gif">
									<img src="../images/ggl.gif" width="217" height="86">
								</td>
							</tr>
							<tr>
													...
													<tr>
														<td>
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	<td width="20">
																		<img src="../images/ggzt.gif" width="20" height="32">
																	</td>
																	...
																	<td>
																		<input name="title" type="text" size="30"
																			maxlength="50" value="<%=announce.getTitle()%>">
																	</td>
																	<td width="260" align="right">
																		<img src="../images/gg2.gif" width="259" height="32">
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
														<td colspan=2 class="neirong" valign=top>
															<textarea class="smallarea" cols="80" name="body"
																rows="12"><%=announce.getBody()%></textarea>
														</td>
													</tr>
													<tr>
														<td>
															<table width="100%" border="0" cellspacing="0"
																cellpadding="0">
																<tr>
																	<td width="65" align="right" class="text1">
																		内容：
																	...
																	<td width="90">
																		<input type="image" name="Submit"
																			src="../images/fs.gif" width="82" height="23">
																	</td>
																	<td width="90">
																		<a href="javascript:window.history.back()"><img
																				src="../images/fh.gif" width="82" height="23"
																				border="0">
																		</a>
																	</td>
																	<td align="right">
																		<img src="../images/gg3.gif" width="147" height="42">
																	</td>
																</tr>
															</table>
														</td>
