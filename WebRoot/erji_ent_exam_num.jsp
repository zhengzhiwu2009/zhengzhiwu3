...
<%
	...
	db.close(rs_batch);
		...
		String sql = 
			...
			"  from pe_enterprise pe,pe_enterprise e1,\n" + 
			...
			" where pe.id = a.e2_id(+) and pe.fk_parent_id=e1.id(+) \n" + 
			"   and pe.id = b.e2_id(+)\n" + 
			"   and pe.id = c.e2_id(+)\n" + 
			"   and pe.id = d.e2_id(+)\n" + 
			"   and pe.id = e.e2_id(+)\n" + 
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1060 style='border-collapse:
 ...
 <tr height=50 style='mso-height-source:userset;height:37.5pt'>
  ...
  width:796pt'><%=exambatch_name%></td>
 </tr>
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl26 style='height:14.25pt;border-top:none'>企业名称</td>
  <td height=19 class=xl26 style='height:14.25pt;border-top:none'>所在一级企业</td>
 ...
 <%             int b_total_count = 0;
				...
				while(rs!=null&&rs.next())
				{
					...
					String yiji_name = fixnull(rs.getString("yiji_name"));//企业名称
				    ...
				    String tsql="select distinct su.login_id,m.name,m.position,m.phone,m.mobile_phone,m.email,me.fk_enterprise_id,su.login_num "
				    			+" from pe_enterprise_manager m,pr_bzz_pri_manager_enterprise me,sso_user su " 
				    			+" where m.fk_sso_user_id=me.fk_sso_user_id and m.fk_sso_user_id=su.id and me.fk_enterprise_id='"+enterprise_id+"' and su.fk_role_id in('402880f322736b760122737a968a0010','402880f322736b760122737a60c40008') order by su.login_num";
				    String manager = "";
				    String manager1 = "";
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td height=19 class=xl28 style='height:14.25pt;border-top:none'><%=yiji_name %>　</td>
  ...
  <td class=xl28 style='border-top:none;border-left:none'><%=new BigDecimal((Float.parseFloat(k_num)+Float.parseFloat(l_num)+Float.parseFloat(m_num))*100.0/shikao_num).setScale(1, BigDecimal.ROUND_HALF_UP)%>%</td>
           ...
           <% } 
              ...
              %>
 <tr height=19 style='height:14.25pt'>
  <td height=19 colspan="4" class=xl29 style='height:14.25pt;border-top:none'>总计</td>
