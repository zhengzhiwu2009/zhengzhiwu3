...
public class YetOfflineAction extends MyBaseAction<PeBzzTchCourse> {
	...
	public void initGrid() {
		...
		this.getGridConfig().setTitle("下线课程");
		...
		this.getGridConfig().addColumn(this.getText("下线日期"), "offline_date", false, false, true, "TextField", true, 25);
	...
	public void setServletPath() {
		// TODO Auto-generated method stub
		this.servletPath = "/entity/teaching/yetOffline";
	}
	...
	public Page list() {
		...
		try {
			...
			sqlBuffer.append("  NVL(EC4.NAME, '-') FLAGCONTENTPROPERTY,NVL(EC11.NAME, '-') quyu,a.time,  a.TEACHER, " +
					" DECODE(PBTC_SCORE,0,NULL,PBTC_SCORE) SCORE, a.offline_date, ");
			...
			sqlBuffer.append(" INNER JOIN ENUM_CONST EC9 ON A.FLAG_OFFLINE = EC9.ID  and ec9.code='1' ");// 已下线
			...
			sqlBuffer.append(" EC8.NAME,EC9.NAME,EC5.NAME,EC6.NAME,EC1.NAME,EC2.NAME,EC3.NAME, PBTC_SCORE, a.offline_date,");
			sqlBuffer.append(" EC4.NAME,EC8.NAME,EC9.NAME,EC5.NAME,EC6.NAME,FLAG_ISRECOMMEND,EC.NAME,EC11.NAME,a.time, ");
			sqlBuffer.append(" A.TEACHER,C.COURSE_ID,A.CREATE_DATE, ");
