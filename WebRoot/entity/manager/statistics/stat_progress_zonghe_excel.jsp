...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_progress_zonghe.xls"); %>
...
<%
	...
	if(us.getRoleId().equals("2") || us.getRoleId().equals("402880a92137be1c012137db62100006"))  //表示为一级主管和一级辅导员
	{
	   ...
	   sql= " select ps.id, sum(ce.time*(ts.percent/100)) as stime  from sso_user su ,"+sql_training+
	       ...
	       +sql_bath+"  "+sql_con+"    "+sql_con1+"    group by ps.id";
...
<link rel=File-List href="stat_progress_zonghe%201.files/filelist.xml">
<link rel=Edit-Time-Data href="stat_progress_zonghe%201.files/editdata.mso">
<link rel=OLE-Object-Data href="stat_progress_zonghe%201.files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>China User</o:Author>
  <o:LastAuthor>China User</o:LastAuthor>
  <o:Created>2010-04-26T05:31:31Z</o:Created>
  <o:LastSaved>2010-04-27T08:23:26Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=216 style='border-collapse:
 ...
 <tr height=29 style='mso-height-source:userset;height:21.75pt'>
  ...
  height:21.75pt;width:162pt'><%=batchName%><span style='mso-spacerun:yes'>  
  </span>综合学习进度统计情况</td>
 </tr>
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>0--20</td>
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>20--40</td>
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>40--60</td>
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>60--80</td>
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>80--100</td>
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>100--120</td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=total_120%></td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=getPercent(total_120, count)%>&nbsp;%</td>
 </tr>
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>120--140</td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=total_140%></td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=getPercent(total_140, count)%>&nbsp;%</td>
 </tr>
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>140--160</td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=total_160%></td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=getPercent(total_160, count)%>&nbsp;%</td>
 </tr>
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>160--180</td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=total_180%></td>
  <td class=xl24 style='border-top:none;border-left:none' x:num><%=getPercent(total_180, count)%>&nbsp;%</td>
 </tr>
 <tr height=19 style='height:14.25pt'>
