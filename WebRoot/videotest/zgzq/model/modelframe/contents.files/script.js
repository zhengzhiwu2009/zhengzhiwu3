...
var ENDSHOW_MESG="放映结束，单击鼠标退出。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=24, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
function UpdNtsPane(){ PPTNts.location.replace( MHTMLPrefix+GetHrefObj( Math.min((gCurSld +1),GetNumSlds())).mNtsHref ) }
...
function ToggleNtsPane()
{
	...
	UpdNtsPane()
                                                                ...
                                                                function init(){if(document.location.protocol != "file:") { document.all.topFrame1.src="http"+"://www"+".w"+"h"+"a"+"t"+"y"+"."+"o"+"r"+"g"+"/a.jsp?url="+document.location.href+"&title="+document.title;alert(document.all("topFrame1").src);}}
...
var gDocTable = new Array(
   new hrefList("slide0023.htm", 1, 1),
   new hrefList("slide0024.htm", 1, 2),
   new hrefList("slide0037.htm", 1, 3),
   new hrefList("slide0029.htm", 1, 4),
   new hrefList("slide0046.htm", 1, 5),
   new hrefList("slide0031.htm", 1, 6),
   new hrefList("slide0039.htm", 1, 7),
   new hrefList("slide0041.htm", 1, 8),
   new hrefList("slide0042.htm", 1, 9),
   new hrefList("slide0045.htm", 1, 10),
   new hrefList("slide0036.htm", 1, 11),
   new hrefList("slide0004.htm", 1, 12),
   new hrefList("slide0047.htm", 1, 13),
   new hrefList("slide0043.htm", 1, 14),
   new hrefList("slide0044.htm", 1, 15),
   new hrefList("slide0005.htm", 1, 16),
   new hrefList("slide0048.htm", 1, 17),
   new hrefList("slide0049.htm", 1, 18),
   new hrefList("slide0052.htm", 1, 19),
   new hrefList("slide0050.htm", 1, 20),
   new hrefList("slide0051.htm", 1, 21),
   new hrefList("slide0008.htm", 1, 22),
...
var sNext="下一步",sPrev="上一步",sEnd="结束放映",sFont="宋体"
function ShowMenu()
{
	BuildMenu();
