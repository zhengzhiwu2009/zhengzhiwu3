...
<%
		...
		//gaoyuan 09-08-25 end
	%>
<%
	//String resId = request.getParameter("resId");
	//String xml = request.getParameter("xml"); //原来使用，gaoyuan 修改
...
%>                      
                    ...
                    <tr align="center"><td> <input type="button" value="返回" onclick="window.history.back()"> </td></tr>
                  </table></td>
                    </tr>
                  </table> 
                </td>
