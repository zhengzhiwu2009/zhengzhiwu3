  ...
  <head>
   ...
   var flag = true;
			if(document.getElementById('pwd1').value == ''){
				flag=false;
		pwd1Infor.innerHTML='<div class="checkError">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码不能为空！</div>';
			}
			
			if(document.getElementById('pwd').value == ''){
				flag=false;
		pwdInfor.innerHTML='<div class="checkError">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码确认不能为空！</div>';
			}else {
			if(!checkpwd()){
			flag=false;
				pwdInfor.innerHTML='<div class="checkError">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;两次输入的密码不一致</div>'; 							
			}
			}  
	if(!userAddGuarding()){
		flag=false;
...
//生成学习中心下拉列表
  ...
  <body>
  <form name="print" method="POST" action="/entity/first/firstRegister_addStudent.action" onsubmit='return userAddGuarding();' enctype="multipart/form-data">
...
onFocus="foCardType()" onBlur="blCardType()">
                ...
                <OPTION VALUE="港、澳、台居民证件">港、澳、台居民证件</OPTION>                           
					  ...
					  <tr>
                        <td width="23%" class="grayfont" height="24"><font class="sign">*</font> 密码：</td>
                        <td width="43%" align="left"><input  id="pwd1" type="password" class="textreg" onFocus="fopwd1()" onBlur="blpwd1()" /> </td>
                        <td width="34%" id="pwd1Infor">&nbsp;</td>
                      </tr>
					  <tr>
                        <td width="23%" class="grayfont" height="24"><font class="sign">*</font> 密码确认：</td>
                        <td width="43%" align="left"><input name="student.password" id="pwd" type="password" class="textreg" onFocus="fopwd()" onBlur="blpwd()" /> </td>
                        <td width="34%" id="pwdInfor">&nbsp;</td>
                      </tr>							  					  
                    </table></td>
                    <td width="50%" align="center"  valign="top">
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
