...
//生成学习中心下拉列表
			...
			birthdayDate.render('showbirthday'); 	
			     birthdayDate.addListener('focus',function(){
					...
					document.getElementById("birthdayInfo").innerHTML='<div class="checkInfor">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请填写您的出生地</div>';
			   }); 
  ...
  <body >
  <form name="print" method="POST" action="/entity/first/firstStudentInfo_editInfo.action" onsubmit='return userAddGuarding();'>
                  ...
                  <tr>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      <tr>
                        ...
                        <input type="text"  name="site" size="52" value="<s:property value="student.getPrRecPlanMajorSite().getPeSite().getName()"/>"  id="combo-box-sites" onFocus="foSite()" onBlur="blSite()"/>                        </td>
                        <td width="7%"  >&nbsp;</td>
                      </tr>
                      <tr>
