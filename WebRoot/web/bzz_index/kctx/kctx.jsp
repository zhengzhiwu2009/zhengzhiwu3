...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td align="center" class="body_box"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="218" valign="top" bgcolor="#9FC3FF"><img src="/web/bzz_index/kctx/images/l_t.jpg" width="218" height="8"></td>
                ...
                <td height="27" background="/web/bzz_index/images/index/index_r5_c007.jpg"> 
                  <div align="left">
                    <table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td width="6%">&nbsp;</td>
                        <td width="94%"><font color="#000066" size="3"><strong>课程体系</strong></font></td>
                      </tr>
                    </table>
                  </div></td>
              </tr>
      ...
      <tr bgcolor="#9FC3FF">
        <td valign="top"><br/>
          ...
          <tr>
            <td><img src="/web/bzz_index/kctx/images/kctx_03.gif" width="206" height="70"></td>
          </tr>
          <tr>
            <td background="/web/bzz_index/kctx/images/list_bg.jpg"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" id="menu0" status="off" class="cd_2-off" onMouseOver="overMenu(this)" onMouseOut="outMenu(this)" onClick="registMenu(this);window.open('/web/bzz_index/kctx/kcjs.jsp','xytd');parent.resize();">　 课程体系简介</td>
              </tr>
              <tr>
                <td height="6"></td>
              </tr>
              <tr>
                <td height="30" id="menu1" status="off" class="cd_2-off" onMouseOver="overMenu(this)" onMouseOut="outMenu(this)" onClick="registMenu(this);window.open('/web/bzz_index/kctx/kctx01.jsp','xytd');parent.resize();">　 基础课程</td>
              </tr>
              <tr>
                <td height="6"></td>
              </tr>
              <tr>
                <td height="30" id="menu2" status="off" class="cd_2-off" onMouseOver="overMenu(this)" onMouseOut="outMenu(this)" onClick="registMenu(this);window.open('/web/bzz_index/kctx/kctx02.jsp','xytd');parent.resize();">　 提升课程</td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td><img src="/web/bzz_index/kctx/images/list_b.jpg" width="206" height="31"></td>
          </tr>
        </table></td>
      </tr>
      <tr bgcolor="#9FC3FF">
        <td valign="bottom"><img src="/web/bzz_index/kctx/images/l_b.jpg" width="218" height="7"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
