...
<body>
<form action="/entity/workspaceStudent/studentWorkspace_toFreeCourses.action" name="frm" method="post">
...
<div class="" style="width:100%;padding:0;margin:0; " align="center">
      <div class="main_title">免费公共课程学习</div>
      <div class="main_txt">
  ...
  <tr>
    ...
    <td align="center">
    	<a style = "color:#3366ff; cursor: pointer;" onclick="window.open('/cms/flkcalone.htm?myId=<s:property value="#opencourse.peBzzTchCourse.id"/>&flag=true','newWindow_detail')" >
    ...
    <td><div class="ck" style="width:70px;background-image:url('/entity/bzz-students/images/index_21.jpg')" >
     <a style="cursor: pointer;" onclick="openCourseWare('/sso/bzzinteraction_InteractionStuManageFree.action?course_id=<s:property value="#opencourse.peBzzTchCourse.id"/>&opencourseId=<s:property value="#opencourse.id"/>&passStudy=1','newWindow');" >开始学习</a>
      </div></td>
