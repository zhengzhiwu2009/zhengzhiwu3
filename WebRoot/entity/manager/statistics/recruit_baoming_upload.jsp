...
function FileTypeCheck()
  ...
  if(!(ExtentName == ".xls" || ExtentName == ".XLS")){
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<s:form name="batch"
			action="/entity/recruit/peBzzRecruitBefore_uploadExcel.action" method="POST"
								...
								<tr valign="bottom" class="postFormBox">
									...
									<td width="77%">
										<span class="link" help="下载Excel格式的模版表格"><img
											...
											href='/entity/manager/statistics/stat_phone_list_excel1.jsp'
											target=_blank>Excel报表</a><font color="red">（模版导出后要另存为.xls后再上传）</font>
										</span>
									</td>
								</tr>
								<tr valign="bottom" class="postFormBox">
									<td valign="bottom">
										<span class="name">上载预报信息:</span>
									</td>
									<td valign="bottom">
