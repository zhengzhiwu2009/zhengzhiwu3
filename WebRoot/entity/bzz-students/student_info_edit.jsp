...
<body>
	<div class="" style="width: 100%; padding: 0; margin: 0;"
		...
		<div class="main_txt">
			<form
				action="/entity/workspaceStudent/studentWorkspace_modifyInfo.action"
					...
					<tr>
						<td>
							<table class="datalist" width=" 100%" order="0" cellpadding="0"
								...
								<!--<tr bgcolor="#ECECEC">
										<td width="30%" lign="center" bgcolor="#E9F4FF"
											class="kctx_zi1">
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="kctx_zi1"><font
										color="red" size="3">*</font> <strong>姓 名：</strong></td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										...
										id="peBzzStudent.trueName" maxlength=20 size="24" /> <!--<s:property value='peBzzStudent.trueName' />-->
									</td>
								</tr>
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><font
										color="red" size="3">*</font> <strong>性 别：</strong></td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <s:if test="peBzzStudent.gender == null "></s:if> <input
										type="radio" name="peBzzStudent.gender" id="gender1" value="男"
										<s:if test='peBzzStudent.gender =="男"'>checked</s:if>>男
										&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
										name="peBzzStudent.gender" id="gender2" value="女"
										<s:if test='peBzzStudent.gender =="女"'>checked</s:if>>女
									</td>
								</tr>
								<tr>
									...
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <s:if test="peBzzStudent.folk == null "></s:if> <select
										name="peBzzStudent.folk" id="peBzzStudent.folk"
										style="width:154px">
											<OPTION VALUE="<s:property value="peBzzStudent.folk"/>">
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><strong>出生日期：</strong>
									</td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <select size="1" style="width:60px" id="year"
										name="year"
										onfocus="years('year',new Date().getFullYear()),change_date()"
										onchange="change_date()">
											<option id="year"
												value="<s:date name="peBzzStudent.birthdayDate" format="yyyy"/>">
												<s:date name="peBzzStudent.birthdayDate" format="yyyy" />
											</option>
									</select>&nbsp;年&nbsp; <select size="1" style="width:50px" name="month"
										id="month" onfocus="months(),change_date()"
										onchange="change_date()">
											<option id="month"
												value="<s:date name="peBzzStudent.birthdayDate" format="MM"/>">
												<s:date name="peBzzStudent.birthdayDate" format="MM" />
											</option>
									</select>&nbsp;月&nbsp; <select size="1" style="width:50px" name="date"
										id="date">
											<option id="day"
												value="<s:date name="peBzzStudent.birthdayDate" format="dd"/>">
												<s:date name="peBzzStudent.birthdayDate" format="dd" />
											</option>
									</select>&nbsp;日<br /> <input type="hidden"
										id="peBzzStudent.birthdayDate"
										name="peBzzStudent.birthdayDate" value="" /> <!-- 	<input type="text" name="peBzzStudent.birthdayDate" id="peBzzStudent.birthdayDate"  value="<s:date name="peBzzStudent.birthdayDate" format="yyyy-MM-dd"/>" readonly="readonly" size="24"/>
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="kctx_zi1"><font
										color="red" size="3">*</font> <strong>国 籍：</strong></td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <select name="peBzzStudent.cardType"
										id="peBzzStudent.cardType" style="width:155px">
											<option value="中国"
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><font
										color="red" size="3">*</font> <strong>学 历：</strong></td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <select name="peBzzStudent.education"
										style="width:155px">
											<option value="初中"
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><strong>工作部门：</strong>
									</td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <input type="text" name="peBzzStudent.department"
										size="24" id="peBzzStudent.department"
										value="<s:property value="peBzzStudent.department" />" /></td>
								</tr>
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><strong>通讯地址：</strong>
									</td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2">
										&nbsp; <input type="text" name="peBzzStudent.address"
										id="peBzzStudent.address" maxlength=60 size="50"
										value="<s:property value="peBzzStudent.address"/>" /></td>
								</tr>
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><strong>工作区域：</strong>
									</td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2">
										&nbsp; <input type="text" name="peBzzStudent.workAddress"
										id="peBzzStudent.workAddress" maxlength=60 size="50"
										value="<s:property value="peBzzStudent.workAddress"/>" /></td>
								</tr>
								<!-- <tr>	
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="kctx_zi1"><strong>从事业务：</strong>
									</td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <input type="text" name="peBzzStudent.work" size="24"
										id="peBzzStudent.work"
										value="<s:property value="peBzzStudent.work" />" /></td>
								</tr>
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="kctx_zi1"><strong>职务：</strong>
									</td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <input type="text" name="peBzzStudent.position"
										size="24" id="peBzzStudent.position"
										value="<s:property value="peBzzStudent.position" />" /></td>
								</tr>
								<!-- 	 <tr>
										<td align="center" bgcolor="#E9F4FF" class="STYLE1">
											&nbsp;工作所在地区：
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><font
										color="red" size="3">*</font> <strong>手 机：</strong></td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <input type="text" name="peBzzStudent.mobilePhone"
										size="24" id="peBzzStudent.mobilePhone"
										value="<s:property value="peBzzStudent.mobilePhone" />" /></td>
								</tr>
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1"><font
										color="red" size="3">*</font><strong>电子邮件：</strong></td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp; <input type="text" size="24" name="peBzzStudent.email"
										id="peBzzStudent.email"
										value="<s:property value="peBzzStudent.email" />" /></td>
								</tr>
								<!-- 	<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1">
										<strong>邮编：</strong>
