...
package com.bill99.seashell.domain.dto.gatewayquery;
...
public class GatewayOrderQueryResponse  implements java.io.Serializable {
    ...
    private com.bill99.seashell.domain.dto.gatewayquery.GatewayOrderDetail[] orders;
    ...
    public GatewayOrderQueryResponse(
           ...
           com.bill99.seashell.domain.dto.gatewayquery.GatewayOrderDetail[] orders,
     ...
     * @return orders
     */
    public com.bill99.seashell.domain.dto.gatewayquery.GatewayOrderDetail[] getOrders() {
        return orders;
    }
     ...
     * @param orders
     */
    public void setOrders(com.bill99.seashell.domain.dto.gatewayquery.GatewayOrderDetail[] orders) {
        this.orders = orders;
    }
