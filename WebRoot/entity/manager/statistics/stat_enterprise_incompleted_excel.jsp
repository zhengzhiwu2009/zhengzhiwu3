...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1048 style='border-collapse:
 ...
 <%
	...
	String ename = fixnull(rs.getString("enterprise_name"));
	 db.close(rs);
 %>
  <td colspan=7 height=32 class=xl26 width=1048 style='height:24.0pt;
  width:787pt'><font color = 'red'>&lt;&lt;<%=ename%>&gt;&gt;</font>未学完基础课学员列表</td>
  </tr>
 <tr height=29 style='mso-height-source:userset;height:21.75pt'>
  ...
  <td class=xl24 style='border-top:none;border-left:none'>电子邮件</td>
   <td class=xl24 style='border-top:none;border-left:none'>已学完学时数</td>
 </tr>
 <%
 ...
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  ...
  <td class=xl25 style='border-top:none;border-left:none'><%=student_email %>　</td>
   <td class=xl25 style='border-top:none;border-left:none'  x:num><%=total_time %>　</td>
 </tr>
 <%
 	}
 	db.close(rs);
