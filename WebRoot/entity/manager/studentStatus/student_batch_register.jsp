...
function FileTypeCheck()
  ...
  if(bathid==0){
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<form name="batch"
			action="<s:property value='servletPath'/>_uploadExcel.action" method="POST"
							...
							<table width="68%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr valign="bottom" class="postFormBox">
									...
									<td width="77%">
										<span class="link" help="下载Excel格式的模版表格"><img
											...
											href='/entity/manager/studentStatus/pebzzstudent.xls'
								...
								<tr valign="bottom" class="postFormBox">
									...
									<td valign="bottom">
										...
										<s:select name="batchid" id="batchid" list="peBzzBatch" listKey="id" listValue="name" label="选择学期信息"
										 headerKey="0" headerValue="请选学期信息">
										</s:select>
										<tr>
											<td>&nbsp;</td>
										</tr>
