...
public abstract class BasicScoreManage {
	 ...
	 * @throws PlatformException
	 */
	public abstract int updateElectiveScore(String studentId,
			String opencourseId, String score) throws PlatformException;
	/**
	 * 获取选课分数
	 * @param studentId
	 * @param opencourseId
	 ...
	 * @throws PlatformException
	 */
	public abstract String getElectiveScore(String studentId,
	 ...
	 * @throws PlatformException
	 */
	public abstract Map getOnlineExamScore(String studentId,
			String opencourseId) throws PlatformException;
	 ...
	 * @throws PlatformException
	 */
	public abstract int updateOnlineExamScore(String studentId,
			String opencourseId, String score,String ispass) throws PlatformException;
