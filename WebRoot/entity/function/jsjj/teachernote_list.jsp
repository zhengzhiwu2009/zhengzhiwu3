										...
										<td align=center>
											<%
												if (us.getRoleId().equals("3") || us.getRoleId().equals("R004")) {
													if (count == 0) {
											%>
											<a href="teacher_note_add.jsp?type=JSJJ" class="tj">[添加教师简介]</a>&nbsp;
										</td>
										<%
											} else {
										%>
										<a
											href="teacher_note_edit.jsp?type=JSJJ&title=<%=java.net.URLEncoder.encode(title, "UTF-8")%>&id=<%=id%>"
											class="tj">[编辑教师简介]</a>&nbsp;
										<a
											href="teacher_note_delete.jsp?type=JSJJ&title=<%=java.net.URLEncoder.encode(title, "UTF-8")%>&id=<%=id%>"
											class="tj">[删除教师简介]</a>&nbsp;
										</td>
