...
<html>
	...
	<script type="text/javascript">
		function doSubmit() {
			...
			document.myForm.action = "frequentlyAskedQuestions_edit.action";
	...
	<body>
		...
		<form action="" name="myForm">
			...
			<input type="hidden" name="id" id="id" value="<s:property value="question.id"/>">
			<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>
							<input type="text" size="50" name="title" id="title" value="<s:property value="question.title"/>">
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<s:if test="type_list != null && type_list.size() > 0">
								<s:iterator value="type_list" id="type">
									<input type="checkbox" name="type" id="type" value="<s:property value="#type[0]" />" <s:if test="question.typesIds.indexOf(#type[0]) >= 0">checked</s:if>/><s:property value="#type[1]"/>
								</s:iterator>
							</s:if>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" size="50" name="keyword" id="keyword" value="<s:property value="question.keywords"/>">
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<s:if test="role_list != null && role_list.size() > 0">
								<s:iterator value="role_list" id="role">
									<input type="checkbox" name="role" id="role" value="<s:property value="#role[0]"/>" <s:if test="question.roleIds.indexOf(#role[0]) >= 0">checked</s:if>/><s:property value="#role[1]"/>
								</s:iterator>
							</s:if>
						</td>
					</tr>
					<tr>
						...
						<td>
							<textarea rows="6" cols="70" name="description" id="description"><s:property value="question.questionDescription"/></textarea>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<textarea rows="6" cols="70" name="remark" id="remark"><s:property value="question.remarks"/></textarea>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<textarea rows="6" cols="70" name="solution" id="solution"><s:property value="question.solution"/></textarea>
						</td>
					</tr>
					<tr>
