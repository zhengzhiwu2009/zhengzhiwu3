...
<div class="main">
	<div class="main_con1" style="border-top:1px solid #C8C8C8;">
		...
		<div class=""  style="padding:45px 0 65px 200px;font:12px/1.8 "lucida grande", tahoma, verdana, arial, sans-serif, "宋体"; COLOR: #787878">
			<ul class="main_form">
				<li>
					<div class="fm_left" ><img src="/web/bzz_index/password/images/Delete-icon.png"/></div>
					<div class="fm_right">
					<p style="font-weight:bold">抱歉！您的验证地址已经失效！</p>
					<p>您可以： <a href="/password/getPsw_resendEmail.action?verifystr=<s:property value='verifystr' />">重发一封</a> 或者 <a href="/">返回首页</a></p>
					</div>       
				</li>
				<li>
