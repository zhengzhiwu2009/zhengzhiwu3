...
PeSitemanager manager = (PeSitemanager)session.getAttribute("manager");
...
<form name="inputgroupright" method="post" action="/sso/admin/siteManagerOper_updateAdminGroup.action">
