    ...
    　　<%=content%></p></td>
			...
			<tr><td align=center>
				...
				%>
				    ...
				    %>
				     <a href="teacher_note_edit.jsp?type=JSJJ&title=<%=title%>&id=<%=id%>" class="tj">[编辑教师简介]</a>&nbsp;
				     <a href="teacher_note_delete.jsp?type=JSJJ&title=<%=title%>&id=<%=id%>" class="tj">[删除教师简介]</a>&nbsp;</td>
