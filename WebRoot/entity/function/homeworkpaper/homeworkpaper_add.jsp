                                ...
                                <tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                                <tr>
		                                  ...
		                                  <td valign="top"><input name="title" class="saveHistory" type="text" size="30" maxlength="50"></td>		                                  
		                                </tr>
	                            	</table>
									</td>
                          		</tr>
                          		...
                          		<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                                <tr>
		                                  ...
		                                  <td valign="top"><textarea name="note" rows="10" cols="50" class="saveHistory"></textarea></td>		                                  
		                                </tr>
	                            	</table>
									</td>
                          		</tr>
                           		...
                           		<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                                <tr>
		                                  ...
		                                  <td valign="top">
		                                  	<INPUT type="radio" name="types" value="1" checked class="saveHistory">使用作业策略&nbsp;&nbsp;&nbsp;
		                                  	<INPUT type="radio" name="types" value="0" class="saveHistory">手工组织作业
		                                  </td>		                                  
		                                </tr>
	                            	</table>
									</td>
