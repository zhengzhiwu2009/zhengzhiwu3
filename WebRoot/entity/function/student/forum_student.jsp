...
%>
  ...
  <body>
    <form  name="forum" action="<%=basePath%>login.whaty?action=external" target="_self" method="post">
		...
		<input type="hidden" name="userRealName" value="<s:property value="peBzzStudent.getTrueName()"/>">
