				...
				<table width="100%">
					<tr>
						<td>
							...
							<a
								href="/entity/information/prVoteQuestion_toAddQuestion.action?bean.peVotePaper.id=<s:property value="peVotePaper.id"/>&status=add">[添加题目]</a>
								</s:if>
						</td>
					</tr>
					<tr>
							...
							<table width=100%>
							  <s:iterator value="prVoteQuestionList" status="num">
								<tr width="60%">
									...
									<td width="40%" nowrap="true" style="padding-top:0px;margin-top:0px;">
									<s:if test="canupdate == \"1\""> 
										<a href="/entity/information/prVoteQuestion_toEditQuestion.action?bean.id=<s:property value="id"/>&status=edit&quesType=<s:property value="enumConstByFlagQuestionType.id"/>">[修改]</a>
