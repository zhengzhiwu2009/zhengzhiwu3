...
<%
	...
	{
		response.sendRedirect("./courseware/scorm12/myCourseStatus.jsp?coursewareId="+courseware.getId()+"&courseId="+courseId+"&electiveId="+electiveId+"&opencourseId="+opencourseId);
	}
	}
	else
	{
