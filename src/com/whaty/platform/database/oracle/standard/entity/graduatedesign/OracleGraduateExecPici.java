 ...
 * 
 */
public class OracleGraduateExecPici extends Pici {

	public OracleGraduateExecPici() {

	}

	public OracleGraduateExecPici(String id) {
		dbpool db = new dbpool();
		MyResultSet rs = null;
		String sql = "";
		sql = "select a.id,a.name,starttime,endtime,subjectstime,subjectetime,opensubstime,endsubetime,subsubstime,subsubetime,rejoinstime,rejoinetime,reportgradestime,reportgradeetime,status,WRITEDISCOURSESTIME,WRITEDISCOURSEETIME,semester_id,b.name as semester_name from entity_graduate_exec_pici a,entity_semester_info b where a.semester_id = b.id(+) and a.id ='"
				+ id + "'";
		try {
			...
			EntityLog
					.setDebug("OracleGraduateExecPici@OracleGraduateExecPici(String id) error !! sql="
							+ sql);
	...
	public int add() throws PlatformException {
		...
		sql = "insert into entity_graduate_exec_pici (id,name,starttime,endtime,subjectstime,subjectetime,opensubstime,endsubetime,subsubstime,subsubetime,rejoinstime,rejoinetime,reportgradestime,reportgradeetime,status,WRITEDISCOURSESTIME,WRITEDISCOURSEETIME,semester_id) values ('"
				+ this.getId()
				+ "','"
				+ this.getName()
				+ "',to_date('"
		...
		UserAddLog.setDebug("OracleGraduateExecPici.add() SQL=" + sql + " COUNT=" + i + " DATE=" + new Date());
		return i;
	}
	...
	public int update() throws PlatformException {
		dbpool db = new dbpool();
		String sql = "";
		sql = "update entity_graduate_exec_pici set" + " id = '" + this.getId()
		...
		int i = db.executeUpdate(sql);
		UserUpdateLog.setDebug("OracleGraduateExecPici.update() SQL=" + sql + " COUNT=" + i + " DATE=" + new Date());
		return i;
	}
	...
	public int delete() throws PlatformException {
		dbpool db = new dbpool();
		String sql = "";
		sql = "delete from entity_graduate_exec_pici where id='" + this.getId()
				+ "'";
		EntityLog.setDebug("OracleGraduateExecPici@Method:delete()=" + sql);
		int i = db.executeUpdate(sql);
		UserDeleteLog.setDebug("OracleGraduateExecPici.delete() SQL=" + sql + " COUNT=" + i + " DATE=" + new Date());
		return i;
	}
	...
	public int setActive() {
		dbpool db = new dbpool();
		String sql = "";
		sql = "update entity_graduate_exec_pici set status='1' where id ='"
				+ this.getId() + "'";
		int i = db.executeUpdate(sql);
		UserUpdateLog.setDebug("OracleGraduateExecPici.setActive() SQL=" + sql + " COUNT=" + i + " DATE=" + new Date());
		return i;
	}
	...
	public int cancelActive() {
		dbpool db = new dbpool();
		String sql = "";
		sql = "update entity_graduate_exec_pici set status='0' where status = '1'";
		int i = db.executeUpdate(sql);
		UserUpdateLog.setDebug("OracleGraduateExecPici.cancelActive() SQL=" + sql + " COUNT=" + i + " DATE=" + new Date());
		return i;
	}
	...
	public int graduateDesignTimeSect() {
		dbpool db = new dbpool();
		String sql = "";
		sql = "Select * From entity_graduate_exec_pici t  Where t.status ='1' and SYSDATE between t.starttime and t.endtime+1";
	...
	public int subjectResearchTimeSect() {
		dbpool db = new dbpool();
		String sql = "";
		sql = "Select * From entity_graduate_exec_pici t  Where t.status ='1' and SYSDATE between t.subjectstime and t.subjectetime+1";
		int i = db.countselect(sql);
		return i;
	}
	...
	public int regBgCourseTimeSect() {
		dbpool db = new dbpool();
		String sql = "";
		sql = "Select * From entity_graduate_exec_pici t  Where t.status ='1' and SYSDATE between t.opensubstime and t.endsubetime+1";
		int i = db.countselect(sql);
		return i;
	}
	...
	public int discourseSumbitTimeSect() {
		dbpool db = new dbpool();
		String sql = "";
		sql = "Select * From entity_graduate_exec_pici t  Where t.status ='1' and SYSDATE between t.subsubstime and t.subsubetime+1";
		int i = db.countselect(sql);
		return i;
	}
	...
	public int rejoinRequesTimeSect() {
		dbpool db = new dbpool();
		String sql = "";
		sql = "Select * From entity_graduate_exec_pici t  Where t.status ='1' and SYSDATE between t.rejoinstime and t.rejoinetime+1";
		int i = db.countselect(sql);
		return i;
	}
	...
	public int reportGraduTimeSect() {
		dbpool db = new dbpool();
		String sql = "Select * From entity_graduate_exec_pici t  Where t.status ='1' and  SYSDATE between t.reportgradestime and t.reportgradeetime+1";
		int i = db.countselect(sql);
		return i;
	}
	public int witeDiscourseTimeSect() {
		dbpool db = new dbpool();
		String sql = "Select * From entity_graduate_exec_pici t  Where t.status ='1' and  SYSDATE between t.WRITEDISCOURSESTIME and t.WRITEDISCOURSEETIME+1";
		int i = db.countselect(sql);
		return i;
	}
