...
function FileTypeCheck()
  ...
  if(!(ExtentName == ".xls" )){
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<s:form name="batch"
			action="/entity/basic/paymentManage_batchUpload.action" method="POST"
			enctype="multipart/form-data" onsubmit="return FileTypeCheck();">
			
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr> 
    <td><div class="content_title"  id="zlb_title_start">批量导入订单对账</div ></td>
  </tr>
   <tr>
    ...
    <div class="border" style="padding-left:30px">
          <table width="96%" border="0" cellpadding="0" cellspacing="0" style="text-align:left;">
            <tr valign="bottom" class="postFormBox"> 
              ...
              <a href='/entity/manager/invoice/check_batch.xls' target=_blank>Excel模板</a></span></td> 
            </tr>
            <tr valign="bottom" class="postFormBox"> 
              <td valign="bottom"><span class="name">上载对账信息:</span></td>
              <td valign="bottom"><input type=file name="_upload" id="src"/></td>
            </tr>
            <tr class="postFormBox">
              <td ><button onclick="history.go(-1);">返回</button></td>
              <td><input type=submit value = "导入对账订单" /></td>
            </tr>
         </table>
      </div>
    </td>
