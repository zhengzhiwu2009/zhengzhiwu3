...
try
{
	...
	int totalItems;
	totalItems = testManage.getPaperPolicysNum(null,title,null,null,null,null,"experiment",teachclass_id);
	//----------分页开始---------------
		...
		//----------分页结束---------------
	List testPolicyList = testManage.getPaperPolicys(pageover,null,title,null,null,null,null,"experiment",teachclass_id);
%>
                    ...
                    <tr> 
                      <td align="right" valign="top"> 
                        <table width="70%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center"><a href="homeworkpaper_list.jsp" class="tj">[查看实验]</a>&nbsp;</td>
                      ...
                      <td align="center" background="images/tablebian.gif">
						<table width="99%" border="0" cellspacing="0" cellpadding="0" class="mc1">
                          <tr bgcolor="<%=trBgcolor%>"> 
                            ...
                            <td width="21%" align="center"  class="td1">课程实验</td>
                            <td width="15%" align="center"  class="td1">
                     		<%if(!type.equals("list")){%>
                            <a href="homeworkpaper_add_bypolicy.jsp?id=<%=policyId%>&paperId=<%=paperId%>">组卷</a>
                      		<%}%>
