...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('homeworkpaper_pre.jsp?id=<%=paperId%>&tsId=<%=tsId%>','xgzy','resizable,width=800,height=600')">修改</a>
<%
		}else{%>
	<a href="homeworkhistory_info.jsp?tsId=<%=tsId%>" border=0 target=_blank>查看</a>
<%		}
	}
%>
							</td>
