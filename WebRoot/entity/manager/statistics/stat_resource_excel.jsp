...
<table x:str border=0 cellpadding=0 cellspacing=0 width=767 style='border-collapse:
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=total_course_num%>　</td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=jichu_course_num%>　</td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=tisheng_course_num%></td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=total_course_time%>　</td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=jichu_course_time%>　</td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=tisheng_course_time %>　</td>
 </tr>
 <%
 }
 db.close(rs);%>
