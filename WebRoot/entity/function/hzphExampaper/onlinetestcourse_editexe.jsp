...
<%
	try {
		...
		int count = testManage.updateOnlineTestCourse(testCourseId,title,note,startDate,endDate,status,isAutoCheck,isHiddenAnswer,null,teachclass_id,null,batch_id);
