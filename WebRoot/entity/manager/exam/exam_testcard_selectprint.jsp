...
<%
   int j=0;
   for(int i=0;i<peBzzExamScores.size();i++)
   {
   		String true_name = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getPeBzzStudent().getTrueName());
 	    String gender = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getPeBzzStudent().getGender());
 	    String reg_no = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getPeBzzStudent().getRegNo());
 	    String testcard_id =fixnull( ((PeBzzExamScore)peBzzExamScores.get(i)).getTestcard_id());
 	    String enterprise_name = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getPeBzzStudent().getPeEnterprise().getName());
 	    String site_name = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getPeBzzExamBatchSite().getPeBzzExamSite().getName());
 	    String room_name = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getRoom_id());
 	    String desk_no =fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getDesk_no());
 	    String address = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getAddress());
 	    String note = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getNote());
 	    String phone = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getPhone());
 	    String exam_time = fixnull(((PeBzzExamScore)peBzzExamScores.get(i)).getExam_time());
%>
<%if(i == (peBzzExamScores.size()-1)) { %>
...
session.removeAttribute("peBzzExamScores");
 %>
</body>
