...
try
{
	...
	//	totalItems = interactionManage.getTeachClassListNum(teachclass_id,type);
...
<%
	...
	{
%>	
                            <td align="center"><a href="homeworkpaper_add.jsp?type=SMZY" class="tj">[添加纸质作业]</a>&nbsp;</td>
<%
	}
%>	                            	
                      ...
                      <td align="center" background="../images/tablebian.gif">
						<table width="99%" border="0" cellspacing="0" cellpadding="0" class="mc1">
                          <tr bgcolor="<%=trBgcolor%>"> 
                           	<td width="45%"  class="td1"><a href="homeworkpaper_info.jsp?id=<%=paperId%>&paperId=<%=paperId %>&type=SMZY&title=<%=title%>&pageInt=<%=pageInt%>"><%=paperTitle%></a></td>
...
<%
	...
	{
%>							
                            <a href="homeworkpaper_edit.jsp?id=<%=paperId%>&type=SMZY&pageInt=<%=pageInt%>&title=<%=title%>">编辑</a>
...
<%
	...
	{
%>	 
				<a href="homeworkpaper_info.jsp?id=<%=paperId%>&type=SMZY&title=<%=title%>&pageInt=<%=pageInt%>">查看</a>
