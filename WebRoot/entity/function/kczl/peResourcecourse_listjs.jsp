						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:else>
									<s:iterator value='knowledeList' id='knowledge'>
										...
										<tr>
											<td class="td">
										<a href="/sso/peResourceInteraction_listpeResourcexq.action?ziliaoId=<s:property value="#knowledge[0]" />"><s:property value="#knowledge[1]" /></a>
											...
											<s:if test="#request.privilege==3">
												<a href="/sso/peResourceInteraction_edit.action?ziliaoId=<s:property value="#knowledge[0]" />&teachclassId=<s:property value="#knowledge[4]" />">编辑</a>
											<a href="javascript:cfmdel('/sso/peResourceInteraction_delpeResource.action?fkziliao=<s:property value="#knowledge[5]" />&teachclassId=<s:property value="#knowledge[4]" />')" class="button">删除</a>
											</s:if>	
											<a href="/sso/peResourceInteraction_loadFileLink.action?ziliaoId=<s:property value="#knowledge[0]" />" target="_blank">下载</a>
											</td>
