...
$(document).ready(function() {
  ...
  function isInvoice(flag){
	...
	/**if($selectedvalue==0) {   //当使用网银支付时，单独跳出页面进行
		$('#batch').attr("target", "_blank");
	}**/
  }
</script>
	</head>
	<body leftmargin="0" topmargin="0" >
		<s:form name="batch" id="batch"
			action="/entity/basic/peElectiveCoursePeriod_toPayment.action" method="POST">
							...
							<table style="text-align: left">
								<tr>
									<td height="28" class="" colspan="2" align="center">
										<font size="5">共需要支付</font>&nbsp;&nbsp;&nbsp;
										<font color="red" size="5"><s:property value="#session.allAmount"/>&nbsp;元&nbsp;&nbsp;</font>
										
									</td>
								</tr>
								<tr>
									<td width="10%" height="28" align="left" style="padding-left:41px">
								...
								<tr>
									<td height="28" class="" colspan="2" align="left" style="padding-left:41px">
										<input type="radio" class="radioItem" name="payMethod" value="0" />
										<font size="4">网银支付</font>
									</td>
								</tr>
								<tr>
									<td height="26" class="" colspan="2" align="left" style="padding-left:41px">
										<input type="radio" class="radioItem" name="payMethod" value="2" />
										<font size="4">电汇支付</font>
									</td>
								</tr>
								<tr>
									<td height="27" class="" colspan="2" align="left" style="padding-left:41px">
								...
								<tr>
									<td colspan="2" height="29" style="color: red;" align="center">
										<font size="4">账号：1100 1020 5000 5908 00</font>
									</td>
								</tr>
								<tr>
									<td colspan="2" height="29" style="color: red;" align="center">
