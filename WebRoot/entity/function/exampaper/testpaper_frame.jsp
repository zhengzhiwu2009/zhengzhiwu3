...
<frameset rows="60,*" cols="*" frameborder=0 border="0" framespacing="0">
  <frame src="testpaper_top.jsp?id=<%=id%>&pageInt=<%=pageInt %>" name="topFrame" scrolling="NO" frameborder="0" marginwidth="0" marginheight="0" noresize >
  <frameset rows="*" cols="0,0,*" framespacing="0" frameborder="0" border="0" marginwidth="0" marginheight="0" name="main_set" id="main_set">
    <frame src="testpaper_left.jsp?id=<%=id%>&pageInt=<%=pageInt %>" scrolling="auto" name=rightmarin" frameborder="0" marginwidth="0" marginheight="0"  noresize>
