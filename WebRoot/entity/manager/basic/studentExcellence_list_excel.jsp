	 ...
	 if(us.getRoleId().equals("3"))
	   {
		   sql_t =  
	    	   ...
	    	   "  from pe_bzz_student s, pe_enterprise e, pe_enterprise e1 , sso_user u, pe_bzz_examscore pbe,whatyforum.whatyforum_userinfo forum , pe_bzz_goodstu k1  \n" + 
	    	   " where s.fk_enterprise_id = e.id\n" + 
	    	   "   and u.id = s.fk_sso_user_id\n" + 
	    	   "   and u.flag_isvalid = '2'\n" + 
	    	   "   and pbe.total_grade = '优秀'\n" + 
	    	   "   and s.is_goodstu = 'ccb2880a91dadc115011dadfcf26b0008' \n"+
	    	   "   and s.id = k1.fk_studentid(+) and k1.submit_status = 'ccb2880a91dadc115011dadfcf26b0005' \n"+
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=997 style='border-collapse:
 ...
 <tr height=36 style='mso-height-source:userset;height:27.0pt'>
  <td colspan=9 height=36 class=xl24 width=997 style='height:27.0pt;width:750pt'><%=batch_name%><%=enterprise%>优秀学员列表</td>
 </tr>
