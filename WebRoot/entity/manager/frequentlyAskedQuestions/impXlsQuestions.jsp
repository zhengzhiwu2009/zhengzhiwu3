...
function FileTypeCheck()
  ...
  var obj =document.getElementById('src');
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<s:form name="batch"
			action="/entity/basic/frequentlyAskedQuestions_BatchUpload.action" method="POST"
			enctype="multipart/form-data" onsubmit="return FileTypeCheck();">
			
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr> 
    <td><div class="content_title"  id="zlb_title_start">导入常见问题</div ></td>
  </tr>
   <tr>
  ...
  <tr> 
    ...
    <div class="border" style="padding-left:30px">
          <p>&nbsp;</p>
          <p align="left"><font color=red>提示：导入数据最多1000条</font></p>
          <p>&nbsp;</p>
          <table width="96%" border="0" cellpadding="0" cellspacing="0" style="text-align:left;">
            <tr valign="bottom" class="postFormBox"> 
              ...
              <a href='/entity/manager/frequentlyAskedQuestions/question_imple_batch.xls' target=_blank>Excel报表</a></span></td>
            </tr>
            <tr valign="bottom" class="postFormBox"> 
            ...
            <tr class="postFormBox">
              <td >&nbsp;</td>
              <td><input type=button  onclick=" return submits();" value = "导入常见问题" /></td>
            </tr> 
           <!--   <tr class="postFormBox">
              <td >&nbsp;</td>
