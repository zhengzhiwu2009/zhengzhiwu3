...
<html>
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<s:form name="batch" id="batch"
			action="/entity/basic/paymentLive_toConfirmOrderStu.action" method="POST" target="_blank">
			<input type="hidden" name="bid" id="bid" value='<s:property value="#request.id"/>' />
			...
			<tr>
				<td height="28">
					<div class="content_title"  id="zlb_title_start">在线直播支付确认</div id="zlb_title_end">
				</td>
			</tr>
			<tr>
						...
						<table  width='98%' border="0" cellpadding="0" cellspacing='0' style='margin-bottom: 5px'>
							<tr>
								<td height="30" align="left">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;直播名称：
									<font color="red"><s:property value="#request.courseName" /></font>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;所选人数：
