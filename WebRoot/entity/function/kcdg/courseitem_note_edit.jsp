...
<form action="courseitem_note_editexe.jsp" method="POST" name="frmAnnounce" onsubmit="return chkSubmit()">
...
<input type=hidden name=pageInt value=<%=pageInt %>>
                          ...
                          <tr>
							...
							<input type=text name=title class=input1 size=60 value="<%=title1%>">
							 ...
							 -->
                          		...
                          		<tr>
                          		<td class="neirong" valign=top width=20%" nowrap="nowrap">
							<font size=2>内容：</font>
							</td>
							<%
		...
		<tr>
			<td align=center><input type=submit value="提交" id="sub">&nbsp;&nbsp;<input type=button value="返回" onclick="window.location='courseitemnote_list.jsp?pageInt=<%=pageInt %>&title=<%=title1%>'"></td>
		</tr>
                  </table> </td>
              </tr>
            </table></td>
