...
<%
	...
	//String paperId = fixnull(request.getParameter("paperId"));
	 String paperIds = request.getParameter("paperls");	 
	...
	try {
		...
		int totalItems;
		totalItems = testManage.getPaperPolicysNum(null,title,null,null,null,null,"test",teachclass_id);
		//----------分页开始---------------
		...
		String link = "&title="+title+"&type="+type;
		//----------分页结束---------------
		List testPolicyList = testManage.getPaperPolicys(pageover,null,title,null,null,null,null,"test",teachclass_id);
%>
                    ...
                    <tr> 
                      <td align="right" valign="top"> 
                        <table width="70%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" nowrap="nowrap" width="30%"><a href="testpaper_list.jsp" class="tj">[返回试卷列表]</a>&nbsp;</td>
                            <td align="center"><img src="../images/xb.gif" width="48" height="32"></td>
                            <td>
                            	<form method="post" action="testpaperpolicy_list.jsp?type=list" name="paper_listSearchForm">
                 ...
                 <tr>
                   <td height="26" background="../images/tabletop.gif">
                    ...
                    <tr>
					  ...
					  <td width="1%" align="center" valign="bottom"><img src="images/topxb.gif" style="display: none"></td>
                      <td width="16%" align="center" class="title" style="display: none">发布人</td>
                      ...
                      <td align="center" background="images/tablebian.gif">
						<table width="99%" border="0" cellspacing="0" cellpadding="0" class="mc1">
                          <tr bgcolor="<%=trBgcolor%>"> 
                            ...
                            <td width="24%"  align="center" class="td1"><a href="#" onclick="window.open('paperpolicy_info.jsp?id=<%=testPaperPolicy.getId()%>','','dialogWidth=800px;dialogHeight=500px,scrollbars=yes')"><%=policyTitle%></a></td>
                            <td width="18%" align="center"  class="td1" style="display: none"><%int index = creatUser.indexOf(")"); String str=creatUser.substring(index+1); %><%=str%></td>
                            <td width="17%" align="center"  class="td1"><%=creatDate%></td>
                            <td width="21%" align="center"  class="td1">在线自测</td>
                            <%if("teacher".equalsIgnoreCase(userType)&&us.getUserLoginType().equals("3")){ %>
                            <td width="15%" align="center"  class="td1">
                     		<%if(!type.equals("list")){%>
                            <a href="testpaper_add_bypolicy2.jsp?policyId=<%=policyId%>&paperIds=<%=paperIds%>">组卷</a>
                      		<%} else {%>
                      		<a href="paperpolicy_modify.jsp?policyId=<%=policyId%>" class="button">编辑</a>
                            <a href="javascript:cfmdel('paperpolicy_delexe.jsp?title=<%=title%>&type=<%=type%>&pageInt=<%=pageInt%>&policyId=<%=policyId%>')" class="button">删除</a>
                            <%} %>
                            </td>
                            <%}
                             %>
...
<table width="806" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td background="images/bottom02.gif"><%@ include file="../pub/dividepage.jsp" %>
                      </td>
                    </tr>
                    <tr>
