...
<tr>
  ...
  %>
    ...
    <td valign="top" class="text" align="center"><strong><%=enterprise_name %>&nbsp;&nbsp;&nbsp;年龄分布情况</strong></td>
  </tr>
  <%}
         db.close(rs);
   %>
  ...
  <tr> 
    <td valign="top" class="text" align="center"> <div id="chartdiv" align="center"> 
      ...
      <script type="text/javascript">
		   var chart = new FusionCharts("<%=request.getContextPath() %>/entity/manager/statistics/fusioncharts/Column3D.swf",  "ChartId", "500", "350", "0", "0");
		    var d = "<%=enterprise_id%>|"+"<%=batch_id%>|"+Math.random();
		   chart.setDataURL("<%=request.getContextPath() %>/entity/manager/statistics/chart/chart_enterprise_age.jsp?d="+d);		   
  ...
  <tr>
    <td valign="top" class="text" align="center">&nbsp;</td>
  	...
  	<tr>
          <td class="text" align="center"><a href="/entity/manager/statistics/stat_enterprise.jsp?pageInt1=<%=pageInt1%>&search1=<%=search1%>&pageInt=<%=c_pageInt%>&search=<%=c_search%>&id=<%=batch_id%>&name=<%=name%>">返回</a>
          <a href="/entity/manager/statistics/stat_enterprise_age_excel.jsp?d=<%=enterprise_id%>|<%=batch_id%>|<%=new Date().getTime()%>">导出</a>
          </td>
        </tr>
