		  ...
		  <tr>
			...
			<table width="670" border="0" cellpadding="0" cellspacing="0" background="/web/news/images/1_12.jpg">
              <tr>
                ...
                <td width="96%" class="newsbtitle" align="left">使用浏览器登录邮箱的说明</td>
              </tr>
            </table></td>
		  </tr>
		  <tr>
			<td style="padding-top:5px;">
			<p class="newsp"><B>一、操作系统为</B>（括号内为建议使用的文档版本号，下同）</P>
            <p class="newsp">&nbsp;&nbsp; Microsoft Windows98（第二版4.10.2222A）</P>
            <p class="newsp">&nbsp;&nbsp; Microsoft Windows Me（4.90.3000）</P>
            <p class="newsp">&nbsp;&nbsp; Microsoft Windows 2000（版本5.0）</P>
            <p class="newsp"><B>IE浏览器为</B></P>
            <p class="newsp">&nbsp;&nbsp; Microsoft Internet Explorer 版本6.0（.2600.0000）</P>
            <p class="newsp">&nbsp;&nbsp; Microsoft Internet Explorer 版本5.00（.2614.3500）</P>
            <p class="newsp">点击邮箱入口链接（进入gdou邮箱），弹出认证窗口如下：</P>
            <p class="newsp"><IMG height=237 src="/web/mail/images/01.jpg" width=402></P>
            <p class="newsp">输入用户名，密码，域（gdou）。单击确定：（<B>不要在“将密码存入密码表中”前打“√”）</B></P>
            <p class="newsp"><IMG height=237 src="/web/mail/images/02.jpg" width=402></P>
            <p class="newsp"><B>二、操作系统为：</B>Microsoft Windows XP（版本5.1）</P>
            <p class="newsp"><B>IE浏览器为：</B>Microsoft Internet Explorer 版本6.0（.2600.0000）</P>
            <p class="newsp">点击邮箱入口链接（进入gdou邮箱），弹出认证窗口如下：</P>
            <p class="newsp"><IMG height=282 src="/web/mail/images/03.jpg" width=326></P>
            <p class="newsp">在用户名处输入Email地址，在密码处输入密码，单击确定：（<B>不要在“记住我的密码”前打“√”）</B></P>
            <p class="newsp"><IMG height=282 src="/web/mail/images/04.jpg" width=326></P>
            <p class="newsp">&nbsp;</P>
