    ...
    <td  width="703" height="210" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="703" height="163">
      ...
      <table width="703" height="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <tr>
			...
			<table width="670" border="0" cellpadding="0" cellspacing="0" background="/web/news/images/1_12.jpg">
              <tr>
                ...
                <td width="96%" class="newsbtitle" align="left">使用outlook2002登录邮箱的说明</td>
              </tr>
            </table></td>
		  </tr>
		 ...
		 <p class="newsp"><B>配置outlook2002：</B></P>
            <p class="newsp">打开Outlook窗口，选择“工具”—&gt;“电子邮件账户”</P>
            <p class="newsp"><IMG height=364 src="/web/mail/images/12.jpg" width=553></P>
            <p class="newsp">选择“添加新电子邮件账户”，单击“下一步”</P>
            <p class="newsp"><IMG height=364 src="/web/mail/images/13.jpg" width=553></P>
            <p class="newsp">选择“POP3”，单击“下一步”</P>
            <p class="newsp"><IMG height=364 src="/web/mail/images/14.jpg" width=553></P>
            <p class="newsp">输入相关信息，单击“测试账户设置”</P>
            <p class="newsp"><IMG height=228 src="/web/mail/images/15.jpg" width=489></P>
            <p class="newsp">单击“关闭”退回上一界面。</P>
            <p class="newsp"><B>单击“其他设置”配置发送邮件服务器要求身份验证</B></P>
            <p class="newsp"><IMG height=412 src="/web/mail/images/16.jpg" width=385></P>
            <p class="newsp">在“我的发送服务器（SMTP）要求验证”前打“√”，单击“确定”，返回上一界面，单击“下一步”</P>
            <p class="newsp"><IMG height=364 src="/web/mail/images/17.jpg" width=553></P>
            <p class="newsp">单击“完成”。</P>
            <P align=center class="newsp"><A href="/web/mail/oe.jsp"><FONT 
            color=#ff0000>&gt;&gt; 使用Outlook Express登录邮箱的说明</FONT></A></P><A 
            href="http://218.19.140.210/mail/oe.htm">
            <p class="newsp">&nbsp;</P></A>
