...
//	List cwareList=interactionManage.getCoursewares(teachclass_id);
    ...
    <td height="26" background="../../../images/help_bt12.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="meau_hu">　<a href="/entity/function/coursenote_list.jsp?open_course_id=<%=teachclass_id%>" target=contentBox>课 程 简 介</a></td>
      </tr>
    </table></td>
  </tr>
   <tr>
    <td height="26" background="../../../images/help_bt12.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="28" align="right"><img src="../../../images/ico01.gif" width="11" height="10"></td>
        <td class="meau_hu">　<a href="/entity/function/teachernote_list.jsp?open_course_id=<%=teachclass_id%>" target=contentBox>教 师 简 介</a></td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td height="26" background="../../../images/help_bt12.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="28" align="right"><img src="../../../images/ico01.gif" width="11" height="10"></td>
        <td class="meau_hu">　<a href="/entity/workspaceTeacher/interactionHomework_toHomeworkList_student.action?teachclassId=<%=teachclass_id %>" target=contentBox>上 传 作 业</a></td>
      </tr>
    </table></td>
  </tr>
  <%
  ...
  <tr>
    <td height="26" background="../../../images/help_bt12.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="28" align="right"><img src="../../../images/ico01.gif" width="11" height="10"></td>
        <td class="meau_hu">　<a href="../../../../experimentpaper/homeworkpaper_list.jsp" target=contentBox>课 程 实 验</a></td>
      </tr>
    </table></td>
  </tr>
  <%
  ...
  <tr>
    <td height="26" background="../../../images/help_bt12.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="28" align="right"><img src="../../../images/ico01.gif" width="11" height="10"></td>
        <td class="meau_hu">　<a href="../../../../exampaper/onlinetestcourse_list.jsp" target=contentBox>在 线 考 试</a></td>
      </tr>
    </table></td>
  </tr>
  <%
