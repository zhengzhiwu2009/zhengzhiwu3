...
<%
	...
	String type1 = fixnull(request.getParameter("type1"));//这个是目的就是添加题目的返回的按钮的根据来的type1 的不同而使用不同的按钮。
...
try
{
	...
	int totalItems;
	totalItems = testManage.getPaperPolicysNum(null,title,null,null,null,null,"homework",teachclass_id);
	//----------分页开始---------------
		...
		//----------分页结束---------------
	List testPolicyList = testManage.getPaperPolicys(pageover,null,title,null,null,null,null,"homework",teachclass_id);
%>
                    ...
                    <tr> 
                      <td align="right" valign="top"> 
                        <table width="80%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" width="30%"><a href="homeworkpaper_list.jsp" class="tj">[查看作业]</a>&nbsp;</td>
                            <td align="center"><img src="../images/xb.gif" width="48" height="32"></td>
                            	<form method="post" action="homeworkpaperpolicy_list.jsp" name="paper_listSearchForm">
                            	<input type="hidden" name="paperId" value=<%=paperId%>/>
                   			<td align="center" width="30%" class="mc1">按标题搜索：</td>
                      ...
                      <td align="center" background="images/tablebian.gif">
						<table width="99%" border="0" cellspacing="0" cellpadding="0" class="mc1">
                          <tr bgcolor="<%=trBgcolor%>"> 
                            <td width="5%" align="center" valign="middle" class="td1" onClick="window.open('paperpolicy_info.jsp?id=<%=testPaperPolicy.getId()%>','','dialogWidth=800px;dialogHeight=500px,scrollbars=yes')"><a href="" onclick="return false;"><img src="images/xb2.gif" width="8" height="8" border="0"></a></td>
                            <td width="24%"  class="td1" onClick="window.open('paperpolicy_info.jsp?id=<%=testPaperPolicy.getId()%>','','dialogWidth=800px;dialogHeight=500px,scrollbars=yes')"><a href="" onclick="return false;"><%=policyTitle%></a></td>
                            ...
                            <td width="21%" align="center"  class="td1">在线作业</td>
                            <td width="15%" align="center"  class="td1">
                     		<%if(!type.equals("list")){%>
                            <a href="homeworkpaper_add_bypolicy.jsp?id=<%=policyId%>&paperId=<%=paperId%>&type1=<%=type1%>">组卷</a>
                      		<%} else {%>
