...
if(formToken!=null && !formToken.equals(session.getAttribute("formToken"))) {
	request.getRequestDispatcher("/error/tokenError.jsp").forward(request,response);
...
<script type="text/javascript">
	alert("您输入的信息不存在！");
	window.navigate("/web/bzz_index/czmm/find.jsp");
</script>
<%
	return;
}
...
<table width="993" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="54" align="center" valign="middle" background="web/bzz_index/images/bottom_08.jpg"><span class="down">版权所有：中国证劵业协会
      <BR>
      投诉：010-11110000 
