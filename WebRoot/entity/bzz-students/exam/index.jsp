        ...
        <table width="208" height="42" border="0" cellpadding="0" cellspacing="0" bgcolor="#DBC4F2" >
          ...
          <tr>
            ...
            <s:if test="peBzzExamBatch != null">
              ...
              <tr>
                <td width="107" height="45" align="center" valign="top" background="/entity/bzz-students/exam/images/menu3bg1.jpg" style="background-repeat:no-repeat; padding-top:8px; padding-left:14px"><a href="/entity/workspaceStudent/bzzstudent_examBat.action" target="mainer" class="menuzi">考试报名<br/>及缓考申请</a></td>
              ...
              <tr>
                <td width="107" height="45" align="center" valign="top" background="/entity/bzz-students/exam/images/menu7bg.jpg" style="background-repeat:no-repeat; padding-top:8px; padding-left:14px"><a href="/entity/workspaceStudent/bzzstudent_toStudentSco.action" target="mainer" class="menuzi">成绩查询</a></td>
              ...
              <tr>
                <td width="107" height="45" align="center" valign="top" background="/entity/bzz-students/exam/images/menu3bg1.jpg" style="background-repeat:no-repeat; padding-top:8px; padding-left:14px"><a href="/entity/workspaceStudent/bzzstudent_toExamIdentity.action" target="mainer" class="menuzi">考试报名<br/>及缓考申请</a></td>
          ...
          <!--<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
               <tr>
                <td valign="top" background="/entity/bzz-students/exam/images-exam/leftbtbg.jpg" style="background-position:bottom; background-repeat:no-repeat;"><table style="margin-top:15px" width="206" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" class="bai" style="padding-left:10px"> <img src="/entity/bzz-students/exam/images-exam/tubiao2.jpg" width="12" height="12"> 您本次学习时长为</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="30" class="bai" style="padding-left:10px"><img src="/entity/bzz-students/exam/images-exam/tubiao2.jpg" width="12" height="12"> 您学习总时长为</td>
                  </tr>
                  <tr>
