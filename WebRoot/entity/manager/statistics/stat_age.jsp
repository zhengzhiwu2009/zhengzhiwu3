...
<tr>
  ...
  %>
    <td valign="top" class="text" align="center"><strong><%=batch_name %>学期&nbsp;&nbsp;&nbsp;年龄分布情况</strong></td>
  </tr>
  <%}
         db.close(rs);
   %>
  <tr> 
    <td valign="top" class="text" align="center"> <div id="chartdiv" align="center"> 
      ...
      <script type="text/javascript">
		   ...
		   chart.setDataURL("<%=request.getContextPath() %>/entity/manager/statistics/chart/chart_age.jsp?d="+d);		   
  ...
  <tr>
    ...
    <a href="/entity/manager/statistics/stat_age_excel.jsp?d=<%=batch_id%>|<%=new Date().getTime()%>">导出</a></td>
  </tr>
</table>
</body>
</html>
