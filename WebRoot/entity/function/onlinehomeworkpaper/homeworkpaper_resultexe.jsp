...
<%
	...
	try {
		...
		//String percent =nf.format(double1);
		String percent=this.percent(right,total);
		...
		{	
			...
			count = testManage.addHomeworkPaperHistory(user_id,id,map,ischeck,total,percent,totalType,user.getId());
			link = "homeworkpaper_list.jsp";
		}
		else
		{
			count = testManage.updateHomeworkPaperHistory(tsId,user_id,id,map,ischeck,total,percent,totalType);
