...
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr>
    <td class="text" align="center"><a href="#" onclick="javascript:window.history.back()">返回</a>
    <a href="/entity/manager/statistics/stat_period_excel.jsp?d=<%=batch_id%>|<%=sDate%>|<%=eDate%>|<%=new Date().getTime()%>">导出</a></td></td>
  </tr>
</table>
