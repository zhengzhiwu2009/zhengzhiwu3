    ...
    <div class="cntent_k">
   	  <div class="k_cc" style="height:380px">
	  		<table align="center" border="0" width="700">
				<tr><td height="25" align="center" class="aaa"><s:property value="#request.reportInfo.title"/> </td></tr>
				<tr valign="top"><td height="300px" style="background-color: #E4F0F0;
						border-bottom-width: 3px;
						border-bottom-style: solid;
						border-bottom-color: #FFFFFF;"><br/><p><s:property value="#request.reportInfo.note" escape="false"/>
