...
//			paperId = testManage.addHomeworkPaper(title,creatUser,status,note,null,startDate,endDate,"1",teachclass_id);
		...
		//指定题目作业
			paperId = testManage.addHomeworkPaper(title,creatUser,status,note,null,startDate,endDate,"0",teachclass_id,batch_id);
		}
...
//	location.href = "homeworkpaperpolicy_list.jsp?paperId=<%=paperId%>&type1=<%=types%>";
	location.href = "/entity/function/onlinehomeworkpaper/paperpolicy_add1_exam.jsp?";
</script>
<%
