      ...
      <table width="703" height="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <tr>
			...
			<a href="/entity/first/firstInfoNews_toNewsList.action?type=<s:property value="peInfoNews.peInfoNewsType.id"/>">
			<font class="positions" ><s:property value="peInfoNews.peInfoNewsType.name"/></font></a>>>新闻内容</td>
		  </tr>
		  <tr>
			<td align="center">
			<table width="670" border="0" cellpadding="0" cellspacing="0" background="/web/news/images/1_12.jpg">
              <tr>
                ...
                <td width="96%" class="newsbtitle" align="left"><s:property value="peInfoNews.title"/></td>
              </tr>
            </table></td>
		  </tr>
		  <tr>
			<td align="right" class="secondtitle"><s:date name="peInfoNews.reportDate" format="yyyy-MM-dd HH:mm:ss" />  【<a href="#"><span class="orange">打印</span></a>】  【点击次数：<s:property value="peInfoNews.readCount"/>】</td>
		  </tr>
		  <tr>
			<td style="padding-top:5px;" width="703">
        	<FONT class="newsp"><s:property value="peInfoNews.getNote()" escape="false"/></FONT><br/>
<!-- 
     		 <s:if test="peInfoNews.pictrue.length()>0">
     		 	<IMG alt="" src="..<s:property value="peInfoNews.pictrue"/>"/>
     		 </s:if>
 -->
  ...
  <tr>
    <td width="703"  height="68" valign="top" style="background-image:url(/web/news/images/1_11.jpg); background-repeat:repeat-x;" align="center" class="banquan">版权所有：中国证劵业协会<br />
