...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_resource_total_excel.xls"); %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=344 style='border-collapse:
 ...
 <tr height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  width:258pt'><%=batch_name%>总开课信息</td>
 </tr>
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl24 style='height:14.25pt;border-top:none'>课程名称</td>
  <td class=xl24 style='border-top:none;border-left:none'>学时</td>
 </tr>
 <%
 ...
 <tr height=16 style='mso-height-source:userset;height:12.0pt'>
  ...
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=course_time%>　</td>
 </tr>
 <%}
 db.close(rs);
 %>
