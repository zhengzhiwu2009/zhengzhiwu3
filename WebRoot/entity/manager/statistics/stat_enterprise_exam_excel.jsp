	...
	if(!sql_ent.equals(""))
	{
		...
		sql_con1=" and bs.fk_enterprise_id in "+sql_ent;
				...
				String sql = 
					...
					"       nvl(kk.num, '0') as bukao_total_num,\n" +   //补考报名考试总人数
					"       nvl(ll.num, '0') as bukao_pass_num,\n" +     //补考审核通过人数
					"       nvl(mm.num, '0') as huankao_total_num,\n" +   //缓考报名考试总人数
					"       nvl(nn.num, '0') as huankao_pass_num\n" +     //缓考审核通过总人数
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1060 style='border-collapse:
 ...
 <tr height=50 style='mso-height-source:userset;height:37.5pt'>
  <td colspan=30 height=50 class=xl24 width=1060 style='height:37.5pt;
