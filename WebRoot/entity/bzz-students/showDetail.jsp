				...
				<tr>
					<td>
						<%
							...
							Object liveSum = ServletActionContext.getRequest().getAttribute("liveSum");
							Object livePerc = ServletActionContext.getRequest().getAttribute("livePerc");
						...
						%>
						您的本次学习直播课程累计时间为：
						<b><%=minSum==null?"-":minSum %></b> 分钟。
						直播课程的累计时间为：<b><%=liveSum==null?"-":liveSum %></b> 分钟 ，累计时间占比为：<b><%=livePerc==null?"-":livePerc %>%</b>。
						<%
							}
						%>
					</td>
