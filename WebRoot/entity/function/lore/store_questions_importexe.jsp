...
<%
	   ...
	   try{
		...
		String creatuser = new String(user.getName().getBytes("iso8859-1"),"UTF-8");
...
java.util.Date sDate = new java.util.Date();
		...
		*/
			...
			if(purpose.indexOf("随堂练习")==-1&&purpose.indexOf("课后测验")==-1){
...
*/			
			...
			String questioncore = sheet.getCell(2, i).getContents().trim();
		...
		//	String teacherNote = sheet.getCell(6, i).getContents().trim();
			...
			if(type.equals(QuestionType.DANXUAN)) {
				if(cols == 9 && "单选题".equals(modeltype)) {
				String xml = "<question><body>" + questioncore + "</body><select>";
				List optionList = new ArrayList();
				String option_strA = sheet.getCell(3, i).getContents().trim();
				String option_strB = sheet.getCell(4, i).getContents().trim();
				...
				String answer = sheet.getCell(8, i).getContents().trim();
			...
			if(type.equals(QuestionType.DUOXUAN)) {
				if(cols ==  9&& "多选题".equals(modeltype)) {
				String xml = "<question><body>" +  questioncore + "</body><select>";
				List optionList = new ArrayList();
			...
			if(type.equals(QuestionType.PANDUAN)) {
				if(cols == 4&& "判断题".equals(modeltype)) {
