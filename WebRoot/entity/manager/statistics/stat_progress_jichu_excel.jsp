...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_progress_jichu.xls"); %>
...
<%
	...
	if(us.getRoleId().equals("2") || us.getRoleId().equals("402880a92137be1c012137db62100006"))  //表示为一级主管和一级辅导员
	{
	   ...
	   sql=" select ps.id, sum(ce.time*(ts.percent/100)) as stime  from sso_user su , "+sql_training+
	       ...
	       " and co.id = ts.course_id and co.fk_course_id = ce.id and  ps.fk_batch_id = co.fk_batch_id and su.flag_isvalid='2'  "
