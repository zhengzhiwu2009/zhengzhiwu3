...
<%	response.setHeader("Content-Disposition", "attachment;filename=exam_student_score_excel.xls"); %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1131 style='border-collapse:
 ...
 <tr height=52 style='mso-height-source:userset;height:39.0pt'>
  <td colspan=9 height=52 class=xl26 width=1131 style='height:39.0pt;
  width:848pt'>考试学员成绩信息表</td>
 </tr>
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl24 style='border-top:none;border-left:none'>所在考试批次</td>
  <td class=xl24 style='border-top:none;border-left:none'>总评成绩</td>
  <td class=xl24 style='border-top:none;border-left:none'>总评等级</td>
  <td class=xl24 style='border-top:none;border-left:none'>考试状态</td>
 </tr>
 <%
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl25 style='border-top:none;border-left:none'><%=exambatch_name %>　</td>
  <td class=xl25 style='border-top:none;border-left:none'><%=total_score %>　</td>
  <td class=xl25 style='border-top:none;border-left:none'><%=total_grade %>　</td>
  <td class=xl25 style='border-top:none;border-left:none'><%=exam_status %>　</td>
 </tr>
 <%}
	 db.close(rs);%>
