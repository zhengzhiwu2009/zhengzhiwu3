			...
			<table cellspacing="0" cellpadding="0">
				<s:iterator value='#request.courseDetail' id='items'>
					...
					<tr>
						...
						<td>
							<span style="margin-left:20px;"><s:property value="#items[5]" /></span>
						</td>
						<th>
							拟停用日期：
						</th>
					...
					<tr>
						...
						<td>
							<span style="margin-left:20px;"><s:date name="#items[8]" format="yyyy-MM-dd" /></span>
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						...
						<td>
							<span style="margin-left:20px;"><s:property value="#items[25]" /></span>
						</td>
						<th>
							建议学习人群：
						</th>
					...
					<tr>
						...
						<td>
							<s:if test="#items[19]==null">
								<span style="margin-left:20px;">未上传</span>
							</s:if>
							<s:else>
								<span style="margin-left:20px;"><img src="<s:property value='#items[19]' />" height="200" width="300" /></span>
							</s:else>
						</td>
						<th>
							主讲人照片：
						...
						<td>
							...
							<s:else>
								<span style="margin-left:20px;"><img src="<s:property value='#items[20]' />"  height="200" width="260" /></span>
							</s:else>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colSpan="3">
							<span style="margin-left:20px;"><s:property value="#items[21]" escape="false" /></span>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td colSpan="3">
							<span style="margin-left:20px;"><s:property value="#items[22]" /></span>
						</td>
					</tr>
				</s:iterator>
			</table>
