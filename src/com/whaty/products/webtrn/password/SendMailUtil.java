...
public class SendMailUtil {
	...
	//邮件用户名
	/* String mailUser = "xuxiaoliang@whaty.com"; //你通过哪个帐号发送邮件
	 String host = "mail.whaty.com";     //你通过哪个主机发送邮件
	 String pwd = "whaty123";   //你所要通过的帐号的密码是多少，也就是mailUser的密码
	*/
	
	/*String mailUser = "webtrn@163.com"; //你通过哪个帐号发送邮件
	String host = "smtp.163.com"; //你通过哪个主机发送邮件
	String pwd = "z9z7w7w8whaty123"; //你所要通过的帐号的密码是多少，也就是mailUser的密码
*/	
	
	String mailUser = "service@webtrn.cn"; //你通过哪个帐号发送邮件
	String host = "mail.whaty.com";     //你通过哪个主机发送邮件
	String pwd = "serviceyanfa123";   //你所要通过的帐号的密码是多少，也就是mailUser的密码
