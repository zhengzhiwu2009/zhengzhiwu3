...
import com.whaty.platform.courseware.basic.NormalHttpCourseware;
...
public class OracleNormalHttpCourseware extends NormalHttpCourseware {

	public OracleNormalHttpCourseware(String coursewareId) {
		super();
...
//				+ coursewareId + "'";
		...
		try {
//			CoursewareLog.setDebug("OracleNormalHttpCourseware:"+sql);
			...
			while (rs != null && rs.next()) {
				...
				this.setHttpLink(rs.getString("link"));
	...
	public int add() throws PlatformException {
		String sql = "update PE_TCH_COURSEWARE set LINK='" + this.getHttpLink()
				+ "COURSEWARE_TYPE='" + CoursewareType.NORMALHTTP
				+ "' where id='" + this.getId() + "'";
		dbpool db = new dbpool();
		int i = db.executeUpdate(sql);
		UserUpdateLog.setDebug("OracleNormalHttpCourseware.add() SQL=" + sql + " COUNT=" + i + " DATE=" + new Date());
		return i;
	}
