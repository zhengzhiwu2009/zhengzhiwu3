...
<form action="teacher_note_editexe.jsp" method="POST" name="frmAnnounce" onsubmit="return chkSubmit()">
...
<input type=hidden name=pageInt value=<%=pageInt %>>
		...
		<tr>
			<td align=center><input type=submit value="提交" id="sub">&nbsp;&nbsp;<input type=button value="返回" onclick="window.location='teachernote_list.jsp?pageInt=<%=pageInt %>&title=<%=title1%>'"></td>
		</tr>
                  </table> </td>
              </tr>
            </table></td>
