...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1060 style='border-collapse:
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=b_uncheck_num %>　</td>
  ...
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=h_uncheck_num %>　</td>
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=h_first_num %>　</td>
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=h_final_num %>　</td>
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=h_reject_num %>　</td>
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=n_total_num %>　</td>
  ...
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=p_num %>　</td>
  <td class=xl32 style='border-top:none;border-left:none' x:num><%=Integer.parseInt(b_final_num)-Integer.parseInt(o_num) %>　</td>
  <td class=xl32 style='border-top:none;border-left:none'><%=new BigDecimal(Float.parseFloat(k_num)*100/shikao_num).setScale(1, BigDecimal.ROUND_HALF_UP)%>%</td>
  <td class=xl32 style='border-top:none;border-left:none'><%=new BigDecimal(Float.parseFloat(l_num)*100/shikao_num).setScale(1, BigDecimal.ROUND_HALF_UP)%>%</td>
  <td class=xl32 style='border-top:none;border-left:none'><%=new BigDecimal(Float.parseFloat(m_num)*100/shikao_num).setScale(1, BigDecimal.ROUND_HALF_UP)%>%</td>
  <td class=xl32 style='border-top:none;border-left:none'><%=new BigDecimal(Float.parseFloat(n_num)*100/shikao_num).setScale(1, BigDecimal.ROUND_HALF_UP)%>%</td>
  <td class=xl32 style='border-top:none;border-left:none'><%=new BigDecimal((Float.parseFloat(k_num)+Float.parseFloat(l_num)+Float.parseFloat(m_num))*100/shikao_num).setScale(1, BigDecimal.ROUND_HALF_UP)%>%</td>
 </tr>
           <% } 
              db.close(rs); 
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=b_uncheck_count %>　</td>
  ...
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=h_uncheck_count %>　</td>
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=h_first_count %>　</td>
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=h_final_count %>　</td>
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=h_reject_count %>　</td>
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=n_total_count %>　</td>
  ...
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=p_count %>　</td>
  <td class=xl31 style='border-top:none;border-left:none' x:num><%=b_final_count-o_count %></td>
  ...
  <td class=xl31 style='border-top:none;border-left:none'><%=new BigDecimal(n_count*100.0/shikao_count).setScale(1, BigDecimal.ROUND_HALF_UP)%>%</td>
