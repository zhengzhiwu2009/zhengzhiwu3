    ...
    <td  width="703" height="210" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="703" height="163">
      ...
      <table width="703" height="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <tr>
			<td class="positions">当前位置：<a href="/entity/first/firstInfoNews_toIndex.action"><font class="positions">首页</font></a>>>公告内容</td>
		  </tr>
		  <tr>
			<td align="center">
			<table width="670" border="0" cellpadding="0" cellspacing="0" background="/web/news/images/1_12.jpg">
              <tr>
                ...
                <td width="96%" class="newsbtitle" align="left"><s:property value="bulletin.title"/></td>
              </tr>
            </table></td>
		  </tr>
		  <tr>
			<td align="right" class="secondtitle"><s:date name="bulletin.publishDate" format="yyyy-MM-dd" /></td>
		  </tr>
		  <tr>
			<td style="padding-top:5px;">
        	<FONT class="newsp"><s:property value="bulletin.note" escape="false"/></FONT>
