...
<html>
	...
	<script type="text/javascript">
		function doSubmit() {
			...
			document.myForm.action = "courseShowTeacher_updateTeacher.action";
	...
	<body>
		...
		<form action="" name="myForm" method="post">
			...
			<input type ="hidden" name ="courseId" value="<s:property value="teacherInfo.courseId" />">
			<input type ="hidden" name ="loginId" value="<s:property value="teacherInfo.loginId" />">
