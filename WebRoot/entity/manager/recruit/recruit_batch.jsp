...
function FileTypeCheck()
  ...
  if(bathid==0){
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<s:form name="batch"
			action="/entity/recruit/peBzzRecruit_uploadExcel.action" method="POST"
					...
					<td valign="top" class="pageBodyBorder_zlb" align="center">
						<div class="cntent_k" id="zlb_content_start">
							...
							<table width="68%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr valign="bottom" class="postFormBox">
									...
									<td width="77%">
										<span class="link" help="下载Excel格式的模版表格"><img
											...
											href='/entity/manager/recruit/peBzzRecruit.xls'
								...
								<tr valign="bottom" class="postFormBox">
									<td valign="bottom">
										<span class="name">上载学员信息:</span>
									</td>
									<td valign="bottom">
										<input type=file name="upload" id="src" />
									</td>
								</tr>
										<s:select name="batchid" id="batchid" list="peBzzBatch" listKey="id" listValue="name" label="选择报名学期信息"
										 headerKey="0" headerValue="请选择报名学期信息">
										</s:select>
										<tr>
											<td>&nbsp;</td>
										</tr>
