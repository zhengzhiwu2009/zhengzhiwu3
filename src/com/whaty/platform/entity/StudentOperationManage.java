...
public abstract class StudentOperationManage {
	 ...
	 * 判断课程是否完成学习
	 */
	public abstract boolean isLearningCompleted(String courseId,
			String student_id) throws PlatformException;
	
	/**
	 * 判断课程是否完成满意度调查
	 */
	public abstract boolean isManyiCompleted(String courseId,
			String student_id) throws PlatformException;
...
//			throws PlatformException;
	...
	/**
	 * 20130105添加，用于判断选课表中是否存在成绩，如果成绩为空则显示满意度，如果不为空则可直接进入考试
	 * @param student_id
	 * @param opencourse_id
	 * @return
	 */
	public abstract boolean isShowManyi(String student_id, String course_id);
}
