...
/**
 * SatisfactionQuestionInfo entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class SatisfactionQuestionInfo extends
	...
	/** default constructor */
	public SatisfactionQuestionInfo() {
	}

	/** minimal constructor */
	public SatisfactionQuestionInfo(String questioncore, String title) {
		this.questioncore = questioncore;
		this.title = title;
	}

	/** full constructor */
	public SatisfactionQuestionInfo(String creatuser, Date creatdate,
			String diff, String questioncore, String title, String keyword,
			String lore, String cognizetype, String purpose,
			String referencescore, String referencetime, String studentnote,
			String teachernote, String type, Set satisfactionPaperquestions) {
