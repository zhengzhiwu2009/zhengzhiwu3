...
<%
		...
		%>
			<script>alert('模拟学生登陆只能查看不能添加新试卷');window.history.back();</script>
		<%
			}
		%>
<html>
...
function trim(str) { 
	...
	{	
		...
		if(document.paperForm.batch_id.value == "")
		{
			//alert("请选择学期！");
			//return false;
		}
...
<form name="paperForm" action="homeworkpaper_addexe_exam.jsp" method="post" onsubmit="return subCheck()">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top" class="bg3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="86" valign="top" background="images/top_01.gif"><img src="images/stlx.gif" width="217" height="86"></td>
              </tr>
              <tr>
                <td align="center" valign="top"><table width="608" border="1" cellspacing="0" cellpadding="0" bordercolordark="BDDFF8" bordercolorlight="#FFFFFF">
                          		...
                          		<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                                <tr>
		                                  ...
		                                  <td valign="top" class="text1"><textarea name="note" rows="10" cols="49" class="saveHistory"></textarea><br/>(1000字以内)</td>		                                  
		                                </tr>
	                            	</table>
									</td>
                          		</tr>
                          		...
                          		<tr>
                           		...
                           		<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                                <tr>
		                                  <td width="20" valign="top"><img src="images/ggzt.gif" width="20" height="32"></td>
				                          <td width="80" class="text3" valign="top">*生成试卷:</td>
		                                  <td class="text1" valign="top">
		                                	<INPUT type="radio" name="types" value="1" checked class="saveHistory">随机题目&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                      <td align="center"><a href="homeworkpaper_list_exam.jsp" class="tj">[返回]</a> </td>
                    </tr>
                  </table></td>
                    </tr>
                  </table> <br/>
