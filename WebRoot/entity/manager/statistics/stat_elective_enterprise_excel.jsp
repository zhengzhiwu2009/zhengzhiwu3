...
<%
  ...
  String sql_con="";
				...
				String sql = "select id,name,num from (select en.id,en.name,count(e.fk_stu_id) as num from pe_bzz_batch b,pe_bzz_tch_course c,pr_bzz_tch_opencourse o,pr_bzz_tch_stu_elective e,pe_bzz_student s,sso_user u,pe_enterprise en "
							+"	where s.fk_sso_user_id=u.id and u.flag_isvalid='2' and s.flag_rank_state='402880f827f5b99b0127f5bdadc70006' and b.id=o.fk_batch_id "+sql_con+" "+sql_con1+"  and c.id=o.fk_course_id and o.id=e.fk_tch_opencourse_id and e.fk_stu_id=s.id and s.fk_enterprise_id=en.id and c.id='"+course_id+"' and b.id='"+batch_id+"' "
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=581 style='border-collapse:
 ...
 <tr height=16 style='mso-height-source:userset;height:12.0pt'>
  ...
  <td class=xl25 style='border-top:none;border-left:none' x:num><%=num%>　</td>
 </tr>
 <%}
 db.close(rs);
 %>
