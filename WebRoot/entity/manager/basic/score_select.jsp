...
<script language="javascript">
		//window.open('/entity/manager/basic/score_selectprint.jsp');
		window.navigate('/entity/manager/basic/score_selectprint.jsp');
		//window.parent.location='/entity/basicx/peBzzCertificate.action';
