        ...
        <td width="180" height="100%" valign="top" background="" bgcolor="#4B8CBB" style="padding-left:4px; background-repeat:repeat-y" id="bj"><table width="208" height="42" border="0" cellpadding="0" cellspacing="0" bgcolor="#E2EEF3" >
          <tr>
            <td ><table style="margin-top:5px;" width="208" height="26" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="80" valign="top" bgcolor="#4B8CBB" class="bai"><p>·当前考试：<br/>
                </p></td>
                <td width="128" bgcolor="#4B8CBB" class="bai">第一次考试</td>
              </tr>
            </table>            
           </td>
          </tr>
          <tr>
            <td align="center" ><table style="margin-top:15px; margin-left:2px; margin-bottom:5px" width="138" border="0" cellpadding="0" cellspacing="0" bgcolor="#e2eef3">
              <tr>
                <td width="138" height="45" align="center" valign="top" background="/entity/function/student/images/menu3_1bg.jpg" style="background-repeat:no-repeat; padding-top:8px; padding-left:10px"><a href="/entity/function/lore/lore_dir_list.jsp" target="mainer" class="menuzi">题库管理</a></td>
                 <!--
               <td width="107" height="45" align="center" valign="top" background="images/menu7bg.jpg" style="background-repeat:no-repeat; padding-top:8px; padding-left:14px"><a href="/entity/function/exampaper/alert.jsp" target="mainer" class="menuzi">工具与案例</a></td>
                ...
                <tr>
                <td width="138" height="45" align="center" valign="top" background="/entity/function/student/images/menu5_1bg.jpg" style="background-repeat:no-repeat; padding-top:8px; padding-left:10px"><a href="/entity/function/onlinehomeworkpaper/homeworkpaper_list_exam.jsp" target="mainer" class="menuzi">试卷管理</a></td> 
             </tr>
          <!--    <tr>
