...
<div class="" style="width: 100%; padding: 0; margin: 0;"
			...
			<div class="main_txt">
		<form method="post" action="/entity/workspaceStudent/studentWorkspace_passwordexe.action" name="pass_chg" onsubmit="return check();">
		<table class="datalist" border="0" cellpadding="0" cellspacing="0" align="center"  width="100%">
		  ...
		  <tr class="table_bg1">
		    ...
		    <input type="button" value="返回" onclick="javascript:window.location='<%=basePath%>/entity/workspaceStudent/studentWorkspace_StudentInfo.action'"/>
		    </td>
		   </tr>
		</table>
	</form>
