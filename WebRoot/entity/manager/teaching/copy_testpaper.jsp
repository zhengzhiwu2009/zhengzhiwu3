...
<form name = "batch" action="/entity/manager/teaching/copy_testpaperexe.jsp" method="POST"  enctype="multipart/form-data" onsubmit ="return FileTypeCheck();">
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td><div class="content_title" id="zlb_title_start">复制课程自测信息</div></td>
  </tr>
