...
<table x:str border=0 cellpadding=0 cellspacing=0 width=202 style='border-collapse:
 ...
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  ...
  width:152pt'>每天最大在线人数统计</td>
 </tr>
 <tr height=18 style='mso-height-source:userset;height:13.5pt'>
  <td colspan=2 height=18 class=xl26 style='height:13.5pt'>统计时间:<%=x_date[x_date.length-1][0] %><span
  style='mso-spacerun:yes'>&nbsp;&nbsp;</span></td>
 </tr>
 <tr height=29 style='mso-height-source:userset;height:21.95pt'>
  <td height=29 class=xl25 style='height:21.95pt'>时间</td>
 ...
 <tr height=29 style='mso-height-source:userset;height:21.95pt'>
  <td height=29 class=xl25 style='height:21.95pt;border-top:none'>合计</td>
