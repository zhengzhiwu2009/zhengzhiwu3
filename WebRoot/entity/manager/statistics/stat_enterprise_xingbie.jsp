...
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
 <tr>
  ...
  %>
    <td  class="text" align="center"><strong><%=enterprise_name %>&nbsp;&nbsp;&nbsp;性别分布情况</strong></td>
...
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr> 
    <td  class="text" align="center"> <div id="chartdiv" align="center"> 
      ...
      <script type="text/javascript">
		   ...
		   chart.setDataURL("<%=request.getContextPath() %>/entity/manager/statistics/chart/chart_enterprise_xingbie.jsp?d="+d);		   
  ...
  <tr>
	...
	<tr>
          ...
          <a href="/entity/manager/statistics/stat_enterprise_xingbie_excel.jsp?d=<%=enterprise_id%>|<%=batch_id%>|<%=new Date().getTime()%>">导出</a></td>
        </tr>
</table>
</body>
</html>
