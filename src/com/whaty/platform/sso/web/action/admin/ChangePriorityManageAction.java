...
*/
	...
	public String showPage(){
		...
		List list = null;//getPrPriRoleService().getList(dc);
		setRlist(list);
...
//		d.add(Restrictions.eq("father.id","402880c31b7338f5011b733bc5830001"));
		...
		List priList = null;//getPrPriRoleService().getList(d);
...
//		dd.add(Restrictions.eq("fa.id", "402880c31b7338f5011b733bc5830001"));
		List allList = null;//getPePriorityService().getList(dd);
		setAllList(allList);
	...
	public String changeGroupRight()throws SsoException{
		...
		List list = null;//getPePriCategoryService().getList(dc);
