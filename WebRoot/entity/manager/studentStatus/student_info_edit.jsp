...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="print" method="post" action="peStudentInfo_editexe.action" enctype="multipart/form-data" onsubmit="return check();">
			<div id="main_content">
			   <div class="content_title">学员信息修改</div>
			   ...
			   <table width="80%">
			   		...
			   		<tr>
			   			<td>
			   				<div align="left" class="postFormBox"><span class="name"><label>身份证号 <font color="#FF0000">*</font></label></span></div>
			   			</td>
			   			<td>
