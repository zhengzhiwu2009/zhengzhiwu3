	...
	<body>
	   <table width="80%" class="postFormBox" >
	   		...
	   		<tr class="postFormBox" >
	   			<td ></td>
	   			<td align="center" class="pageBottomBorder" nowrap="nowrap"><span class="name"><label>系统编号</label></span></td>
	   			<td align="center" nowrap="nowrap"><span class="name"><label>姓名</label></span></td>
	   			<td align="center" class="pageBottomBorder" nowrap="nowrap"><span class="name"><label>身份证号</label></span></td>
	   		...
	   		<tr class="postFormBox" >
	   			<s:iterator status="i">
	   				<%--获取（id，系统编号，姓名，身份证号，座位号，考试成绩，成绩状态，已录入成绩，已录入成绩状态）信息--%>
