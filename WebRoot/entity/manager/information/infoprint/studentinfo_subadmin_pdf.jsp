...
<%
	...
	try {
		...
		String sql_t = "select rownum , ps.true_name as name  , ps.reg_no as regno ,  ss.password as passwords ,\n"
			...
			+ " ps.email as email  from pe_bzz_student ps inner join sso_user ss on ps.fk_sso_user_id = ss.id and ss.flag_isvalid='2' and ps.flag_rank_state='402880f827f5b99b0127f5bdadc70006' \n"
