...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td background="/web/news/images/zcxwbj_04.jpg"><div id="zcxw_tit">通知公告</div></td>
    <td width="15"><img src="/web/news/images/zcxwbj_08.jpg" width="15" height="31"></td>
  </tr>
  <tr>
    <td background="/web/news/images/zcxwbj_10.jpg">&nbsp;</td>
    <td style="padding:15px 15px;"><iframe id="xytd" name="xytd" allowtransparency="yes" frameborder="0" width="100%" scrolling="no" src="/entity/first/firstBulletin_toBulletinList.action" onload="resize()"></iframe></td>
