...
public class Test extends MyBaseAction {
	...
	public static void main(String[] args) throws Exception {
		...
		String sum = num.setScale(1, BigDecimal.ROUND_HALF_UP).toString();
	}
	public String testBack(){
		...
		dc.add(Restrictions.eq("id", "ff8080813c93cd71013c97f4cf5407d3"));
		try {
		...
		if(null != list && list.size()>0){
			peBzzOrderInfo = list.get(0);
		}
		peBzzOrderInfo.setAmount("1111");
		try {
