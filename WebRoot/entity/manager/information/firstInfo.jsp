...
document.getElementById("tishi2").style.visibility="hidden";
  ...
  String emailMessage = (String)request.getAttribute("emailMessage");
	...
	if("1".equals(emailMessage)){
		emailMessageNote = "<br/>&nbsp;&nbsp;&nbsp;&nbsp;您的邮箱信息存在重复，为避免您找回密码受到影响请在&ldquo;<a href=\"/entity/information/personalInfo_turnToEditInfo.action\" class=\"ts\" style=\"color: blue;\">个人信息</a>&rdquo;功能中修改您的邮箱地址。";
	}else if("2".equals(emailMessage)){
		emailMessageNote = "<br/>&nbsp;&nbsp;&nbsp;&nbsp;您的邮箱信息不完善，为方便您找回密码请在&ldquo;<a href=\"/entity/information/personalInfo_turnToEditInfo.action\" class=\"ts\" style=\"color: blue;\">个人信息</a>&rdquo;功能中完善您的邮箱地址。";
	}
	if(null != emailMessage && !"".equals(emailMessage) && !"null".equalsIgnoreCase(emailMessage)){
		out.println("&nbsp;");
	%>
	<div id="tishi" style="position: absolute;width: 450px; background-color:silver;left: 26%;top: 20%">
		<table width="100%">
		<tr >
    	...
    	<div style="text-justify: inter-ideograph; text-indent: 24pt; line-height: 150%"><span style="font-size: 12pt;  color: black; line-height: 150%; font-family: 宋体"><%= emailMessageNote %></span></div>
