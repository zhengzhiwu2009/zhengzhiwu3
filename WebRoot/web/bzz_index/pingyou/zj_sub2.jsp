...
<div class="wrap">
 ...
 <!--头部结束-->
 <div class="container">  
  <div class="contenttitle"><strong> 最佳管理员</strong><span class="font_s">（排名不分先后）</span></div>
  ...
  <% 
	...
	sql = " select distinct c.id as enterprise_id , c.name as enterprise_name from pe_bzz_goodmag a, pe_enterprise_manager b, pe_enterprise c "+
        	" where a.fk_managerid = b.id and b.fk_enterprise_id = c.id and b.is_goodmag = 'ccb2880a91dadc115011dadfcf26b0010' and "+
        	" a.submit_status = 'ccb2880a91dadc115011dadfcf26b0005' order by c.name  ";
	...
	String spagesize = (String) session.getValue("pagesize");
		...
		while(rs!=null&&rs.next()){
    		...
    		while(rs2!=null && rs2.next()){
    			...
    			mag_name = mag_name + "<a href='zj_sub3.jsp?goodMag_id="+goodMag_id+"'  >"+fixNull(rs2.getString("mag_name"))+"</a>&nbsp;&nbsp;";
    		}
    		work.close(rs2);	
    	%>
    		<div class="clist">
