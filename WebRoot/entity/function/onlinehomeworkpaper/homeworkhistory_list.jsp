...
try
{
	...
	if("teacher".equalsIgnoreCase(userType))
		totalItems = testManage.getHomeworkPaperHistorysNumNew(null,paperId,null,null,teachclass_id);
	else
		totalItems = testManage.getHomeworkPaperHistorysNumNew(user_id,paperId,null,null,teachclass_id);
	//----------分页开始---------------
	...
	if("teacher".equalsIgnoreCase(userType)){
		historyList = testManage.getHomeworkPaperHistorysNew(pageover,null,paperId,null,null,teachclass_id);
	}
	else{
		historyList = testManage.getHomeworkPaperHistorysNew(pageover,user_id,paperId,null,null,teachclass_id);
	}
%>
          ...
          <td valign="top" class="bg3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" background="../images/top_01.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="217" height="104" rowspan="2" valign="top"><img src="../images/ktlx.gif" width="217" height="86"></td>
                      <td height="46">&nbsp;</td>
                    </tr>
                    <tr> 
