...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="newsbg">
		  ...
		  <tr>
			...
			<table width="670" border="0" cellpadding="0" cellspacing="0" background="/web/news/images/1_12.jpg">
              <tr>
                ...
                <td width="96%" class="newsbtitle" align="left">报名信息查询与修改（功能列表）</td>
              </tr>
            </table></td>
		  </tr>
		  <tr>
			...
			<s:if test="loginErrMessage==null">
                    ...
                    <tr>
                      <td width="40%"  class="leftround"><img src="/web/images/round.jpg" width="5" height="5" /></td>
                      <td width="60%" class="fontl"><a href="/entity/first/firstStudentInfo_infoDetail.action" target="_blank"> 查看报名信息</a></td>
                      </tr>
                    <tr>
                      <td width="40%"  class="leftround"><img src="/web/images/round.jpg" width="5" height="5" /></td>
                      <td width="60%" class="fontl"><a href="/entity/first/firstStudentInfo_turnToEdit.action" target="_blank"> 修改报名信息</a></td>
                      </tr>     
  		
                    <tr>
                      <td width="40%"  class="leftround"><img src="/web/images/round.jpg" width="5" height="5" /></td>
                      <td width="60%" class="fontl"><a href="/entity/first/firstStudentInfo_print.action" target="_blank"> 打印准考证</a></td>
                      </tr>  
                    <tr>
                      <td width="40%"  class="leftround"><img src="/web/images/round.jpg" width="5" height="5" /></td>
                      <td width="60%" class="fontl"><a href="/entity/first/firstStudentInfo_recruitInfo.action" target="_blank"> 查看录取情况</a></td>
                      </tr>  		
                    <tr>
                      <td width="40%"  class="leftround"><img src="/web/images/round.jpg" width="5" height="5" /></td>
                      <td width="60%" class="fontl"><a href="/entity/first/firstStudentInfo_seeRegNo.action" target="_blank"> 查看学号</a></td>
                      </tr>                        			    						  			  
                  </table>
  ...
  <tr>
    <td width="703"  height="68" valign="top" style="background-image:url(/web/news/images/1_11.jpg); background-repeat:repeat-x;" align="center" class="banquan">版权所有：中国证劵业协会企业远程培训中心 京ICP备05046845号<br />
投诉：010-11110000 传真：010-11116666<br />
