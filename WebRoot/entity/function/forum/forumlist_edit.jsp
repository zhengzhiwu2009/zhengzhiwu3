...
ForumList forumList=interactionManage.getForumList(id);
%>
            ...
            <table width="750" border="1" cellspacing="0" cellpadding="0" bordercolordark="BDDFF8" bordercolorlight="#FFFFFF">
              <tr> 
                <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            ...
                            <td width="120" valign="top" class="text3" style="padding-top:25px;padding-left:15px">修改</td>
                    ...
                    <tr>
                   <form action="forumlist_editexe.jsp" method="POST" name="frmForum" onsubmit="return chkSubmit(this)">
                      <td align="center"><table width="80%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="10%" height="40" class="text6">版名：</td>
                            <td>
                            	<input name="name" type="text" size="61" value="<%=forumList.getName()%>" />
                            	<input name="id" type="hidden" value="<%=id%>">
                            </td>
                          </tr>
                          <tr> 
                            <td class="text6">内容：</td>
                            <td><textarea name="content" cols="60" rows="8"><%=forumList.getContent()%></textarea></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
