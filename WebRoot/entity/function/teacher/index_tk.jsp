            ...
            <td align="center" >
	            <table style="margin-top:15px; margin-left:2px" width="138" border="0" cellpadding="0" cellspacing="0" bgcolor="#e2eef3">
	              <tr>
	              	...
	              	<td width="138" height="45" align="center" valign="top" background="/entity/function/images/menu3_1bg.jpg" style="background-repeat:no-repeat; padding-top:13px; padding-left:15px; background-position:center"><a href="/entity/function/lore/lore_dir_list.jsp" target="mainer" class="menuzi">题库管理</a></td>
	              	
	              </tr>
	              <tr>
		              <td width="138" height="45" align="center" valign="top" background="/entity/function/images/menu6_1bg.jpg" style="background-repeat:no-repeat; padding-top:13px; padding-left:15px; background-position:center"><a href="/entity/function/testpaper/onlinetestcourse_list.jsp" target="mainer" class="menuzi">课后测验</a></td>	              </tr>
	              </tr>
	              <!--
