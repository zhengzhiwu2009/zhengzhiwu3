...
<form action="/entity/basic/teacherResource_editNote.action" method="POST" name="frmAnnounce" onsubmit="return chkSubmit()">
	                      				...
	                      				<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                          				<tr>
	                            				<td align="center" class="text1">
	                            					<img src="../images/xb3.gif" width="17" height="15"> 
	                              					<strong>教师简介</strong>
	                              				</td>
												<td width="300">&nbsp;</td>
	                          				</tr>
	                            						...
	                            						<tr>
	                          							...
	                          							<tr>
	                          								<td class="neirong" valign=top width=20%>
																<font size=2>讲师简介：</font>
															</td>
															<td class="neirong" valign=top>
																<textarea class="smallarea" cols="80" name="description" rows="12"><s:property value="teacherInfo.sg_tti_description"/></textarea>
