...
<html>
  <head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script type="text/javascript" src="/js/edit_check.js"></script> 
	<!--
   ...
   document.forms[0].submit();   
	...
	var type = document.getElementById("date").value;
	document.getElementById("birthday").value =type;
...
//生成学习中心下拉列表
		...
		if(<s:property value='canEdit'/> == 1){
			majorCombo.hide();
				...
				birthdayDate.setValue('<s:date name="student.birthday" format="yyyy-MM-dd" />');
				birthdayDate.setRawValue('<s:date name="student.birthday" format="yyyy-MM-dd" />');
			},birthdayDate);    
  ...
  <tr>
	...
	<table width="980" border="0" cellspacing="0" cellpadding="0" style="margin:10px 0px 3px 0px;">
      ...
      <tr>
          ...
          <tr>
			...
			<table id="baseInfor1" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px solid #E1E1E1; margin-bottom:5px;">
              ...
              <tr>
                  ...
                  <tr>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      <tr>
                        ...
                        <td width="43%" align="left"><input name="student.name" id="name" type="text" class="textreg" onFocus="foName()" onBlur="blName()" value="<s:property value="student.getName()"/>"/></td>
                ...
                <OPTION value = "<s:property value="student.getFolk()"/>"><s:property value="student.getFolk()"/></OPTION>
                ...
                <OPTION VALUE="外国血统">外国血统</OPTION>                        
                      ...
                      <tr>
                        ...
                        <td width="43%" align="left"><select name="student.province"  id="province"  onFocus="foProvince()" onBlur="blProvince()">
             <OPTION  value = "<s:property value="student.province"/>"><s:property value="student.province"/></OPTION>
		...
		<input type="text" name="student.city" size="5"  value="<s:property value="student.city"/>"  onFocus="foProvince()" onBlur="blProvince()"/> <span class="grayfont1">市</span></td>
                 ...
                 <OPTION value = "<s:property value="student.zzmm"/>"><s:property value="student.zzmm"/></OPTION>
...
onFocus="foCardType()" onBlur="blCardType()">
                <OPTION value = "<s:property value="student.cardType"/>"><s:property value="student.cardType"/></OPTION>
                ...
                <OPTION VALUE="港、澳、台居民证件">港、澳、台居民证件</OPTION>                            
					  ...
					  <tr>
                        <td width="23%" class="grayfont" height="24"><font class="sign">*</font> 身份证号：</td>
                        <td width="43%" align="left"><input name="student.cardNo" id="cardno" value="<s:property value="student.cardNo"/>" type="text" class="textreg" onFocus="foCardNo()" onBlur="blCardNo()" />  	  	<input type="hidden" name="stuCardId" id="stuCardId" value="<s:property value="student.cardNo"/>"/> </td>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      <tr>
                        ...
                        <s:select list="#{'男':'男','女':'女'}" value="%{student.gender}" theme="simple" name="student.gender"  ></s:select>
                        </td>
                        <td width="34%"  id="genderInfor">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="23%" class="grayfont" height="24"><font class="sign">*</font> 户口：</td>
                        <td width="43%" align="left"><input name="student.register" type="text"  value="<s:property value="student.register"/>" class="textreg" id="register" onFocus="foRegister()" onBlur="blRegister()"  /></td>
                ...
                <OPTION value = "<s:property value="student.xueli"/>"><s:property value="student.xueli"/></OPTION>
                ...
                <OPTION VALUE="博士">博士</OPTION>
                      ...
                      <tr>
                        ...
                        <td width="43%" align="left">
                        <s:select list="#{'未婚':'未婚','已婚':'已婚'}" value="%{student.marriage}" theme="simple" name="student.marriage"></s:select>
						</td>
  ...
  <tr>
                  ...
                  <tr>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      <tr>
                        ...
                        <td width="43%" align="left"><input name="student.graduateSchool" value="<s:property value="student.graduateSchool"/>" type="text" class="textreg" id="xueliSch"  onFocus="foGraduateSchool()" onBlur="blGraduateSchool()"/></td>
                        <td width="34%" id="graduateSchoolInfor" >&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="23%" class="grayfont" height="24"><font class="sign">*</font> 就读专业：</td>
                        <td width="43%" align="left"><input name="student.graduateMajor" value="<s:property value="student.graduateMajor"/>" type="text" class="textreg" id="graduateMajor" onFocus="foGraduateMajor()" onBlur="blGraduateMajor()" /></td>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      <tr>
                        ...
                        <td width="43%" align="left"><select name="graduateYear" class="textshort" id="graduateYear" onFocus="foGraduateDate()" onBlur="blGraduateDate()" >
						 ...
						 <OPTION value = "<s:property value="graduateYear"/>"><s:property value="graduateYear"/></OPTION>
    ...
    <option VALUE="2000">2000</option>
		    ...
		    <OPTION value = "<s:property value="graduateMonth"/>"><s:property value="graduateMonth"/></OPTION>
    ...
    <option VALUE="12">12</option>
                      ...
                      <tr>
                        ...
                        <td width="43%" align="left"><input name="student.graduateCode" value="<s:property value="student.graduateCode"/>" type="text" class="textreg" id="xueliNo" onFocus="foGraduateCode()" onBlur="blGraduateCode()" /> </td>
...
<table width="100%" border="0" id="workInfor" cellspacing="0" cellpadding="0" style="border-bottom:1px solid #E1E1E1; margin-bottom:5px;">
  ...
  <tr>
	...
	<table width="96%" border="0" cellspacing="0" cellpadding="0">
                ...
                <OPTION value = "<s:property value="student.occupation"/>"><s:property value="student.occupation"/></OPTION>
                ...
                <OPTION VALUE="其他人员">其他人员</OPTION> 
                      ...
                      <tr>
                        ...
                        <td width="43%" align="left"><input name="student.workplace" value="<s:property value="student.workplace"/>" type="text" class="textreg" onFocus="foWorkspace()" onBlur="blWorkspace()"/></td>
                        <td width="34%" id="workspaceInfor" >&nbsp;</td>
                      </tr>
                     <tr>
                        <td width="23%" class="grayfont" height="24">单位电话：</td>
                        <td width="43%" align="left"><input name="student.workplacePhone" value="<s:property value="student.workplacePhone"/>"  type="text" class="textreg" id="workspacePhone" onFocus="foWorkspacePhone()" onBlur="blWorkspacePhone()"/></td>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      ...
                      <tr>
						...
						<select name="workYear" class="textshort" id="workYear" onFocus="foWorkDate()" onBlur="blWorkDate()" >
						 	<option value = "<s:property value="workYear"/>"><s:property value="workYear"/></option>
    ...
    <option VALUE="2000">2000</option>
		 ...
		 <option value = "<s:property value="workMonth"/>" ><s:property value="workMonth"/></option>
		    <OPTION value = "">请选择.</OPTION>
    ...
    <option VALUE="12">12</option>					
					  ...
					  <tr>
                        ...
                        <td width="43%" align="left"><input name="student.workplaceZip" type="text"  value="<s:property value="student.workplaceZip"/>"  class="textreg" maxlength="6" id="workspaceZip" onFocus="foWorkspaceZip()" onBlur="blWorkspaceZip()" /></td>
                  ...
                  <tr>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      <tr>
                        ...
                        <td width="43%" align="left"><input name="student.address" type="text" id="address" value="<s:property value="student.address"/>"  class="textreg"  onFocus="foAddress()" onBlur="blAddress()"  /></td>
                        <td width="34%" id="addressInfor" >&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="23%" class="grayfont" height="24"><font class="sign">*</font> 手机：</td>
                        <td width="43%" align="left"><input name="student.mobilephone" type="text" value="<s:property value="student.mobilephone"/>" class="textreg" id="mobilephone" onFocus="foMobilephone()" onBlur="blMobilephone()" /></td>
                        <td width="34%" id="mobilephoneInfor" >&nbsp;</td>
                      </tr>
                     <tr>
                        <td width="23%" class="grayfont" height="24"><font class="sign">*</font> Email：</td>
                        <td width="42%" align="left"><input name="student.email" type="text" value="<s:property value="student.email"/>" id="email" class="textreg"  onFocus="foEmail()" onBlur="blEmail()" /></td>
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                       <tr>
                        ...
                        <td width="42%" align="left"><input name="student.zip" id="zip" value="<s:property value="student.zip"/>" type="text" class="textreg" maxlength="6" onFocus="fozip()" onBlur="blzip()" /></td>
                      ...
                      <tr>
						...
						<input name="student.phone" type="text" class="textreg" id="phone" value="<s:property value="student.phone"/>" onFocus="foPhone()" onBlur="blPhone()"  /></td>
...
<table width="100%" id="applyInfor" border="0" cellspacing="0" cellpadding="0" style=" margin-bottom:5px;">
  ...
  <tr>
	...
	<table width="96%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                      <tr>
                        ...
                        <td width="70%" align="left">
                          <s:if test="canEdit ==1">
                        <input type="text"   name="site" size="45" value="<s:property value="student.getPrRecPlanMajorSite().getPeSite().getName()"/>"  readonly="readonly"  onFocus="foSite()" onBlur="blSite()"/>                     
                        </s:if>
                        <input type="text"  <s:if test="canEdit ==1">name="site1"</s:if> <s:else>name="site"</s:else> size="52" value="<s:property value="student.getPrRecPlanMajorSite().getPeSite().getName()"/>"  id="combo-box-sites" onFocus="foSite()" onBlur="blSite()"/>                        </td>
                        <td width="7%"  >&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td width="70%" align="left">
                          <s:if test="canEdit ==1">
                        <input type="text"   name="edutype" size="45" value="<s:property value="student.getPrRecPlanMajorSite().getPrRecPlanMajorEdutype().getPeEdutype().getName()"/>"  readonly="readonly"  onFocus="foEdutype()" onBlur="blEdutype()"/>                     
                        </s:if>                        
                         <input type="text" id="combo-box-edutypes"<s:if test="canEdit ==1">name="edutype1"</s:if><s:else>name="edutype"</s:else>  size="52" value="<s:property value="student.getPrRecPlanMajorSite().getPrRecPlanMajorEdutype().getPeEdutype().getName()"/>"   onFocus="foEdutype()" onBlur="blEdutype()"/></td>
                       <td width="7%"  >&nbsp;</td>
                      </tr>
                     <tr>
                        ...
                        <td width="70%" align="left">
                          <s:if test="canEdit ==1">
                        <input type="text"   name="major" size="45" value="<s:property value="student.getPrRecPlanMajorSite().getPrRecPlanMajorEdutype().getPeMajor().getName()"/>"  readonly="readonly"   onFocus="foMajor()" onBlur="blMajor()"/>                     
                        </s:if>                          
                        <input type="text"  <s:if test="canEdit ==1">name="major1"</s:if><s:else>name="major"</s:else> size="52" value="<s:property value="student.getPrRecPlanMajorSite().getPrRecPlanMajorEdutype().getPeMajor().getName()"/>" id="combo-box-majors"   onFocus="foMajor()" onBlur="blMajor()"/></td>
                        <td width="7%"  >&nbsp;</td>
                      </tr>
				<!-- 	  <tr>
             ...
             <OPTION value = "<s:property value="student.recProvince" />"><s:property value="student.recProvince" /></OPTION>
