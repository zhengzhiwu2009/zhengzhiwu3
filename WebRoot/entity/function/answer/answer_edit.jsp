...
<body leftmargin="0" topmargin="0"  background="../images/bg2.gif">
		<form
			action="answer_editexe.jsp?answer_id=<%=answer.getId()%>&question_id=<%=question.getId()%>&pageInt=<%=pageInt%>&title=<%=title%>&name=<%=name%>"
									...
									<table width="608" border="1" cellspacing="0" cellpadding="0"
										...
										<input type = "hidden" name="pageInt" value="<%=pageInt%>" -->
																<tr>
																	...
																	<td class="text3">
																		<img src="../images/ct_03.gif" width="25" height="25">
																		&nbsp;问题：<%=question.getTitle()%></td>
																</tr>
																<tr>
																	<td width="800" class="text3">
																		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;内容：
																		<div
																			style="word-wrap: break-word; word-break: normal; z-index: 30; background: #FFFFFF;"><%=question.getBody()%></div>
																	</td>
													...
													<tr>
														<td colspan=2 class="neirong" valign=top>
															<textarea class="smallarea" cols="80" name="body"
																rows="12"><%=answer.getBody()%></textarea>
														</td>
													</tr>
												</table>
											</td>
