...
function DetailInfo(paperId)
{
	...
	<%
		...
		try {
			...
			int totalItems = 0;
			totalItems = interactionManage.getTeachClassListNum(courseId, type, title_1);
			//----------分页开始---------------
			...
			testPaperList = interactionManage.getTeachClassList(pageover, courseId, type, title_1);
	%>
