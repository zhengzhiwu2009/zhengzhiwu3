...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1009 style='border-collapse:
 ...
 <tr height=36 style='mso-height-source:userset;height:27.0pt'>
  ...
  width:758pt'>《<%=batch_name%>》<font class="font7"><%=enterprise%>优秀管理员列表</font></td>
 </tr>
 ...
 <%
	...
	sql_t=
		...
		"       enum_const                    ec,\n" + 
		"       pe_bzz_goodmag                k1 \n"+
		" where pem.is_goodmag = 'ccb2880a91dadc115011dadfcf26b0011' \n"+
		"   and pem.id = k1.fk_managerid(+) \n"+
		"   and k1.submit_status = 'ccb2880a91dadc115011dadfcf26b0005' \n" + sql_conn+
