...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function checkFeeBalance(){
			<s:if test="bean.peStudent.feeBalance<0">
				if(window.confirm("学生<s:property value='bean.peStudent.trueName'/>欠费，是否继续对其开除学籍？"))
					return true;
				else
					return false;
			</s:if>			
	...
	<body>
		<form name="quitSchool" method="post" >
			<div id="main_content">
			   <div class="content_title">开除学生设置</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			   <table width="80%">
			   		<tr>
			   			<td colspan="8">
			   				<div align="center" class="postFormBox">学员信息
			   		...
			   		<tr>
			   			...
			   			<td width="20%">
			   				<div align="center" class="form_table" >账户余额</div>
			   			</td>
			   		</tr>
			   		<tr>
			   			<td>
		              ...
		              <td valign="middle" align="right"  colspan="3" ><span class="name"><label>开除日期*</label></span></td>
		              <td valign="middle" colspan="4"><div align="left" class="postFormBox" id = "showinputDate"></div></td>
		            </tr>
			   		<tr class="postFormBox">
			   			<td colspan="3">
			   				<div align="right" ><span class="name"><label>开除的原因</label></span></div>
			   			</td>
			   			<td colspan="4">
			   		...
			   		<tr>
			   			<td colspan="7">
			   				<div align="center" class="postFormBox">
			   					<s:if test='msg.indexOf("成功")>=0&&msg.indexOf("取消")<0'><input type="submit" onclick="javascript:document.quitSchool.action='/entity/studentStatus/peStudentStatus_executeCancel.action';" name="Submit" value="取消开除"/>
			   					<input type="button" onclick="window.navigate('/entity/studentStatus/peStudentStatus_turntoExpelSearch.action')" value="返回"/>
			   					</s:if>
			   					<s:else><input type="submit" onclick="javascript:document.quitSchool.action='/entity/studentStatus/peStudentStatus_executeExpelChange.action';return checkFeeBalance();" name="Submit" value="提交"/></s:else>
			   				</div>
			   			</td>
			   		</tr>
			   </table>
