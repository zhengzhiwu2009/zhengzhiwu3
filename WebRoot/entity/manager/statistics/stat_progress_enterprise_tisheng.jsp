...
<html>
   <head>
      <title>提升课程学习进度统计</title>
   </head>
   <br/> <br/> <br/> 
<body>
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
<tr>
    <td valign="top" class="text" align="center"><strong><%=batch_name %>批次&nbsp;&nbsp;&nbsp;<%=enterprise_name %>提升课程学习进度统计情况</strong></td>
  </tr>
  ...
  <tr> 
    <td valign="top" class="text" align="center"> <div id="chartdiv" align="center"> 
      ...
      <script type="text/javascript">
		   var chart = new FusionCharts("<%=request.getContextPath() %>/entity/manager/statistics/fusioncharts/Column3D.swf",  "ChartId", "700", "350", "0", "0");
		   var d = "<%=enterprise_id%>|<%=batch_id%>|"+Math.random();
		   chart.setDataURL("<%=request.getContextPath() %>/entity/manager/statistics/chart/chart_progress_enterprise_tisheng.jsp?d="+d); 		   
  ...
  <tr>
    <td class="text" align="center"><a href="/entity/manager/statistics/stat_progress_enterprise.jsp?pageInt1=<%=pageInt1%>&search1=<%=java.net.URLEncoder.encode(search1,"UTF-8") %>&pageInt=<%=pageInt2%>&id=<%=batch_id%>&search=<%=java.net.URLEncoder.encode(search2,"UTF-8") %>&name=<%=java.net.URLEncoder.encode(batch_name,"UTF-8") %>">返回</a>
    <a href="/entity/manager/statistics/stat_progress_enterprise_tisheng_excel.jsp?d=<%=enterprise_id%>|<%=batch_id%>|<%=new Date().getTime()%>">导出</a></td>
  </tr>
</table>
</body>
</html>