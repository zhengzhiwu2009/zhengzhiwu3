...
//								message +="保存学员信息："+prExamBooking.getPrTchStuElective().getPeStudent().getTrueName()+" 座位号"+seat+""+ "考场"+this.toThree(room)+" </br> ";
							...
							seat++;
//							message +="保存学员信息："+prExamBooking.getPrTchStuElective().getPeStudent().getTrueName()+" 座位号"+this.toTwo(seat)+ "考场"+this.toThree(room)+" </br> ";
							prExamBooking.setPeExamNo(peExamNo);
							prExamBooking.setPeExamRoom(peExamRoom);
							prExamBooking.setSeatNo(this.toTwo(seat));
							this.getGeneralDao().save(prExamBooking);
