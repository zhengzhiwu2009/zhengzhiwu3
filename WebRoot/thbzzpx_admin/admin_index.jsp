    ...
    <td height="113"><table width="100%" height="113" border="0" cellpadding="0" cellspacing="0" bgcolor="#E6EEF2">
      ...
      <tr >
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0"  >
          <tr>
          <td align="center">
            <span class="text4 STYLE4"><font >中国证劵业协会培训平台</font></span>          </td>
                ...
                <td valign="top" background="images/leftline.gif"><div align="center">
                  <table width="126" border="0" align="center" cellpadding="0" cellspacing="0">
                   ...
                   <%-- <tr>
                    ...
                    <tr>
                      <td height="15" background="images/1.JPG"></td>
                      <td height="15" background="images/2.JPG"><div align="center" class="title"><a href="/sso/admin/pePriRole.action" class="STYLE1" target="main">权限组管理</a></div></td>
                    </tr>
                    <tr>
                      <td height="15" colspan="2" background="images/3.gif"></td>
                    </tr>
                    <tr>
                      <td height="15" background="images/1.JPG"></td>
                      <td height="15" background="images/2.JPG"><div align="center" class="title"><a href="/sso/admin/priority.action" class="STYLE1" target="main">权限管理</a></div></td>
                    </tr>
                    <tr>
                      <td height="15" colspan="2" background="images/3.gif"></td>
                    </tr>
                    <tr>
                      <td height="15" background="images/1.JPG"></td>
                      <td height="15" background="images/2.JPG"><div align="center" class="title"><a href="/sso/admin/pricatetory.action" class="STYLE1" target="main">权限类别管理</a></div></td>
                    </tr>
                    <tr>
                      <td height="15" colspan="2" background="images/3.gif"></td>
                    </tr>
        ...
        <td align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top">
                  <td height="100%"><iframe name="main" width="100%" height="100%" scrolling="auto" frameborder="0" src="manager_manage.jsp" allowtransparency="true"></iframe></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                </tr>
  ...
  <tr>
    <td height="62"><table width="100%" height="62" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/bot2.gif"><div align="center" class="title">中国证券业协会版权所有</div></td>
