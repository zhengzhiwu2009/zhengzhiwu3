...
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
 ...
 <td  class="text" align="center"><strong>每天最大在线人数统计</strong> &nbsp;  &nbsp; </td>
  </tr>
   </table>
   <br/>
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr> 
    <td  class="text" align="center"> <div id="chartdiv" align="center"> 
     ...
     <script type="text/javascript">
		   ...
		   var d = Math.random();
		   chart.setDataURL("<%=request.getContextPath() %>/entity/manager/statistics/chart/chart_online_one.jsp?d="+d);		   
  ...
  <tr>
    ...
    <a href="/entity/manager/statistics/stat_onlineone_excel.jsp?d=<%=new Date().getTime()%>">导出</a></td></td>
  </tr>
</table>
