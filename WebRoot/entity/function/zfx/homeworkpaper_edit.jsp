...
<html>
<head>
<meta http-equiv="Content-Type" content="text/h清华大学继续教育学院 charset=utf-8">
...
<input type=hidden name=pageInt value=<%=pageInt %>>
                    ...
                    <tr>
                      <td background="../images/table_02.gif" ><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="bg4">
                          <tr>
							...
							<input type=text name=title class=input1 size=60 value="<%=teachclass.getTitle() %>">
							</td>
						  </tr>
                          		<tr>
		...
		<tr>
			<td align=center><input type=submit value="提交" id="sub">&nbsp;&nbsp;<input type=button value="返回" onclick="window.location='homeworkpaper_list.jsp?pageInt=<%=pageInt %>&title=<%=title1 %>'"></td>
		</tr>
                  </table> </td>
              </tr>
            </table></td>
