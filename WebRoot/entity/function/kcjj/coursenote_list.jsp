													...
													<td class="text2">
														<table border="0" align="center" cellpadding="0"
															...
															<tr>
																...
																<td>
																	<p align="center">
																		<font size=5><strong><%=title%></strong> </font>
																	</p>
																</td>
															</tr>
										...
										<td align=center>
											<%
												if (us.getRoleId().equals("3") || us.getRoleId().equals("R004")) {
													if (count == 0) {
											%>
											<a href="course_note_add.jsp?type=KCJJ" class="tj">[添加课程简介]</a>&nbsp;
										</td>
										<%
											} else {
										%>
										<a
											href="course_note_edit.jsp?type=KCJJ&title=<%=java.net.URLEncoder.encode(title, "UTF-8")%>&id=<%=id%>"
											class="tj">[编辑课程简介]</a>&nbsp;
										<a
											href="course_note_delete.jsp?type=KCJJ&title=<%=java.net.URLEncoder.encode(title, "UTF-8")%>&id=<%=id%>"
											class="tj">[删除课程简介]</a>&nbsp;
										<td>
											<br/>
										</td>
