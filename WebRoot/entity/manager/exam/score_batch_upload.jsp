 ...
 /* var score_type = document.getElementById("score_type").value;
  ...
  if(bathid==0){
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<s:form name="batch"
			action="/entity/exam/peBzzExamScore_uploadExcel.action" method="POST"
					...
					<td valign="top" class="pageBodyBorder_zlb" align="center">
						<div class="cntent_k" id="zlb_content_start">
							...
							<table width="68%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr valign="bottom" class="postFormBox">
									...
									<td width="77%">
										<span class="link" help="下载Excel格式的模版表格"><img
											...
											href='/entity/manager/exam/scoreBatchUpload.xls'
								...
								<!-- <tr valign="bottom" class="postFormBox">
									<td valign="bottom">
										<span class="name">成绩类型:</span>
									</td>
									<td valign="bottom">
										<select name="score_type" id="score_type">
										     <option value="" >请选择上传成绩类型</option> 
										 	 <option value="obj_score" >客观题成绩</option> 
										 	 <option value="sub_score" >主观题成绩</option>
				        			</select>
									</td>
								</tr> -->
								<tr valign="bottom" class="postFormBox">
								...
								<tr class="postFormBox">
									<td></td>
									 <td align=left><input type=submit value = "上传" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
								</tr>
							</table>
						</div>
