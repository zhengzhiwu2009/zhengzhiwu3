...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript">
			function checknull(){
				if(document.getElementById("pename").value=="" && document.getElementById("cardno").value==""){
					alert('请输入至少一个查询条件!');
...
<!----NAV---->	
    ...
    <div class="w2">
	   ...
	   <section class="b4 Identify">
	       <form action="/sso/regist_findBackGroupUserAccount.action"
	       		method="post" name="infoform" enctype="multipart/form-data"
	       		onsubmit="return checknull();">
		       	<h1>
				  	<label class="f3">集体管理员姓名：</label>
				  	<input type="text" name="pename" id="pename" value="<s:property value="pename"/>" />
			   	</h1>
			   	<h1>
			      
				  	<label class="f3">电&nbsp;&nbsp;&nbsp;子&nbsp;&nbsp;&nbsp;&nbsp;邮&nbsp;&nbsp;&nbsp;件&nbsp;：</label>
				  	<input type="text" name="cardno" id="cardno" value="<s:property value="cardno"/>" />
			   	</h1>
		       	<h2 >
			      	<input type="submit" value="提交" name="button" class="f3"/>
			      	<input type="button" value="清空" name="button" class="f3" onclick="window.location.href='/sso/regist_findGroupUserAccount.action'; "/>
			   	</h2>
			   	<s:if test="operateresult.equals(\"1\")||operateresult.equals(\"2\")">
					<font color="red" size="3">*</font>
					<strong>查询结果：</strong>
					<span><s:property value="resultMessage"/></span>
				</s:if>
		   </form>    
	   </section>
	</div>
