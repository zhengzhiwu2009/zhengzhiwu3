...
public class PeBzzExamAgain  extends AbstractBean implements java.io.Serializable{
	private String id;
	private Date applyDate;				//补考申请时间
	private Date firstDate;				//不用了初审时间
	private	Date finalDate;				//补考终审时间
	private String note;				//备注
	private PeBzzStudent	peBzzStudent;   //学生
	private PeBzzExamBatch	peBzzExamBatch;	//考试批次
	private EnumConst	enumConstByFlagExamAgainStatus; //状态常量
	...
	public EnumConst getEnumConstByFlagExamAgainStatus() {
		return enumConstByFlagExamAgainStatus;
	}
	public void setEnumConstByFlagExamAgainStatus(
			EnumConst enumConstByFlagExamAgainStatus) {
		this.enumConstByFlagExamAgainStatus = enumConstByFlagExamAgainStatus;
	}
