...
<%@ taglib prefix="s" uri="/WEB-INF/struts-tags.tld" %>
      ...
      <s:if test="enumConstByFlagQuestionType.code!=3 && enumConstByFlagQuestionType.code!=4 && enumConstByFlagQuestionType.code !=5">  	       
          <tr>
          <td class="14title">● &nbsp;<s:property value="#class.getQuestionNote()" escape="false"/></td>
          </tr>
          <tr>
          <td style="padding-left:40px"><table width="95%" border="0" cellspacing="0" cellpadding="0" class="12content" style="font-size:12px; line-height:24px;" >
             ...
             <s:if test="#class.getItem1()!=null">
              <tr> 
                <td width="40%" style="padding-right:20px">（1）<s:property value="#class.getItem1()" /></td>
                <td width="20%">    
             ...
             <s:if test="#class.getItem2()!=null">
              <tr> 
                <td >（2）<s:property value="#class.getItem2()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
             ...
             <s:if test="#class.getItem3()!=null">
              <tr> 
                <td >（3）<s:property value="#class.getItem3()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0" >
                    <tr> 
             ...
             <s:if test="#class.getItem4()!=null">
              <tr> 
                <td >（4）<s:property value="#class.getItem4()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
             ...
             <s:if test="#class.getItem5()!=null">
              <tr> 
                <td >（5）<s:property value="#class.getItem5()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0" >
                    <tr> 
             ...
             <s:if test="#class.getItem6()!=null">
              <tr> 
                <td >（6）<s:property value="#class.getItem6()" /></td>
                <td>    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
             ...
             <s:if test="#class.getItem7()!=null">
              <tr> 
                <td >（7）<s:property value="#class.getItem7()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
             ...
             <s:if test="#class.getItem8()!=null">
              <tr> 
                <td >（8）<s:property value="#class.getItem8()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0" >
                    <tr> 
             ...
             <s:if test="#class.getItem9()!=null">
              <tr> 
                <td >（9）<s:property value="#class.getItem9()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
            ...
            <s:if test="#class.getItem10()!=null">
              <tr> 
                <td >（10）<s:property value="#class.getItem10()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
            ...
            <s:if test="#class.getItem11()!=null">
              <tr> 
                <td>（11）<s:property value="#class.getItem11()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
             ...
             <s:if test="#class.getItem12()!=null">
              <tr> 
                <td >（12）<s:property value="#class.getItem12()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
             ...
             <s:if test="#class.getItem13()!=null">
              <tr> 
                <td >（13）<s:property value="#class.getItem13()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0" >
                    <tr> 
             ...
             <s:if test="#class.getItem14()!=null">
              <tr> 
                <td >（14）<s:property value="#class.getItem14()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0"  >
                    <tr> 
             ...
             <s:if test="#class.getItem15()!=null">
              <tr> 
                <td >（15）<s:property value="#class.getItem15()" /></td>
                <td >    
                <table  height="12" border="0" cellpadding="0" cellspacing="0" >
                    <tr> 
                ...
                (<s:property value="votePercent(#class.getItemResult15(), #class.totalItemResult)" default="0"/>%)</td>
                 ...
                 <s:elseif test="enumConstByFlagQuestionType.code==3"> 
                  ...
                  <tr>
                    <td class="14title">问题<s:property value="subNum.index++" />：<s:property value="#class.getQuestionNote()" escape="false"/></td>
                   </tr>
                   <tr>
                      <td><textarea  cols="70" rows="12"><s:property value="#subClass.getItemContent()"/></textarea></td>
                  </tr>
                  </s:if>
                  </s:iterator>
                  </s:elseif>    
                  ...
                  <tr>
                   ...
                   <tr>
                      <td><input type ="text" value="<s:property value="#subClass.getItemContent()"/>"> 分</td>
                  </tr>
                  </s:if>
                  </s:iterator>
                  </s:elseif>    
