...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_progress_enterprise_tisheng.xls"); %>
...
<%
	...
	sql= " select ps.id, sum(ce.time*(ts.percent/100)) as stime  from sso_user su , "+sql_training +
		...
		+sql_bath+"  "+sql_con+"  "+sql_con1+"  "+sql_emp+" and co.flag_course_type='402880f32200c249012200c7f8b30002'  group by ps.id ";
