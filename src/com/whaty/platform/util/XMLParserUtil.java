...
public class XMLParserUtil {
	 ...
	 * @return
	 */
	public static String getSingleMultiContent(String xmlCore,boolean flag) {
		String HTML = "";
		try {
	...
	public static String getSingleMultiContentNoAn(String xmlCore,boolean flag) {
		String HTML = "";
		try {
			Document doc = DocumentHelper.parseText(xmlCore);
			String body = ((Element) (doc.selectNodes("/question/body")
	...
	public static List parserSingleMultiNoAn(String xmlCore) {
		List list = new ArrayList();
		try {
			Document doc = DocumentHelper.parseText(xmlCore);
			String body = ((Element) (doc.selectNodes("/question/body")
	...
	public static String getJudgContent(String xmlCore,boolean flag) {
		String HTML = "";
		try {
			Document doc = DocumentHelper.parseText(xmlCore);
			String body = ((Element) (doc.selectNodes("/question/body")
	...
	public static String getJudgContentNoAn(String xmlCore,boolean flag) {
		String HTML = "";
		try {
			Document doc = DocumentHelper.parseText(xmlCore);
			String body = ((Element) (doc.selectNodes("/question/body")
	...
	public static List parserFaqDetail(String xmlCore) {
		...
		try {
			Document doc = DocumentHelper.parseText(xmlCore);
			String author = ((Element) (doc.selectNodes("/faq/author").iterator().next())).getText();
			String time = ((Element) (doc.selectNodes("/faq/time").iterator().next())).getText();
			String body = ((Element) (doc.selectNodes("/faq/body").iterator().next())).getText();
			list.add(author);
			list.add(time);
			list.add(body);
			...
			//System.out.println("DocumentException="+de.toString());
		}
		return list;
	}
