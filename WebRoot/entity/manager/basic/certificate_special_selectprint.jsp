		...
		try {
			...
			for (int item = 0; item < peBzzCertificates.size(); item++) {
				...
				if("2009秋季".equals(peBzzBatch.getName())){	//学员所在批次为09秋
					TemplatePDF = "/www/htdocs/webapps/scetraining/pdfmodel/certificate_new2009.pdf";
				}else if("2010春季".equals(peBzzBatch.getName())){	//学员所在批次为10春
					TemplatePDF = "/www/htdocs/webapps/scetraining/pdfmodel/certificate_new2010.pdf";
				}
