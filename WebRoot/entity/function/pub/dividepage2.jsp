  ...
  <tr> 
    ...
    <td width='46%' style='white-space: nowrap;'> 
    	<table width="70%" height="22" border="0" cellpadding="0" cellspacing="0" class="zi_1">
			...
			%>
				<td><a href="<%=servletPath%>?pageInt=<%=pageNext+link%>" title="下一页" class="button"><span unselectable="on">下一页</span></a></td>
  				<td><a href="<%=servletPath%>?pageInt=<%=maxPage+link%>" title="末页" class="button"><span unselectable="on">末页</span></a></td>
  			<%
  				} else if(pageInt>1 && pageInt<maxPage) {
  			%>
            	<td><a href="<%=servletPath%>?pageInt=<%=1+link%>" title="首页" class="button"><span unselectable="on">首页</span></a></td>
  				<td><a href="<%=servletPath%>?pageInt=<%=pageLast+link%>" title="上一页" class="button"><span unselectable="on">上一页</span></a></td>
  				<td><a href="<%=servletPath%>?pageInt=<%=pageNext+link%>" title="下一页" class="button"><span unselectable="on">下一页</span></a></td>
  				<td><a href="<%=servletPath%>?pageInt=<%=maxPage+link%>" title="末页" class="button"><span unselectable="on">末页</span></a></td>
  			<%
		...
		<th width='24%' style='color:#666666;white-space: nowrap;' class="mc1">
			跳转到第<input name="pageInt" style="height: 20px; width:45px" valign="middle" type="text" size="4" style="height:16px">页
