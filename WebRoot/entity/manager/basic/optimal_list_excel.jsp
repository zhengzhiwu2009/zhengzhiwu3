...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1009 style='border-collapse:
 ...
 <tr height=36 style='mso-height-source:userset;height:27.0pt'>
  <td colspan=10 height=36 class=xl24 width=1009 style='height:27.0pt;
  width:758pt'>《<%=batch_name%>》<font class="font7"><%=enterprise%>最佳管理员列表</font></td>
 </tr>
 ...
 <%
	...
	sql_t=
		...
		"   and pem.is_goodmag = 'ccb2880a91dadc115011dadfcf26b0010' \n"+
		"   and pem.id = k1.fk_managerid(+) and k1.submit_status = 'ccb2880a91dadc115011dadfcf26b0005' \n"+
