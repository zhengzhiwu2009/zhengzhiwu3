          ...
          <td valign="top" class="bg3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" background="../images/top_01.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					%>	
                          	<td  class="mc1">
							系统编号：<input type='text' name='userid' value='<%=userid %>' size='10' maxlength='245' style='vertical-align: bottom;'>
							&nbsp;&nbsp;&nbsp;
							姓名：<input type='text' name='userName' value='<%=userName %>' size='20' maxlength='245' style='vertical-align: bottom;'>
          					<a href='javascript:document.searchForm.submit()'>查找</a>
          					</td>
          			<%
                   	}
                    %>
