...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_enterprise_completed_excel.xls"); %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1048 style='border-collapse:
 ...
 %>
  ...
  width:787pt'><%=enterprise_name%>完成基础课学时学员列表</td>
 </tr>
 <%
 	}
 	db.close(rs);
