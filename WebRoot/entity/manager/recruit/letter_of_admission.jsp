...
<script>
	...
	<body>
			<div id="main_content">
			   <div class="content_title">打印录取通知书</div>
			   <div class="cntent_k" align="center">
			   <div class="k_cc">
			      	  <form action="/entity/recruit/recruitManage_printExe.action" onsubmit="return check();" target="_blank" >
			<table width="554" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td height="8"> </td>
						        ...
						        <tr valign="middle"> 
                                  <td width="200" height="90" align="left" class="postFormBox"><span class="name">&nbsp;&nbsp;身份证号：&nbsp;&nbsp;</span></td>
                                  <td class="postFormBox" style="padding-left:18px">
                                  
                                  <div align="left"  class="postFormBox" ><input type="text" name="cardId" /> </div>
                                  </td>
                          	    </tr>   
						        <tr valign="middle"> 
                                  <td width="200" height="90" align="left" class="postFormBox"><span class="name">&nbsp;&nbsp;发放日期：<font color="red">*</font></span></td>
                                  <td class="postFormBox" style="padding-left:18px">
