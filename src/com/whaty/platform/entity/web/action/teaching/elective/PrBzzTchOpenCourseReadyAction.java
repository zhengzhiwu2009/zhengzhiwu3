	...
	public void initGrid() {
		...
		this
				...
				.addMenuScript(this.getText("返回"),
						"{window.location='/entity/teaching/prBzzTchOpenCourse.action?backParam=true'}");
			...
			try {
				...
				if (plist.size() > 0) {
					...
					for (int n = 0; n < list.size(); n++) {
						...
						//开课表中新添加一个是否有效字段，开课时，默认设为有效  20120405gaoyuan
						EnumConst constFlagIsvalid=new EnumConst();
						constFlagIsvalid.setId("2");
						opencourse.setEnumConstByFlagIsvalid(constFlagIsvalid);
