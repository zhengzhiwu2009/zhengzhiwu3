...
function alertcode(x)
{
	for (var i=0;i<x.length;i++)
	{
		...
		if (((k<'0')||(k>'9')) && k!=',')
		{
			...
			document.change.code.value =document.change.code.value.substring(0,document.change.code.value.length-1);
			return;
		}
	}
}
    ...
    if (document.change.admin_id.value.length==0)
      ...
      if(patrn.exec(document.change.admin_id.value)){
        ...
        if (document.change.code.value.length==0)
       {
        ...
        if (document.change.code.value.length>3)
       {
           alert("分站管理编号为三位数字");
           document.change.code.focus();
           return false;
      ...
      document.change.action='<%=request.getContextPath()%>/sso/admin/siteManagerOper_addUpdateManager.action';
...
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen" width="20%" colspan="2" align="center">添加分站管理员</td>
	
</tr>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen" width="20%">登录账号*(账号不能为6位的数字):</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type="text" id="admin_id" name="peManager.ssoUser.loginId" size="30" maxlength="30"></td>
</tr>

<tr>
	<td bgcolor="#D4E4EB" class="zhengwen" width="20%">登陆密码*:</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type="password" id="password" name="peManager.ssoUser.password" size="30" maxlength="30"></td>
</tr>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen" width="20%">分站管理员编号*:</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type="text" id="code" name="peManager.code" size="30" maxlength="3" onpropertychange="alertcode(this.value)"></td>
</tr>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen" width="20%">姓名*:</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type="text" id="admin_name" name="peManager.name" size="30" maxlength="30"></td>
</tr>
<tr>
...
<tr>
	...
	<s:select list="list" listKey="id" listValue="name" theme="simple" name="peManager.peSite.id"></s:select>
	</td>
</tr>
<%--<tr>--%>
<%--	<td bgcolor="#D4E4EB" class="zhengwen" width="20%">管理员类型:</td>--%>
<%--	<td bgcolor="#D4E4EB" class="zhengwen">--%>
<%--		<s:select list="#{'0':'分站管理员','1':'分站管理员'}" theme="simple" name="peManager.groupId"></s:select>--%>
<%--	</td>--%>
<%--</tr>--%>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen" width="20%">固定电话号码:</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type="text" id="phone" name="peManager.phone" size="30" maxlength="30"></td>
</tr>
<tr>
	<td bgcolor="#D4E4EB" class="zhengwen" width="20%">电子信箱:</td>
	<td bgcolor="#D4E4EB" class="zhengwen"><input type="text" id="email" name="peManager.email" size="30" maxlength="30"></td>
</tr>
<tr>
