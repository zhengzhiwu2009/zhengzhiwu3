...
<body leftmargin="0" topmargin="0"  background="../images/bg2.gif" width="90%">
...
<%
	...
	{
%>	
                            <td ><a href="testpaper_add.jsp" class="tj">[添加新试卷]</a>&nbsp;</td>
                            <td ><a href="paperpolicy_add1.jsp" class="tj">[添加新组卷策略]</a>&nbsp;</td>
                            <td ><a href="testpaperpolicy_list.jsp?type=list" class="tj">[查看组卷策略]</a>&nbsp;</td>
<%
	}
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   <td height="26" background="../images/tabletop.gif" style="background-repeat: no-repeat;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src='../images/tabletop.gif');">
                    ...
                    <tr>
                      <td  height="17" style="display:none">&nbsp;</td>
                      <td width="15%" align="center" class="title">&nbsp;&nbsp;名&nbsp;&nbsp;&nbsp;&nbsp;称</td>
					<!--  
					  <td width="1%" align="center" valign="bottom"><img src="images/topxb.gif"></td>
                      <td width="10%" align="center" class="title">发布人</td>
                      -->
					  <td width="1%" align="center" valign="bottom"  style="display:none"
					     ><img src="images/topxb.gif"></td>
                      <td width="14%" align="center" class="title"  style="display:none">发布时间</td>
					  <td width="1%" align="center" valign="bottom"><img src="images/topxb.gif"></td>
                      ...
                      <td width="30%" align="center" class="title">操作</td>
                    	...
                    	<%                         
                          	...
                          	while(it.hasNext()){
								...
								if(status.equals("1"))
								{
									status_link = "<a href='testpaper_changestatus.jsp?paperId="+paperId+"&title="+title+"&pageInt="+pageInt+"&status=1&note=0'>有效</a>";
								}
								else
								{
									status_link = "<a href='testpaper_changestatus.jsp?paperId="+paperId+"&title="+title+"&pageInt="+pageInt+"&status=0&note=1'>无效</a>";
								}
                      ...
                      <td align="center" background="images/tablebian.gif">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mc1">
                          <tr bgcolor="<%=trBgcolor%>"> 
                            <td width="17" align="center" valign="middle" class="td1" style="display:none"><!-- a href="#" onclick="return false;"><img src="images/xb2.gif" width="8" height="8" border="0" onClick="DetailInfo('<%=paperId%>')"></a--></td>
                          ...
                          <!--  
                            ...
                            <td width="10%" align="center"  class="td1"  style="display:none"><%=creatDate%></td>
...
<%
	...
	int isTest = testManage.getTestPaperHistorysNum(user_id,paperId,null,null,teachclass_id);
	List listPaperHistory=testManage.getTestPaperHistorys(null,user_id,paperId,null,null,teachclass_id);
	...
	if("teacher".equalsIgnoreCase(userType)&&us.getRoleId().equals("3"))
	{
		Boolean isTrue = testManage.deleteJudge(paperId);
		if(!isTrue) {
		%>	
                          ...
                          <!--      <a href="testhistory_list.jsp?paperId=<%=paperId%>&prepageInt=<%=pageInt %>">查看已交试卷</a>-->
                            ...
                            &nbsp; &nbsp; &nbsp;
                            	<label title="已存在考试记录，不能删除">删除</label>
	<%
		} else {
%>	
						  <!--   	<a href="testhistory_list.jsp?paperId=<%=paperId%>&prepageInt=<%=pageInt %>">查看已交试卷</a>-->
...
%>	
							  <!--    <a href="testhistory_list.jsp?paperId=<%=paperId%>&prepageInt=<%=pageInt %>">查看已交试卷</a>-->
                            <a href="testpaper_edit.jsp?id=<%=paperId%>&pageInt=<%=pageover.getPageInt() %>">查看基本信息</a>
                            <a href="#" onclick="javascript:window.open('preview_testpaper_pre.jsp?id=<%=paperId%>','zc','resizable,width=800,height=600')" class="button">预览试题</a>
<%
	}
	else
...
%>	 
		已做&nbsp;&nbsp;&nbsp;
	<!--  	 <a href="testhistory_list.jsp?paperId=<%=paperId%>&prepageInt=<%=pageInt %>">查看已交试卷</a> -->
		<a href="testhistory_info.jsp?tsId=<%=tsId%>" target=_blank>查看已交试卷&nbsp;&nbsp;(<%=score %>)</a>				
<%
		}
		...
		if(mock_login == null || !mock_login.equals("1")){
			...
			{
		%>
		<a href="#" onclick="javascript:window.open('testpaper_pre.jsp?id=<%=paperId%>','zc','resizable,width=800,height=600')">重新自测</a> &nbsp;&nbsp;
		<%
			}
		 %>
		<!--  <a href="testhistory_list.jsp?paperId=<%=paperId%>&prepageInt=<%=pageInt %>">查看已交试卷</a>-->	
		<!--  <a href="testhistory_info1.jsp?tsId=<%=tsId%>" target=_blank>查看已交试卷&nbsp;&nbsp;(<%=score %>)</a>-->
		<%
		}
		}
		else
		...
		if(mock_login == null || !mock_login.equals("1")){
		%>
		<a href="#" onclick="javascript:window.open('testpaper_pre.jsp?id=<%=paperId%>','zc','resizable,width=800,height=600')">开始自测</a>
		<%
			}
		%>
		<%
...
<table width="90%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align=center>
                     <img src="images/fh.gif" width="80" height="24" onclick="javascript:window.location='onlinetestcourse_list.jsp?pageInt=<%=pageInt %>'">
                    </td>
                    </tr>
                  </table>
                </td>
