  ...
  <tr>
    ...
    <div class="cntent_k" id="zlb_content_start">
          ...
          <table width="68%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr valign="bottom" align="center">
              <td> &nbsp;</td>
            	<td align="left" colspan="2" valign="bottom"><input type=submit id="submit1" value = "下一步" />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="button" value="返回" onclick="javascript:window.location.href='/entity/teaching/prBzzTchOpenCourse.action?backParam=true'" > </td>
            </tr>
         </table>
      </div>        
    </td>
