...
<% 
PeManager pe =((PeManager)request.getAttribute("peManager"));
 ...
 function checkIdcard(idcard){
  ...
  if(idcard.length==15){
   ...
   function pageGuarding()
   {
      ...
      document.change.action='<%=request.getContextPath()%>/sso/admin/managerOper_updateInfo.action';
...
<tr>
	...
	<select name="peManager.gender">
		...
		<option value="女" <%if(pe.getGender().equals('女')){out.write("checked");} %>>女</option>
	</select>
	</td>
</tr>
...
<tr>
	...
	<td bgcolor="#D4E4EB" class="zhengwen"><select name="peManager.enumConstByFlagIsvalid.code" >
          ...
          <option value="0" <%if(pe.getEnumConstByFlagIsvalid().getCode().equals("0")) {out.print("checked");} %>>无效</option>
        </select></td>
</tr>
