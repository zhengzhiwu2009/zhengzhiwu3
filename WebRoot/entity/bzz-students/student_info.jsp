						...
						<td>
							<table class="datalist" width="100%" border="0" cellpadding="0"
								...
								<tr>
									...
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2">
										&nbsp;
										<s:if test="peBzzStudent.cardNo==null">--</s:if>
								...
								<tr>
									...
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp;
										<s:if test="peBzzStudent.peEnterprise.code == null ">--</s:if>
								...
								<tr>
									...
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp;
										<s:if test="peBzzStudent.workAddress == null ">--
										</s:if>
								...
								<tr>
									...
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp;
										<s:if test="peBzzStudent.work==null">--</s:if>
								...
								<tr>
									...
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp;
										<s:if test="peBzzStudent.enumConstByFlagQualificationsType.name==null">--</s:if>
										<s:property value="peBzzStudent.enumConstByFlagQualificationsType.name" />
										 
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td align="center" bgcolor="#E9F4FF" class="STYLE1">
										<strong>电子邮箱：<s:property value='peBzzStudent.enumConstByIsEmployee.code == "1"'/></strong>
									</td>
									<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
										&nbsp;
								...
								<s:if test='peBzzStudent.enumConstByIsEmployee.code == "1"'>
									<tr>
										<td align="center" bgcolor="#E9F4FF" class="STYLE1">
										...
										<td align="left" bgcolor="#FAFAFA" class="kctx_zi2" colspan="2">
											&nbsp;
											<s:if test="peBzzStudent.mobilePhone == null ">--</s:if>
											<s:property value="peBzzStudent.passEmail"/>
										</td>
									</tr>
								</s:if>
							</table>
						...
						<tr>
							<td>
								<table border="0" align="center" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td>
											<a href="/entity/workspaceStudent/studentWorkspace_toPassword.action">
										...
										<td>
											<a href="/entity/workspaceStudent/studentWorkspace_toModifyInfo.action">
												<img src="/entity/bzz-students/images/two/an_03_1.gif" />
											</a>
										</td>
										</s:elseif>
										<s:elseif test='peBzzStudent.enumConstByIsEmployee.name=="是"'>
										<td>
											<a href="/entity/workspaceStudent/studentWorkspace_toModifyEmail.action">
												<img src="/entity/bzz-students/images/two/an_03_1.gif" />
											</a>
										</td>
										</s:elseif>
