 ...
 *
 */
public class WorkScoreReCheckAction extends PrRecPriPayApplyAction{
	...
	public void initGrid() {
		...
		this.getGridConfig().setTitle(this.getText("作业成绩复查审核"));
	...
	public void setServletPath() {
		this.servletPath="/entity/exam/workScoreReCheck";
	}
	@Override
	public DetachedCriteria initDetachedCriteria() {
		...
		dc.createAlias("enumConstByFlagApplyStatus", "enumConstByFlagApplyStatus")
		  ...
		  .add(Restrictions.and(Restrictions.eq("enumConstByApplyType.namespace", "ApplyType"), Restrictions.eq("enumConstByApplyType.code", "17")))
