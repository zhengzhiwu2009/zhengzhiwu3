...
function searSubmit(){
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
			...
			<tr>
				<td height="28">
					<div class="content_title"  id="zlb_title_start">学员学时剥离记录</div id="zlb_title_end">
				</td>
			</tr>
			<tr>
				<td valign="top" class="pageBodyBorder" style="background:none;">
					...
					<div class="border">
						<!-- start:内容区－列表区域 -->
						<form action="/entity/basic/prepaidAccountSearch_toViewStudentAdd.action"	name="form" method="post">
						...
						<table width="98%">
							<tr>                         
	                           <td align="left" >证件号码:<input type=text style="width: 150px" id="cardNo" name="cardNo"		value="<s:property value="cardNo"/>" />
	                           <input class="comment_btn" type="button" value="查  询" onclick="searSubmit();" >
	                           </td>
								<input type="hidden" style="width: 150px" id="recordId" name="recordId" value="<s:property value="recordId"/>" />
	                         </tr>
                          </table>
						...
						<table  width='98%' border="0" cellpadding="0" cellspacing='0' style='margin-bottom: 5px'>
							<tr>
								<td height="30" align="center" style="font-size:larger">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">剥离学生总数：<s:property value="allotStudent" />
								</font>
									&nbsp;&nbsp;&nbsp;
									<font color="red">剥离学时总计：<s:property value="allotAmount" />
								</font>
								</td>
							</tr>
						</table>
