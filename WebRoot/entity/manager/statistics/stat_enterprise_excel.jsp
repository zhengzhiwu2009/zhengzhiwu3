...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_enterprise_excel.xls"); %>
...
%>
<%
	String search = fixnull(java.net.URLDecoder.decode(fixnull(request.getParameter("search2")),"UTF-8"));
	...
	String id = fixnull(request.getParameter("batch_id"));
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2009-07-22T07:07:32Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=811 style='border-collapse:
 ...
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
  <td colspan=6 height=44 class=xl26 width=811 style='height:33.0pt;width:609pt'><%=name%>学员统计信息</td>
 </tr>
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl24 style='height:30.0pt;border-top:none'>企业名称</td>
...
<%              rs = db.executeQuery(sql);
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl25 style='height:19.5pt;border-top:none'><%=enterprise_name%></td>
  <td class=xl25 style='border-top:none;border-left:none'  x:num><%=total_num%></td>
  <td class=xl25 style='border-top:none;border-left:none'  x:num><%=completed_num %></td>
  <td class=xl25 style='border-top:none;border-left:none' x:num>0</td>
  <td class=xl25 style='border-top:none;border-left:none' x:num>0</td>
  <td class=xl25 style='border-top:none;border-left:none' x:num><%=incompleted_num%></td>
 </tr>
 <%
 	}
 	db.close(rs);%>
