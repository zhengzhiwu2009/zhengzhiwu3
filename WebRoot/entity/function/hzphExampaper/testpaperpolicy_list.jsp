...
<%
	...
	try {
		...
		int totalItems;
		totalItems = testManage.getPaperPolicysNum(null,title,null,null,null,null,"OnlineExam",teachclass_id);
		//----------分页开始---------------
		...
		//----------分页结束---------------
		List testPolicyList = testManage.getPaperPolicys(pageover,null,title,null,null,null,null,"OnlineExam",teachclass_id);
%>
						...
						<table width="99%" border="0" cellspacing="0" cellpadding="0" class="mc1">
                          <tr bgcolor="<%=trBgcolor%>"> 
                            ...
                            <a href="testpaper_add_bypolicy2.jsp?policyId=<%=policyId%>&paperIds=<%=paperIds%>">组卷</a>
                      		<%} else {%>
							 <a href="paperpolicy_update.jsp?policyId=<%=policyId%>&title=<%=policyTitle%>">编辑</a>        		
