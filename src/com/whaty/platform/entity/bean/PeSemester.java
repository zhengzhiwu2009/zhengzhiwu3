...
public class PeSemester extends com.whaty.platform.entity.bean.AbstractBean
	...
	public PeSemester(String name, Long serialNumber, String flagActive,
			...
			Set peTchRejoinSections, Set prExamPatrolSettings,
			Set prPcOpencourses, Set peExamMaincourseNos, Set prTchOpencourses,
			Set peExamNos, Set prTchPaperTitles, Set peTchRejoinRooms,
			Set prExamBookings) {
		this.name = name;
