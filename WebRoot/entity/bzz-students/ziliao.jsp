					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="2" align=left>
								颁布/发布时间：
								<input type="text" style="width: 80px" name="ktimestart" id="ktimestart" value="" />
								...
								到
								<input type="text" style="width: 80px" name="ktimeend" id="ktimeend" value="" />
							...
							<td colspan="3" align="left">
								...
								<s:if test="resourceTagList != null && resourceTagList.size() > 0">
									<s:iterator value="resourceTagList" id="tag">
										<input type="checkbox" name="resourceTag" value="<s:property value="#tag.id"/>" <s:if test="tagIds.indexOf(#tag.id) >= 0">checked=checked</s:if>/><s:property value="#tag.name"/>
									</s:iterator>
								</s:if>
							</td>
						</tr>
