							...
							<tr>
								<td width="18%">
									<div align="left" class="postFormBox">
										注：1、关闭之后登分账户不能被自动分配。但可以手动调整。<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、打开之后登分账户才能登陆登分。<br/>
									</div>
								</td>
							</tr>
							<tr>
								<td>
									...
									<s:if test='#session.inputpri==null||#session.inputpri.equals("0")'>
										当前登分账户不能登录登分<input type="submit" value="打开" id="submit"/>
									</s:if><s:else>
										当前登分账户可以登录登分<input type="submit" value="关闭" id="submit"/>
									</s:else>
									</div>
								</td>
							</tr>
