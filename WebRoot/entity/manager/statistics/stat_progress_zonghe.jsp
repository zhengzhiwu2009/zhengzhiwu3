...
<tr>
    <td valign="top" class="text" align="center"><strong><%=batch_name %>学期&nbsp;&nbsp;&nbsp;综合学习进度统计情况</strong></td>
  </tr>
  ...
  <tr> 
    <td valign="top" class="text" align="center"> <div id="chartdiv" align="center"> 
      ...
      <script type="text/javascript">
		   ...
		   chart.setDataURL("<%=request.getContextPath() %>/entity/manager/statistics/chart/chart_progress_zonghe.jsp?d="+d);		   
  ...
  <tr>
    ...
    <a href="/entity/manager/statistics/stat_progress_zonghe_excel.jsp?d=<%=batch_id%>|<%=new Date().getTime()%>">导出</a></td>
  </tr>
</table>
</body>
</html>