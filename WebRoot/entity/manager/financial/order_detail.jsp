					...
					<td valign="top" class="pageBodyBorder" style="background: none;">
						<div class="content">
							<table cellspacing="0" cellpadding="0">
								...
								<s:if test="peBzzOrderInfo.EnumConstByFlagOrderType.code == '1'" >
								<tr align="bottom" class="postFormBox">
									<td width="">
										<span class="name">购买学时数：</span>
									</td>
									<td width="">
										<font color="red"><s:property value="bean.classhour"/></font>
									</td>
									<td width="">
							...
							<table width='98%' align="center" cellpadding='1' cellspacing='0'
								...
								<s:iterator value="electiveList" id="elective">
									...
									<td style='white-space: nowrap; text-align: center;'>
										<s:if test="#elective[8]!=null && #elective[8]==0"><font title="关闭订单、重新购买会造成课程删除" color="red" style="cursor: pointer;">已点击重新购买</font></s:if>
										<s:elseif test="#elective[4]=='INCOMPLETE'">未完成</s:elseif>
										<s:elseif test="#elective[4]=='COMPLETED'">已完成</s:elseif>
										<s:elseif test="#elective[4]=='UNCOMPLETE'">未学习</s:elseif>
										<s:else>未学习</s:else>
									</td>
								</tr>
								</s:iterator>
