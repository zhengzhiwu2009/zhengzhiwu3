...
String news_id=(String)session.getAttribute("infoNewsId");
%>
...
<script language="javascript">
		Ext.onReady(function(){
				Ext.MessageBox.show({   
					...
					fn:function(ok){
						if(ok=='ok'){
							window.location='/entity/information/peInfoNews_updateInfoNews.action?bean.id=<%=news_id%>&backParam=true';
						}
					}
				});
			});
...
Ext.onReady(function(){
				Ext.MessageBox.show({   
					...
					fn:function(ok){
						if(ok=='ok'){
							//window.history.back();;
							window.location='/entity/information/peInfoNews.action?backParam=true';
						}
					}
				});
			});
...
Ext.onReady(function(){
				Ext.MessageBox.show({   
					...
					fn:function(ok){
						if(ok=='ok'){
							window.location='peInfoNews_updateInfoNews.action?bean.id=<%=news_id%>';
						}
					}
				});
			});
