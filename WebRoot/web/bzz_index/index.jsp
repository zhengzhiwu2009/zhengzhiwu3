...
if(isDateAfter("2012-05-13 00:00:00")){	//报名表下载
	%>
	<div id="pic2" style="position:absolute; visibility:visible; left:0px; top:0px; z-index:5; width: 110; height: 97;background-color:#FF0000;font-size:x-large; font-weight: bold;padding-top:12px;padding:12px;">
	<a href="http://www.thbzzpx.org/web/bzz_index/files/xydjb.xls" target="_blank">四期报名表下载</a>
	 </div> 
	<SCRIPT LANGUAGE="JavaScript">
	<!-- Begin
	var x1 = 50+document.body.clientWidth,y1 = 60 
	...
	var itl1= setInterval("getwindowsize1()", delay1) 
	obj1.onmouseover=function(){clearInterval(itl1)} 
	obj1.onmouseout=function(){itl1=setInterval("getwindowsize1()", delay1)} 
	//  End -->
	</script>
	<%
	}
...
<div id="Announcement">
<div class="title_1"><div class="more"><a href="/entity/first/firstBulletin_allBulletin.action" target="_blank">更多>></a></div><h1>公告</h1></div>
<ul>
...
<s:iterator id="BulletinList" value="#list3" status="bulletin">
	<s:if test="#bulletin.getIndex()<6">
		...
		<s:else >
			<li style="text-align:left;"><a href="/entity/first/firstBulletin_viewDetail.action?bean.id=<s:property value="id"/>" target="_blank"">
			<s:if test='%{enumConstByFlagIsNew.code.equals("0")}'><span style="color:#FF0000">【new】</span><s:property value="@com.whaty.platform.entity.util.MyUtil@subStr(title, 20)"/></s:if>
			<s:else><s:if test="title.length()>14"><s:property value="title.substring(0,14)" />...</s:if><s:else><s:property value="title" /></s:else></s:else></a></li>
		</s:else>
	</s:if>
</s:iterator>
</ul>
...
<div id="Dynamic_news">
<div class="title_2"><div class="more2"><a href="/entity/first/firstInfoNews_allNews.action" target="_blank">更多>></a></div><h1>新闻动态</h1></div>
...
<table style="margin-top: -10px;width:265" border="0" cellspacing="0" cellpadding="0">
                <s:if test="tpnewsList.size()>0">
                  <s:iterator id="tpnewsList" value="tpnewsList" status="tpnews">
                	...
                	<input id="title" type="hidden" name="title" value="<s:if test="title.length()>14"><s:property value="title.substring(0,14)" />...</s:if><s:else><s:property value="title" /></s:else>"/>
...
<s:iterator id="newsList" value="newsList" status="news">
	<li style="text-align:left;"><a href="/entity/first/firstInfoNews_toInfoNews.action?bean.id=<s:property value="id"/>" target="_blank"> <s:if test="title.length()>18"><s:property value="title.substring(0,18)" />...</s:if><s:else><s:property value="title" /></s:else></a></li>
</s:iterator>
</ul>
<!-- 文字新闻动态结束 -->
</div>
...
<!--Login area start-->
<div id="Login_area">
<form id="loginform" name="loginform" method="post" action="/sso/login_login.action" target="_self" onsubmit="return checkForm();" >
<p><span class="sp1">帐 号：</span><span><input name="loginId" id="loginId" type="text" class="input_1"/></span></p>
<p><span class="sp1">密 码：</span><span><input name="passwd" id="password" type="password" class="input_1" onchange="return updateInputState();"/></span></p>
<p><span class="sp1">验证码：</span><span><input name="authCode" id="authCode" type="text" class="input_2" /></span><span class="sp2"><img src="/sso/authimg" width="51" height="20" onclick="this.src=this.src+'?'+(new Date()).getTime()" /></span></p>
...
<div class="key"><span class="sp10"><input type="checkbox" name="rememberMe" value="rememberMe" id="remeberMe" class="input_3" style="border:0; border:none"/></span><span class="sp11">记住我<input type="hidden" id="passwdInput" name="passwdInput" /></span><span class="sp12"><a href="/password/getPsw_identify.action" target="_blank">忘记密码？</a></span></div>
</form>
</div>
<!--Login area end-->
<!--Service area start-->
...
<ul>
<li><a href="/web/bzz_index/rhbm/rhbm.jsp" target="_blank"><img src="/web/bzz_index/index_new/images/1.jpg" width="42" height="43" /><h1>如何报名</h1></a></li>
<li><a href="#"><img src="/web/bzz_index/index_new/images/2.jpg" width="42" height="43" /><h1>如何学习</h1></a></li>
<li><a href="/web/bzz_index/xytd/xytd.jsp" target="_blank"><img src="/web/bzz_index/index_new/images/3.jpg" width="42" height="43" /><h1>学员通道</h1></a></li>
...
<li><a href="http://thtm.tsinghua.edu.cn/" target="_blank"><img src="/web/bzz_index/index_new/images/6.jpg" width="42" height="43" /><h1>证书查询</h1></a></li>
<li><a href="/web/bzz_index/table_download.jsp" target="_blank"><img src="/web/bzz_index/index_new/images/7.jpg" width="42" height="43" /><h1>表格下载</h1></a></li>
<li><a href="/web/bzz_index/player_download.jsp" target="_blank"><img src="/web/bzz_index/index_new/images/8.jpg" width="42" height="43" /><h1>软件下载</h1></a></li>
<li><a href="/web/bzz_index/lxwm_new/lxwm_new.jsp" target="_blank"><img src="/web/bzz_index/index_new/images/9.jpg" width="42" height="43" /><h1>联系我们</h1></a></li>
</ul>
</div>
<!--Service area end-->
...
<div id="Learning_to_rank">
  <div class="tab">
    <dl>
      <dt>
        <div class="title_3"><a>学习人数</a><a title="第三期学员学习平均学时，学员人数超100人的企业">平均学时</a><a title="第二期考试优秀率排名,学员人数超过100人的企业">考试排名</a><a>交流排名</a><a>管理排名</a></div>
        <h1>学习排名</h1>
      </dt>
      <dd>
        <ul><h3><a href="#">更多</a></h3><h4>学习人数排名说明：按集团在平台累计学习总人数降序排列</h4>
          <div class="title_4"><span class="sp4">名次</span> <span class="sp5">企业名称</span><span class="sp6"></span><span class="sp6">说明</span></div>
          <%
          //学习人数开始
          ...
          while(null != rs && rs.next()){
        	  %>
        	  <li ><a ><span class="sp7"><%= study_stu_num_i++ %></span> <span class="sp8">  <%= rs.getString("name") %> </span><span class="sp9"></span></a></li>
        	  <%
          }
          db.close(rs);
          %>
        </ul>
        <ul style="display:none"><h3><a href="#">更多</a></h3><h4>平均学时排序说明：集团企业三期学员学习平均学时（100人以上参与排名）</h4>
          <div class="title_4"><span class="sp4">名次</span> <span class="sp5">企业名称</span><span class="sp6">平均总学时</span><span class="sp6">说明</span></div>
          <%
          //平均学时开始
          String sql_study_time = "  select a.id,a.name,a.avg_finished_ctime,b.student_num,rownum from ( \n"+
        	  ...
        	  "  stat_study_summary sss where sss.batch_id='ff8080812fce7858012fd2d27c1d1527' group by sss.yiji_id) a  \n"+
        	   "  where pe.id=a.yiji_id(+) and pe.fk_parent_id is null order by avg_finished_ctime desc  \n"+
        	  "  ) a, \n"+
        	   "  (select sum(student_num) as student_num,fk_parent_id from pe_enterprise pe, \n"+
        	 "  (select count(*) as student_num, fk_enterprise_id from pe_bzz_student group by fk_enterprise_id) b  \n"+
        	 "  where pe.id=b.fk_enterprise_id and student_num > 100 group by fk_parent_id \n"+
        	 "  ) b  \n"+
        	 "  where a.id=b.fk_parent_id and rownum < 7";
        ...
        <ul style="display:none"><h3><a href="#">更多</a></h3><h4>考试排名说明：集团企业二期考试学员成绩优秀率排名（100人以上参与排名）</h4>
          <div class="title_4"><span class="sp4">名次</span> <span class="sp5">企业名称</span><span class="sp6">优秀率</span><span class="sp6">说明</span></div>
          <%
          //二期考试排名开始
          String sql_exam = " select youxiu_percent,yiji_id,yiji_name from ( \n"+
        	  ...
        	  " ) a, \n"+
        	  " (--总人数 \n"+
        	  " select total_num,yiji_id,yiji_name from ( \n"+
        ...
        <ul style="display:none"><h3><a href="#">更多</a></h3><h4>交流次数排名说明：根据集团企业学员参与论坛及答疑活跃度进行排名</h4>
          <div class="title_4"><span class="sp4">名次</span> <span class="sp5">企业名称</span><span class="sp6">交流次数</span><span class="sp6">说明</span></div>
          <%
          //交流排名
          String sql_question_answer = " select total_num,enterprise_id,enterprise_name,rownum from ( \n"+
        	  " select nvl(ans.total_num,0)+nvl(forum.forum_num,0) as total_num,ans.enterprise_id,ans.enterprise_name,rownum from  \n"+
        	  " -- \n"+
        	  " ( \n"+
        	   " select nvl(a.question_num,0)+nvl(b.answer_num,0) as total_num,a.enterprise_id,a.enterprise_name,rownum from  \n"+
        	   " (--学员答疑  \n"+
        	   ...
        	   " where a.enterprise_id=b.enterprise_id(+) order by total_num desc \n"+
        	  " ) ans, \n"+
        	  " ( \n"+
        	  "  --论坛 \n"+
        	   " select count(*) as forum_num,pe.fk_parent_id from  \n"+
        	   " whatyforum.whatyforum_forum wf, pe_bzz_student pbs,pe_enterprise pe  \n"+
        	   " where wf.username=pbs.reg_no and pbs.fk_enterprise_id=pe.id and fk_parent_id is not null \n"+
        	   " group by fk_parent_id) forum  \n"+
        	  " where ans.enterprise_id=forum.fk_parent_id order by total_num desc \n"+
        	  " ) where rownum < 7";
        ...
        <ul style="display:none"><h3><a href="#">更多</a></h3><h4>管理次数排名说明：根据集团企业管理员管理频率及参与度进行排序</h4>
          <div class="title_4"><span class="sp4">名次</span> <span class="sp5">企业名称</span><span class="sp6">管理次数</span><span class="sp6">说明</span></div>
          <%
          //管理排名开始
          String sql_manage = " select a.id,a.total_num,b.name from ( \n"+
        	  ...
        	  " (--企业下管理员登录和发布公告数之和 \n"+
        	  " select a.fk_enterprise_id as enterprise_id,nvl(a.login_num,0) + nvl(b.bulletin_num,0) as total_num from  \n"+
...
<div class="title_1"><div class="more3"><a href="#"><!-- 更多>> --></a></div><h1>热门课程<span class="sp3">(周点击排行)</span></h1></div>
...
<div class="title_1"><div class="more"><a href="/web/bzz_index/msfc/msfc_new.jsp" target="_blank">更多>></a></div><h1>名师风采</h1></div>
...
<ul>
<s:iterator id="jxjw" value="jxjw" status="jxjws">
	<li><a href="/entity/first/firstInfoNews_toInfoNews.action?bean.id=<s:property value="id"/>" target="_blank"> <s:if test="title.length()>12"><s:property value="title.substring(0,12)" />...</s:if><s:else><s:property value="title" /></s:else></a></li>
</s:iterator>
</ul>
...
<div class="tab3">
            <dl>
              ...
              <dd>
                <ul>
			<div class="wrap">
					<h3><a href="/web/bzz_index/yxbzz/xywy.jsp" target="_blank">更多>></a></h3>
					<div style="clear:both"></div>
					<!-- 学员文苑开始 -->
					<s:iterator id="xywy" value="xywy" status="xywynews">
						<li><a href="/entity/first/firstInfoNews_toXywyDetail.action?bean.id=<s:property value="id"/>" target="_blank"> <s:property value="title" /></a></li>
					</s:iterator>
			</div>
			<div class="wrap">
					<div style="clear:both"></div>
					<!-- 学员文苑开始 -->
					<s:iterator id="xywy" value="xywy" status="xywynews">
						<li><s:property value="summary" /></li>
					</s:iterator>
			</div>
...
<P>联系电话：<span style="color:#FF0000; font-family:Arial, Helvetica, sans-serif">010-62797946</span> 推荐作品发送至Email:<span style="color:#FF0000; font-family:Arial, Helvetica, sans-serif"> bzzzg@mail.itsinghua.com</span></P>
</div>
				...
				<div class="wrap">
					...
					<%
					//辅导答疑开始
					//String sql_answer = " select id,title,student_name,enterprise_name from ( \n"+
						//" select eqi.id,eqi.title,pbs.true_name as student_name ,pe.name as enterprise_name from  \n"+
						//" exam_question_info eqi,pe_bzz_student pbs,pe_enterprise pe  \n"+
						//" where eqi.submituser_id=pbs.id and pbs.fk_enterprise_id=pe.id and eqi.is_index_show='1' order by publish_date desc \n"+
						//" ) where rownum < 6";
					String sql_answer = "  select id,title,student_name,enterprise_name from (  \n"+
						"  select eqi.id,eqi.title,pbs.true_name as student_name ,pe.name as enterprise_name from   \n"+
						 "  exam_question_info eqi,pe_bzz_student pbs,pe_enterprise pe   \n"+
						 "  where eqi.submituser_id=pbs.id and pbs.fk_enterprise_id=pe.id order by click_num desc,publish_date desc \n"+ 
						"  ) where rownum < 6";
					List answer_student_name = new ArrayList();
					List answer_enterprise_name = new ArrayList();
					rs = db.executeQuery(sql_answer);
					int answer_i = 0;
					while(null != rs && rs.next()){
						answer_i++;
						answer_student_name.add(rs.getString("student_name"));
						answer_enterprise_name.add(rs.getString("enterprise_name"));
					%>
				...
				<div class="wrap">
				<%
				for(int i = 0; i < answer_student_name.size(); i++){
				%>
					<li><a href="#" class="a_1">&nbsp;<%= answer_student_name.get(i) %></a></li>
				<%
				}
				%>	
				</div>
				<div class="wrap">
				<%
				for(int i = 0; i < answer_enterprise_name.size(); i++){
				%>
					<li><a href="#" class="a_1">&nbsp;<%= answer_enterprise_name.get(i) %></a></li>
				<%
				}
				%>	
				</div>
             ...
             <ul style="display:none">
				<div class="wrap">
					...
					String sql_comm_question = " select id,title from resource_info \n"+
						" where status='1' and rownum < 16 order by id desc";
			 ...
			 <ul style="display:none">
					...
					<%
					//论坛精粹开始
					String sql_forum = " select id,title,student_name,enterprise_name from ( \n"+
						" select wf.id,wf.title,pbs.true_name as student_name,pe.name as enterprise_name from  \n"+
						" whatyforum.whatyforum_forum wf,pe_bzz_student pbs,pe_enterprise pe   \n"+
						" where wf.elite='189' and wf.username=pbs.reg_no and pbs.fk_enterprise_id=pe.id order by click desc \n"+
						" ) where rownum < 6";
					rs = db.executeQuery(sql_forum);
					int forum_i = 0;
					List forum_student_name = new ArrayList();
					List forum_enterprise_name = new ArrayList();
					while(null != rs && rs.next()){
						forum_i++;
						forum_student_name.add(rs.getString("student_name"));
						forum_enterprise_name.add(rs.getString("enterprise_name"));
					%>
					<li><a href="#" class="a_1"> <%= rs.getString("title") %></a></li>
					<%
					}
				...
				<div class="wrap">
				<%
				for(int i = 0; i < forum_student_name.size(); i++){
				%>
					<li><a href="#" class="a_1">&nbsp;<%= forum_student_name.get(i) %></a></li>
				<%
				}
				%>	
				</div>
				<div class="wrap">
				<%
				for(int i = 0; i < forum_enterprise_name.size(); i++){
				%>
					<li><a href="#" class="a_1">&nbsp;<%= forum_enterprise_name.get(i) %></a></li>
				<%
				}
				%>	
				</div>
...
<a href="http://www.sasac.gov.cn/n1180/n2381219/n2381237/index.html"><img src="/web/bzz_index/index_new/images/004.jpg" width="120" height="58" /></a>
<a href="http://www.sasac.gov.cn/n1180/n2381219/n2381237/index.html" target=_blank><img src="/web/bzz_index/images/1.jpg" width=121 height=56 hspace="3"  border=0 /></a>
<a href="http://www.sasac.gov.cn/n1180/n2381219/n6271021/index.html" target=_blank><img height=56  src="/web/bzz_index/images/2.jpg" hspace="3" width=121 border=0 /></a>
<a href="http://kxfzg.chinamobile.com/" target=_blank><img hspace="3" height=56  src="/web/bzz_index/images/3(1).jpg" width=121 border=0 /></a>
<a href="http://www.airchinagroup.com/" target=_blank><img hspace="3" height=56 src="/web/bzz_index/images/4(1).jpg"  width=121 border=0 /></a>
<a href="http://www.airchinagroup.com/" target=_blank><img height=56 src="/web/bzz_index/images/5.jpg" hspace="3" width=121 border=0 /></a>
<a href="http://www.cnooc.com.cn/" target=_blank><img hspace="3" height=56 src="/web/bzz_index/images/6(1).jpg" width=121 border=0 /></a>
<a href="http://www.cnpc.com.cn/" target=_blank><img hspace="3" height=56 src="/web/bzz_index/images/7(1).jpg" width=121 border=0 /></a>
<a href="http://www.airchinagroup.com/" target=_blank><img hspace="3" height=56 src="/web/bzz_index/images/5.jpg" width=121 border=0 /></a>
<a href="http://www.cnooc.com.cn/" target=_blank><img hspace="3" height=56 src="/web/bzz_index/images/6(1).jpg" width=121 border=0 /></a>
<a href="http://www.cnpc.com.cn/" target=_blank><img hspace="3" height=56 src="/web/bzz_index/images/7(1).jpg" width=121 border=0 /></a>
</div>
</td>
