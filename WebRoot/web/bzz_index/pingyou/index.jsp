...
<div id="big">
 ...
 <!--头部结束-->
  ...
  <div class="con2">
     ...
     <div class="content2">
       <div class="c_2left">
         <div class="tit"><a href="zj_sub2.jsp" class="more">更多>></a><strong> 最佳管理员</strong><span class="font_s">（排名不分先后）</span></div>
         <div class="ctncroll">
       ...
       <div class="c_2right">
         ...
         <div class="tit"><a href="yx_sub2.jsp" class="more">更多>></a><strong> 优秀管理员</strong><span class="font_s">（排名不分先后）</span></div>
  ...
  <div class="con3">
  <div class="ctitle">
   <a href="sub2.jsp" class="more">更多>></a>
   <div class="title">优秀学员</div>
   </div>
   <div class="con3text">
    <div class="con3left"><img src="images/p_23.jpg" width="342" height="278" border="0" /></div>
    <div class="con3right">
