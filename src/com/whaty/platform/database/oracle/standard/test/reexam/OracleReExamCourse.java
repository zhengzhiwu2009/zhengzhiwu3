...
public class OracleReExamCourse extends ReExamCourse {
	public OracleReExamCourse() {
	}

	public OracleReExamCourse(String aid) {
		...
		sql = "select name,to_char(s_date,'yyyy-mm-dd hh24:Mi:ss') as s_date,to_char(e_date,'yyyy-mm-dd hh24:Mi:ss')"
			//	+ " as e_date,test_batch_id,course_id,examsequence_id,course_type,exam_type from test_examcourse_info where id='"
				+ " as e_date,test_batch_id,course_id,basicsequence_id,course_type,exam_type from expendtest_examcourse_info where id='"
				+ aid + "'";
		try {
			...
			//	this.setCourse_id(rs.getString("course_id"));
				this.setCourse_id(rs.getString("course_id"));
				this.setExamBatch(new OracleReExamBatch(rs
						.getString("test_batch_id")));
				this.setSequence(new OracleReExamSequence(rs
	...
	public ReExamCourse getExamCourse(String batch_id, String course_id) {
		dbpool db = new dbpool();
		String sql = "";
		MyResultSet rs = null;
