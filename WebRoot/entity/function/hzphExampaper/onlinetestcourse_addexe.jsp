...
<%
	try {
		...
		//batch_id存放考试批次
		int count = testManage.addOnlineTestCourse(title,note,startDate,endDate,status,isAutoCheck,isHiddenAnswer,batch_id,teachclass_id,user_id,batch_id);
