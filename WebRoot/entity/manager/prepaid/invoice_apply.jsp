								...
								<tr class="postFormBox">
									...
									<td align="left">
										<input type="radio" id="PTFP" name="invoiceType"
											onclick="invoice(this.id)" checked="checked" value="3" />
										增值税普通电子发票&nbsp;&nbsp;
										<input type="radio" id="ZYFP" name="invoiceType"
											onclick="invoice(this.id)"
											<s:if test="amount <1000" > disabled="disabled"</s:if>
											value="4" />
										增值税专用发票&nbsp;&nbsp;&nbsp;&nbsp;
									</td>
								</tr>
								<tr class="postFormBox" id="a1">
									...
									<td>
										<input name="peBzzInvoiceInfo.title" id="invoiceTitle" title="请慎重填写！如发票抬头为单位或机构名称，则务必与所在单位或机构财务确认后再进行填写。"
											type="text"
											value="<s:property value="lastInvoiceInfo.title"/>" size="60"
											maxlength="100">
									</td>
								</tr>
