...
public class PePriCategoryManageAction extends MyBaseAction<PePriCategory> {
	...
	public void initGrid() {
		...
		this.getGridConfig().addColumn(this.getText("路径"), "path", true, true, true, "TextField", false, 500);
		...
		this.getGridConfig().addColumn(this.getText("所属分类"), "pePriCategory.name", true, true, true, "TextField", true, 500);
