...
<div class="main">
	<div class="main_con1" style="border-top:1px solid #C8C8C8;">
		...
		<div class=""  style="padding:45px 0 65px 200px;font:12px/1.8 "lucida grande", tahoma, verdana, arial, sans-serif, "宋体"; COLOR: #787878">
			<ul class="main_form">
				<li>
					<div class="fm_left" ><img src="/web/bzz_index/password/images/Tick-icon.png"/></div>
					<div class="fm_right">
					<p style="font-weight:bold">密码修改成功</p>
					<p>温馨提示:为了您的账号安全,请牢记账号和密码</p>
					<p> 现在您可以    <a href="/">登录</a> 或者 <a href="/">返回首页</a></p>
					<br/>
					</div>       
				</li>
				<li>
