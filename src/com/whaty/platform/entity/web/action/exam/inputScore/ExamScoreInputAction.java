...
//		this.getGridConfig().addColumn(this.getText("登分账户A"),"prTchStuElective.prTchProgramCourse.peTchCourse.peExamScoreInputUserByFkExamScoreInputUseraId.name");
		ColumnConfig c1 = new ColumnConfig(this.getText("登分账户A"),"prTchStuElective.prTchProgramCourse.peTchCourse.peExamScoreInputUserByFkExamScoreInputUseraId.name");
...
//		this.getGridConfig().addColumn(this.getText("登分账户B"),"prTchStuElective.prTchProgramCourse.peTchCourse.peExamScoreInputUserByFkExamScoreInputUserbId.name");
		ColumnConfig c2 = new ColumnConfig(this.getText("登分账户B"),"prTchStuElective.prTchProgramCourse.peTchCourse.peExamScoreInputUserByFkExamScoreInputUserbId.name");
