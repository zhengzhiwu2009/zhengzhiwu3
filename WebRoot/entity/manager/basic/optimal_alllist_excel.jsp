...
<%	response.setHeader("Content-Disposition", "attachment;filename=optimal_list_excel.xls"); %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1009 style='border-collapse:
 ...
 <tr height=36 style='mso-height-source:userset;height:27.0pt'>
  ...
  width:758pt'>《<%=batch_name%>》<font class="font7"><%=enterprise%>最佳管理员列表（此信息仅供参考）</font></td>
 </tr>
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 style='border-top:none;border-left:none'>是否是最佳管理员</td>
  <td class=xl26 style='border-top:none;border-left:none'>所在集团</td>
  <td class=xl26 style='border-top:none;border-left:none'>所在单位</td>
 ...
 <%
	...
	sql_t=
		...
		" where 1=1 \n" + sql_conn+
		"   and pem.is_goodmag != 'ccb2880a91dadc115011dadfcf26b0011' and pem.is_goodmag = k2.id(+) and pem.id = k1.fk_managerid(+) and k1.submit_status = k3.id(+) \n"+
