...
function deleteSelect() {
	...
	for(var i=0;i<x.length;i++) {
 	...
 	if(confirm("您确定要删除吗")){
 		document.user.action = "testpaper_delete_select.jsp";
	...
	<%
		...
		//----------分页结束---------------
		List testPaperList = testManage.getTestPapersByOnlineTestCourse(
	...
	<body leftmargin="0" topmargin="0" background="../images/bg2.gif"
		...
		<input type="hidden" name="pageInt" value="<%=backPageInt %>">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td width="1%" align="center" valign="bottom"><img src="images/topxb.gif"></td-->
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr bgcolor="<%=trBgcolor%>">
													<td class='select' width="5%" style='text-align: center; '> 
                          								<input type='checkbox' class='checkbox' name='idaaa' value='<%=paperId%>' id=''>
                          	 						</td>
                            ...
                            <td width="10%" align="center"  class="td1"><%=creatUser%></td>-->
													...
													<td width="30%" align="center" class="td1">
														...
														<%
															String user_id = "(" + user.getId() + ")" + user.getName();
																	int isTest = testManage.getTestPaperHistorysNum(user_id,
																			paperId, null, null, teachclass_id);
																	List listPaperHistory = testManage.getTestPaperHistorys(
									...
									<tr>
										<td align="center">
											<a href="javascript:deleteSelect();" class="button">删除选中</a>
										</td>
									</tr>
									<tr>
										<td>
