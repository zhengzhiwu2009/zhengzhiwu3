...
//System.out.println(sql);
 rs = db.executeQuery(sql);
	...
	int total_180= 0;
        ...
        String str ="<chart palette='2'  xAxisName='学时' yAxisName='Number' showValues='0' decimals='0' formatNumberScale='0' labelDisplay='WRAP'>"+
                    "<set label='0~20' value='"+total_20+"' />"+
                    "<set label='20~40' value='"+total_40+"' />"+
                    "<set label='40~60' value='"+total_60+"' />"+
                    "<set label='60~80' value='"+total_80+"' />"+
                    "<set label='80~ 100' value='"+total_100+"' />"+
                    "<set label='100~ 120' value='"+total_120+"' />"+
                    "<set label='120~ 140' value='"+total_140+"' />"+
                    "<set label='140~ 160' value='"+total_160+"' />"+
                    "<set label='160~ 180' value='"+total_180+"' /></chart>"; 
