...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html清华大学继续教育学院arset=utf-8">
...
<form action="homeworkpaper_addexe.jsp" method="POST" name="frmAnnounce" onsubmit="return chkSubmit()">
...
<input type=hidden name=type value=<%=type %>>
                    ...
                    <tr>
                      <td background="../images/table_02.gif" ><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="bg4">
                          <tr>
							...
							<input type=text name=title class=input1 size=60>
							</td>
						  </tr>
                          	<tr>
		...
		<tr>
			<td align=center><input type=submit value="提交" id=sub>&nbsp;&nbsp;<input type=button value="返回" onclick="javascript:history.go(-1)"></td>
		</tr>
                  </table> </td>
              </tr>
            </table></td>
