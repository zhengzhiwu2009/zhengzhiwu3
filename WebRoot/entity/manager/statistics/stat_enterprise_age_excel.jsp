...
<%	response.setHeader("Content-Disposition", "attachment;filename=stat_enterprise_age.xls"); %>
...
<%
	...
	if(us.getRoleId().equals("2") || us.getRoleId().equals("402880a92137be1c012137db62100006"))  //表示为一级主管和一级辅导员
	{
		...
		if(!enterprise_id.equals(""))	
			sql_con+=" and e.id='"+enterprise_id+"'";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=288 style='border-collapse:
 ...
 %>
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl25 style='height:14.25pt;border-top:none'><%=i * 10%>--<%=(i + 1) * 10%></td>
