...
public abstract class LMSManifestHandler extends CPDOMParser implements Serializable 
{
   ...
   /***********************************************
    * 课件类型，用于课件多表现形式修改，添加人：胡泽 *
    ***********************************************/
	protected String scormType;//课件类型
	protected String indexfile;//课件首页
...
/****************************************************************************
   ...
   ***************************************************************************/
                                 ...
                                 String type, String href ) 
   {
      ...
      org.adl.parsers.dom.ADLItem tempItem = new ADLItem();
