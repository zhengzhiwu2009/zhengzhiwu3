						...
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<%
								...
								try {
									...
									int totalItems = peBzzAssService.getQuestionsNum(teachclass_id, title, name, type, "");
									//----------分页开始---------------
									...
									//----------分页结束---------------		
									List questionList = peBzzAssService.getQuestions(pageover, teachclass_id, title, name, type, "");
