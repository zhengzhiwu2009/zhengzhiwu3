...
<html>
	...
	<body leftmargin="0" topmargin="0" class="scllbar">
		<s:form name="batch"
			action="/entity/exam/peBzzExamAgain_reject.action" method="POST">
						...
						<div class="cntent_k" id="zlb_content_start">
							...
							<table width="68%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr class="postFormBox">
									<td></td>
									 <td align=left><input type=submit value = "驳回" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="button" value="返回" onclick="javascript:window.location.href='/entity/exam/peBzzExamAgain.action?backParam=true'" /></td>
								</tr>
							</table>
						</div>
