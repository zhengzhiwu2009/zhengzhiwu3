...
<%
	...
	String submituserName = null;
	String submituserType = null;	
	if(us.getRoleId().equals("3")) {
		String stu_id = request.getParameter("stu_id");
		String stu_name = request.getParameter("stu_name");
		
		submituserId = fixNull(stu_id);
		submituserName = fixNull(stu_name);
		submituserType = "student";
	} else {
		submituserId = fixNull(student.getId());
		submituserName = fixNull(student.getName());
		submituserType = fixNull(student.getLoginType());	
	}
