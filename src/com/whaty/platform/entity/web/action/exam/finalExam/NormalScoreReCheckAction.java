 ...
 *
 */
public class NormalScoreReCheckAction extends PrRecPriPayApplyAction {
	...
	public void initGrid() {
		...
		this.getGridConfig().setTitle(this.getText("平时成绩复查审核"));
		...
		this.getGridConfig().addColumn(this.getText("身份证号"), "peStudent.prStudentInfo.cardNo");
	...
	public void setServletPath() {
		this.servletPath="/entity/exam/normalScoreReCheck";
	...
	public DetachedCriteria initDetachedCriteria() {
		...
		dc.createAlias("enumConstByFlagApplyStatus", "enumConstByFlagApplyStatus")
		  ...
		  .add(Restrictions.and(Restrictions.eq("enumConstByApplyType.namespace", "ApplyType"), Restrictions.eq("enumConstByApplyType.code", "16")))
