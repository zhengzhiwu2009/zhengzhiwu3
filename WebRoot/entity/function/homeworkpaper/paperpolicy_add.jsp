...
<%
		...
		%>
			<script>alert('模拟学生登陆只能查看不能添加新作业策略');window.history.back();</script>
		<%
			}
		%>
<html>
...
<script>
	...
	function doCommit() {
	var	inp=document.getElementById('ptitle');
		if(inp.value.trim()=="")
		{
			alert('标题不能为空');
			inp.focus();
...
<form name="paperForm" action="paperpolicy_add1.jsp" method="post" onsubmit="return doCommit();">
                    ...
                    <tr> 
                      <td>
                          ...
                          <tr> 
                            ...
                            <td width="200" valign="top" class="text3" style="padding-top:25px">添加作业策略基本信息</td>
                                ...
                                <tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                                <tr>
		                                  ...
		                                  <td valign="top"><input name="title" id="ptitle" type="text" size="30" maxlength="50"><font color=red>*</font></td>		                                  
		                                </tr>
	                            	</table>
									</td>
                          		</tr>
