...
document.write("#tb td{border:none !important;line-height:10px !important; padding:0 !important;margin:0 !important;}");
document.write("<!--");
document.write(".pro {");
...
function CreatPro(id,parPro,parTTime,parDelay,parStep,parStepDelay,parPath){
	...
	function showPro(){
		document.write("<table id='tb' width=100 height=16 border=0 cellpadding = 0 cellspacing = 0 margin-left=0 margin-top=0>");
		document.write("<tr>");
		document.write("<td>");
