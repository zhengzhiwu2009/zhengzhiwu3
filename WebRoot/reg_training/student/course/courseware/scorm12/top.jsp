...
<table  border="0" cellpadding="0" cellspacing="0" width="101%">
  <tr style="background:url('./images/top_01_bg.jpg') repeat-x;">
   <td width="458" height="62"><img name="top_r1_c1" src="./images/top_01.jpg" width="458" height="62" border="0" id="top_r1_c1" alt="" /></td>
   <!--<td background="./images/top_r1_c2.jpg">&nbsp;</td>-->
   <td width="" align="right" style="padding-right:10px;"><a href="#"><img name="top_r1_c3" src="./images/top_05.jpg" width="70" height="23" border="0" id="top_r1_c3" alt="" ONCLICK="javascript:doConfirm();"/></a></td>
  </tr>
</table>
</form>
</body>
