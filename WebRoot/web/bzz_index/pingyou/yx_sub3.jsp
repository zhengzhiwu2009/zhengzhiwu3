...
<div class="wrap">
 ...
 <div class="container">
   <div class="ctntop">
     <div class="ctntoptitle"><div class="titletext">优秀管理员的个人风采展示</div></div>
   </div>
   <div class="ctncenter">
        <% 
        String sql = "";
        ...
        sql = " select b.name, d.name as gender, c.name as enterprise_name, a.work_space, a.photo_one , a.regard_num , a.advanced_story , a.certificate , a.feeling_words from pe_bzz_goodmag a, pe_enterprise_manager b, pe_enterprise c ,"+
