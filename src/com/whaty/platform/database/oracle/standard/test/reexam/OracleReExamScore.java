...
import com.whaty.platform.test.reexam.ReExamScore;
import com.whaty.platform.test.reexam.ReExamUser;

import com.whaty.platform.util.log.UserUpdateLog;
import com.whaty.util.log.Log;

public class OracleReExamScore extends ReExamScore {
	public OracleReExamScore() {
	}

	public OracleReExamScore(ReExamUser examUser, ReExamCourse examCourse) {
