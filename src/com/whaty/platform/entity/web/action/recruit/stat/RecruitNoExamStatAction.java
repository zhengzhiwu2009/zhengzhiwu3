...
import com.whaty.platform.entity.web.action.recruit.recmanage.RecruitManageNoExamAction;
 ...
 * 
 */
public class RecruitNoExamStatAction extends MyBaseAction<PeRecStudent> {

	@Override
	public void initGrid() {
		this.getGridConfig().setCapability(false, false, false);

		this.getGridConfig().setTitle(this.getText("免试生查询"));
		...
		this.getGridConfig().addColumn(this.getText("免试审核状态"),
				"enumConstByFlagNoexamStatus.name");
	...
	public void setServletPath() {
		this.servletPath = "/entity/recruit/recruitNoExamStat";
