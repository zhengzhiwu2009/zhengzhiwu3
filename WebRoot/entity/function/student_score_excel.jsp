...
String coursename = fixnull(request.getParameter("coursename"));
...
" where bs.fk_batch_id = bb.id"+
 ...
 "  and se.fk_tch_opencourse_id = bo.id"+sql_name+sql_reg+sql_batch;
%>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=404 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl24 colspan=6 style='height:15.0pt;width:76pt'><%=coursename%> 学生成绩列表</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl24 width=400 style='height:15.0pt;width:76pt'>系统编号</td>
  ...
  <td height=20 class=xl24 width=200 style='height:15.0pt;width:76pt'>考试成绩</td>
 </tr>
<%
...
%>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td height=20 class=xl24 width=200 style='height:15.0pt;width:76pt'><%=score%></td>
</tr>
<% 
	} 
db.close(rs);
