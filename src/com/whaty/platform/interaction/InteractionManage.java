...
public abstract class InteractionManage {
	 ...
	 * @throws PlatformException
	 */
	public abstract int addQuestion(String title, String body, String key,String type,
			String submituserId, String submituserName, String submituserType,
	 ...
	 * @throws NoRightException
	 */
	public abstract int updateQuestionType(String id, String questionType)
			throws NoRightException;
	...
	public abstract List getQuestions(Page page, String teachclass_id,
			String title, String name, String questionType, String noUse) throws NoRightException;

	public abstract int getQuestionsNum(String teachclass_id, String title,
			String name) throws NoRightException;
	
	public abstract int getQuestionsNum(String teachclass_id, String title,
			String name, String questionType, String notuse) throws NoRightException;
	...
	public abstract int addAnswer(String questionId, String body,
			String reuserId, String reuserName, String reuserType,Object teacher)
			throws NoRightException, PlatformException;
...
//			throws PlatformException;
	...
	//考试辅导答疑——提问 20101227
	public abstract int addExamQuestion(String title, String body,String questionType,
			String submituserId, String submituserName, String submituserType,
			String exambatchId) throws NoRightException,
			PlatformException;
	
	public abstract int updateExamQuestion(String title, String body,String question_id) throws NoRightException,
			PlatformException;
	
	//获取问题数目
	public abstract int getExamQuestionsNum(String exambatchId, String title,
			String questionType) throws NoRightException;
	
	//获取新消息数目
	public abstract String getExamNewsCount(String exambatchId, String student_id) throws NoRightException;
	
	//我的问题数目
	public abstract int getExamQuestionsNumSelf(String exambatchId,
			String student_id) throws NoRightException;
	
	//我的关注问题数目
	public abstract int getExamQuestionsNumFocus(String exambatchId,
			String student_id) throws NoRightException;
	
	//已解决问题数目
	public abstract int getExamQuestionsNumYes(String exambatchId,String student_id) throws NoRightException;
	
	//待回答问题数目
	public abstract int getExamQuestionsNumNo(String exambatchId,String student_id) throws NoRightException;
	
	//新消息数目
	public abstract int getExamNews(String exambatchId,String student_id) throws NoRightException;
	
	public abstract List getExamQuestions(Page page, String exambatchId,
			String title,String questionType) throws NoRightException;
	
	public abstract List getExamQuestionsSelf(Page page, String exambatchId,
			String student_id) throws NoRightException;
	
	public abstract List getExamQuestionsFocus(Page page, String exambatchId,
			String student_id) throws NoRightException;
	
	public abstract List getExamQuestionsYes(Page page, String exambatchId,String student_id) throws NoRightException;
	
	public abstract List getExamQuestionsNo(Page page, String exambatchId,String student_id) throws NoRightException;
	
	public abstract List getExamNews(Page page, String exambatchId,String student_id) throws NoRightException;
	
	public abstract ExamQuestion getExamQuestion(String tid) throws NoRightException;
	
	public abstract ExamAnswer getExamAnswerTeacher(String tid) throws NoRightException;
	
	public abstract ExamAnswer getExamAnswerKey(String tid) throws NoRightException;
	
	public abstract List getExamAnswers(Page page,String question_id) throws NoRightException;
	
	public abstract int addExamAnswer(String questionId, String body,
			String publishId, String publishName, String publishType)
			throws NoRightException, PlatformException;
	
	public abstract int updateExamAnswerToKey(String answer_id)
			throws NoRightException, PlatformException;
	
	public abstract int addQuestionToFocus(String question_id,String student_id)
			throws NoRightException, PlatformException;
	
	public abstract int deleteQuestionToFocus(String question_id,String student_id)
			throws NoRightException, PlatformException;
	
	public abstract ExamUserQuestion getExamUserQuestion(String question_id,String user_id) throws NoRightException;
