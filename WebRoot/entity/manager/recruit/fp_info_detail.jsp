...
<table width="554" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                           ...
                           <tr>
                            ...
                            <s:if test="e_id !=null">
                            <input type=button value="返回" onclick="window.location='/entity/recruit/peBzzFaxInfo.action?e_id=<s:property value="e_id" />&backParam=true'":</td>
                            </s:if>
                            <s:else>
                            <input type=button value="返回" onclick="window.location='/entity/recruit/peBzzFaxInfo.action?backParam=true'":</td>
                            </s:else>
						  </tr>
						   <tr>
                            <td  height="10"> </td>
