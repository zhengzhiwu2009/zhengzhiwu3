...
Ext.onReady(function(){
    ...
    /* ### begin edit by panguangxu 2011-10-13 14:16:00 */
	Ext.onReady(function(){
		if ( Ext.ux && Ext.ux.grid && Ext.ux.grid.FiltersFeature ) {
			Ext.ux.grid.FiltersFeature.prototype.menuFilterText = "搜索";
		}
		if ( Ext.ux && Ext.ux.grid && Ext.ux.grid.filter && Ext.ux.grid.filter.BooleanFilter ) {
			Ext.ux.grid.filter.BooleanFilter.prototype.yesText = "是";
			Ext.ux.grid.filter.BooleanFilter.prototype.noText = "否"; 	
		}
		if ( Ext.ux && Ext.ux.grid && Ext.ux.grid.filter && Ext.ux.grid.filter.DateFilter ) {
			Ext.ux.grid.filter.DateFilter.prototype.dateFormat = "Y-m-d";
			Ext.ux.grid.filter.DateFilter.prototype.afterText = "晚于";
			Ext.ux.grid.filter.DateFilter.prototype.beforeText = "早于";
			Ext.ux.grid.filter.DateFilter.prototype.onText = "等于";  	
		}
	});
	/* ### end edit by panguangxu 2011-10-13 14:16:00 */
